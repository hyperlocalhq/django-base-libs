...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'NavigationLink.description_markup_type'
        db.delete_column(u'navigation_navigationlink', 'description_markup_type')

        # Changing field 'NavigationLink.description_de'
        db.alter_column(u'navigation_navigationlink', 'description_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'description', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'NavigationLink.description_en'
        db.alter_column(u'navigation_navigationlink', 'description_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'description', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))
    
    
    def backwards(self, orm):
        
        # Adding field 'NavigationLink.description_markup_type'
        db.add_column(u'navigation_navigationlink', 'description_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False), keep_default=False)

        # Changing field 'NavigationLink.description_de'
        db.alter_column(u'navigation_navigationlink', 'description_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Beschreibung', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'NavigationLink.description_en'
        db.alter_column(u'navigation_navigationlink', 'description_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Beschreibung', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))
    ...
    models = {
        ...
        u'navigation.navigationlink': {
            'Meta': {'ordering': "['tree_id', 'lft']", 'object_name': 'NavigationLink'},
            ...
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'child_set'", 'null': 'True', 'to': u"orm['navigation.NavigationLink']"}),
