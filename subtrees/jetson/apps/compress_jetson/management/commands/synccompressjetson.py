...
class Command(NoArgsCommand):
    ...
    def handle_noargs(self, **options):
        ...
        from jetson.apps.compress_jetson.utils import needs_update, filter_css, filter_js
        from jetson.apps.compress_jetson.conf import settings

        for name, css in settings.COMPRESS_JETSON_CSS.items():
        ...
        for name, js in settings.COMPRESS_JETSON_JS.items():
