...
class InstitutionBase(CreationModificationDateMixin, UrlMixin, OpeningHoursMixin):
    """
    ...
    parent = models.ForeignKey("self", verbose_name=_("Member of"), blank=True, null=True)
    description = MultilingualTextField(_("Description"), blank=True)

    image = FileBrowseField(_('Image'), max_length=255, directory="%s/" % URL_ID_INSTITUTIONS, extensions=['.jpg', '.jpeg', '.gif','.png','.tif','.tiff'], blank=True)
    
    institution_types = TreeManyToManyField(InstitutionType, verbose_name=_("Types"),)
    status = models.CharField(_("Status"), max_length=20, choices=STATUS_CHOICES, blank=True, default="draft")
    legal_form = models.ForeignKey(LegalForm, verbose_name=_("Legal form"), blank=True, null=True, related_name="legal_form_institution")
    
    context_categories = TreeManyToManyField(ContextCategory, verbose_name=_("Context categories"), limit_choices_to={'is_applied4institution': True}, blank=True)
    ...
    establishment_yyyy = models.IntegerField(_("Year of Establishment"), blank=True, null=True, choices=YEAR_OF_ESTABLISHMENT_CHOICES)
    establishment_mm = models.SmallIntegerField(_("Month of Establishment"), blank=True, null=True, choices=MONTH_CHOICES)
    nof_employees = models.IntegerField(_("Number of Employees"), blank=True, null=True)
    ...
    def get_supported_payments(self):
        all_payments = ["is_card_visa_ok", "is_card_mastercard_ok", "is_card_americanexpress_ok", "is_paypal_ok", "is_cash_ok", "is_transaction_ok", "is_prepayment_ok", "is_on_delivery_ok", "is_invoice_ok", "is_ec_maestro_ok", "is_giropay_ok"]
        supported_payments = [
            force_unicode(type(self)._meta.get_field(field_name).verbose_name)
            for field_name in all_payments
    ...
    def get_contact_persons(self):
        if not hasattr(self, "_contact_persons_cache"):
            self._contact_persons_cache = [contact.person for contact in self.individualcontact_set.all()] 
    ...
    def are_opening_hours_displayed(self, user=None):
        if not hasattr(self, "_are_opening_hours_displayed_cache"):
            ...
            self._are_opening_hours_displayed_cache = (
                ...
                or (user and user.has_perm("institutions.change_institution", self))
                )
    ...
    def autocomplete_search_fields():
        return ("id__iexact", "title__icontains", "title2__icontains",)
...
class InstitutionalContactBase(models.Model):
    ...
    location_type = models.ForeignKey(InstitutionalLocationType, verbose_name=_("Location type"), default=get_default_ins_loc_type)
    ...
    postal_address = models.ForeignKey(Address, verbose_name=_("Postal Address"), related_name="institutional_address", null=True, blank=True)
    ...
    phone0_type = models.ForeignKey(PhoneType, verbose_name=_("Phone Type"), blank=True,
                                    null=True, related_name='institutional_contacts0',
    ...
    phone1_type = models.ForeignKey(PhoneType, verbose_name=_("Phone Type"), blank=True,
                                    null=True, related_name='institutional_contacts1',
    ...
    phone2_type = models.ForeignKey(PhoneType, verbose_name=_("Phone Type"), blank=True,
                                    null=True, related_name='institutional_contacts2',
    ...
    url0_type = models.ForeignKey(URLType, verbose_name=_("URL Type"), blank=True, null=True, related_name='institutional_contacts0', on_delete=models.SET_NULL)
    ...
    url1_type = models.ForeignKey(URLType, verbose_name=_("URL Type"), blank=True, null=True, related_name='institutional_contacts1', on_delete=models.SET_NULL)
    ...
    url2_type = models.ForeignKey(URLType, verbose_name=_("URL Type"), blank=True, null=True, related_name='institutional_contacts2', on_delete=models.SET_NULL)
    ...
    im0_type = models.ForeignKey(IMType, verbose_name=_("IM Type"), blank=True, null=True, related_name='institutional_contacts0', on_delete=models.SET_NULL)
    ...
    im1_type = models.ForeignKey(IMType, verbose_name=_("IM Type"), blank=True, null=True, related_name='institutional_contacts1', on_delete=models.SET_NULL)
    ...
    im2_type = models.ForeignKey(IMType, verbose_name=_("IM Type"), blank=True, null=True, related_name='institutional_contacts2', on_delete=models.SET_NULL)
    ...
    email0_type = models.ForeignKey(EmailType, verbose_name=_("Email Type"), blank=True, null=True, related_name='institutional_contacts0', on_delete=models.SET_NULL)
    ...
    email1_type = models.ForeignKey(EmailType, verbose_name=_("Email Type"), blank=True, null=True, related_name='institutional_contacts1', on_delete=models.SET_NULL)
    ...
    email2_type = models.ForeignKey(EmailType, verbose_name=_("Email Type"), blank=True, null=True, related_name='institutional_contacts2', on_delete=models.SET_NULL)
