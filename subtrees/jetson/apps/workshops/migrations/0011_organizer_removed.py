...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('workshops_workshop', 'organizing_museum', self.gf('django.db.models.fields.related.ForeignKey')(related_name='organized_workshops', null=True, to=orm['museums.Museum'], blank=True), keep_default=False)
