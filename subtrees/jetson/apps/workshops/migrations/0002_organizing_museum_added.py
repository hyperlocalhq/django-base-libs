...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Workshop.organizing_museum'
        db.add_column('workshops_workshop', 'organizing_museum', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='organized_workshops', null=True, to=orm['museums.Museum']), keep_default=False)

        # Adding field 'Workshop.organizer_title'
        db.add_column('workshops_workshop', 'organizer_title', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Workshop.organizer_url_link'
        db.add_column('workshops_workshop', 'organizer_url_link', self.gf('base_libs.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)

    
    def backwards(self, orm):
        
        # Deleting field 'Workshop.organizing_museum'
        db.delete_column('workshops_workshop', 'organizing_museum_id')

        # Deleting field 'Workshop.organizer_title'
        db.delete_column('workshops_workshop', 'organizer_title')

        # Deleting field 'Workshop.organizer_url_link'
        db.delete_column('workshops_workshop', 'organizer_url_link')
    ...
    models = {
        ...
        'workshops.workshop': {
            ...
            'street_address': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'street_address2': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'subtitle': ('base_libs.models.fields.MultilingualCharField', [], {'max_length': '255', 'null': 'True'}),
            'subtitle_de': ('django.db.models.fields.CharField', ["u'Subtitle'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'subtitle_en': ('django.db.models.fields.CharField', ["u'Subtitle'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'tags': ('tagging_autocomplete.models.TagAutocompleteField', [], {'default': "''"}),
            'title': ('base_libs.models.fields.MultilingualCharField', [], {'max_length': '255', 'null': 'True'}),
        ...
        'workshops.workshoptime': {
            'Meta': {'ordering': "('start',)", 'object_name': 'WorkshopTime'},
            ...
            'start_yyyy': ('django.db.models.fields.IntegerField', [], {'default': '2013'}),
