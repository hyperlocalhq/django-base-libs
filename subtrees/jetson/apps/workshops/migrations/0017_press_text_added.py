...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Workshop.press_text'
        db.add_column('workshops_workshop', 'press_text', self.gf('base_libs.models.fields.MultilingualTextField')(default='', null=True, blank=True), keep_default=False)

        # Adding field 'Workshop.press_text_de'
        db.add_column('workshops_workshop', 'press_text_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Pressetext', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False), keep_default=False)

        # Adding field 'Workshop.press_text_de_markup_type'
        db.add_column('workshops_workshop', 'press_text_de_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False), keep_default=False)

        # Adding field 'Workshop.press_text_en'
        db.add_column('workshops_workshop', 'press_text_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Pressetext', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False), keep_default=False)

        # Adding field 'Workshop.press_text_en_markup_type'
        db.add_column('workshops_workshop', 'press_text_en_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False), keep_default=False)

        # Adding field 'Workshop.press_text_markup_type'
        db.add_column('workshops_workshop', 'press_text_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False), keep_default=False)

        # Changing field 'Workshop.admission_price_info_de'
        db.alter_column('workshops_workshop', 'admission_price_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintrittpreis Infotext', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Workshop.admission_price_info_en'
        db.alter_column('workshops_workshop', 'admission_price_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintrittpreis Infotext', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Workshop.press_text'
        db.delete_column('workshops_workshop', 'press_text')

        # Deleting field 'Workshop.press_text_de'
        db.delete_column('workshops_workshop', 'press_text_de')

        # Deleting field 'Workshop.press_text_de_markup_type'
        db.delete_column('workshops_workshop', 'press_text_de_markup_type')

        # Deleting field 'Workshop.press_text_en'
        db.delete_column('workshops_workshop', 'press_text_en')

        # Deleting field 'Workshop.press_text_en_markup_type'
        db.delete_column('workshops_workshop', 'press_text_en_markup_type')

        # Deleting field 'Workshop.press_text_markup_type'
        db.delete_column('workshops_workshop', 'press_text_markup_type')

        # Changing field 'Workshop.admission_price_info_de'
        db.alter_column('workshops_workshop', 'admission_price_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Preisinformation', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Workshop.admission_price_info_en'
        db.alter_column('workshops_workshop', 'admission_price_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Preisinformation', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))
    ...
    models = {
        ...
        'workshops.organizer': {
            ...
            'organizing_museum': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'workshop_organizer'", 'null': 'True', 'to': "orm['museums.Museum']"}),
            'workshop': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['workshops.Workshop']"})
        },
        'workshops.workshop': {
