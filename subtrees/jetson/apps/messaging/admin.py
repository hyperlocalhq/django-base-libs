...
class InternalMessageOptions(ExtendedModelAdmin):
    list_display = (
        'creation_date', 'subject', 'sender_display', 'recipient_display',
        'is_read', 'is_deleted', 'is_spam', 'is_draft', 'is_replied'
    )
    list_filter = ('creation_date', 'is_read', 'is_deleted', 'is_spam')
    search_fields = (
        "subject", "body", "sender__username", "sender__first_name",
        "sender__last_name", "recipient__username", "recipient__first_name",
