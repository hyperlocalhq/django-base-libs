...
class LanguageOptions(admin.ModelAdmin):
    save_on_top = True
    list_display = (
        '__unicode__', 'iso3_code', 'iso2_code', 'synonym', 'display'
    )
    list_filter = ('display', )
...
class CountryOptions(admin.ModelAdmin):
    save_on_top = True
    inlines = [
        CountryLanguage_Inline, Area_Inline, TimeZone_Inline, Phone_Inline
    ]
    """
    fieldsets = (
    ...
    """
    list_display = (
        '__unicode__', 'iso3_code', 'iso2_code', 'territory_of', 'adm_area',
        'display'
    )
...
class PhoneOptions(admin.ModelAdmin):
    save_on_top = True
    list_display = (
        'country', 'code', 'ln_area', 'ln_sn', 'ln_area_sn', 'nat_prefix',
        'int_prefix'
    )
