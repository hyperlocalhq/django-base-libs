...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'IndividualType'
        db.create_table('people_individualtype', south_cleaned_fields((
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=255, db_index=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='child_set', null=True, to=orm['people.IndividualType'])),
        ...
        db.send_create_signal('people', ['IndividualType'])
        ...
        db.create_table('people_person', south_cleaned_fields((
            ...
            ('individual_type', self.gf('mptt.fields.TreeForeignKey')(to=orm['people.IndividualType'], null=True, blank=True)),
            ...
            ('person_repr', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ...
            ('nationality', self.gf('django.db.models.fields.related.ForeignKey')(max_length=200, to=orm['i18n.Nationality'], null=True, blank=True)),
            ...
            ('status', self.gf('django.db.models.fields.CharField')(default='unconfirmed', max_length=20, blank=True)),
            ('preferred_language', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['i18n.Language'], null=True, blank=True)),
            ('timezone', self.gf('django.db.models.fields.related.ForeignKey')(max_length=200, to=orm['i18n.TimeZone'], null=True, blank=True)),
            ('display_birthday', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('display_email', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('display_address', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('display_phone', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('display_fax', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('display_mobile', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('display_im', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('display_username', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('allow_search_engine_indexing', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ...
        db.create_table('people_individualcontact', south_cleaned_fields((
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('postal_address', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='individual_address', null=True, to=orm['location.Address'])),
            ...
            ('phone0_type', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='individual_contacts0', null=True, blank=True, to=orm['optionset.PhoneType'])),
            ...
            ('phone1_type', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='individual_contacts1', null=True, blank=True, to=orm['optionset.PhoneType'])),
            ...
            ('phone2_type', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='individual_contacts2', null=True, blank=True, to=orm['optionset.PhoneType'])),
            ...
            ('url0_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='individual_contacts0', null=True, to=orm['optionset.URLType'])),
            ...
            ('url1_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='individual_contacts1', null=True, to=orm['optionset.URLType'])),
            ...
            ('url2_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='individual_contacts2', null=True, to=orm['optionset.URLType'])),
            ...
            ('im0_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='individual_contacts0', null=True, to=orm['optionset.IMType'])),
            ...
            ('im1_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='individual_contacts1', null=True, to=orm['optionset.IMType'])),
            ...
            ('im2_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='individual_contacts2', null=True, to=orm['optionset.IMType'])),
            ...
            ('email0_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='individual_contacts0', null=True, to=orm['optionset.EmailType'])),
            ...
            ('email1_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='individual_contacts1', null=True, to=orm['optionset.EmailType'])),
            ...
            ('email2_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='individual_contacts2', null=True, to=orm['optionset.EmailType'])),
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'IndividualType'
        db.delete_table('people_individualtype')
    ...
    models = {
        ...
        'people.individualcontact': {
            ...
            'phone0_type': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'individual_contacts0'", 'null': 'True', 'blank': 'True', 'to': "orm['optionset.PhoneType']"}),
            ...
            'phone1_type': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'individual_contacts1'", 'null': 'True', 'blank': 'True', 'to': "orm['optionset.PhoneType']"}),
            ...
            'phone2_type': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'individual_contacts2'", 'null': 'True', 'blank': 'True', 'to': "orm['optionset.PhoneType']"}),
