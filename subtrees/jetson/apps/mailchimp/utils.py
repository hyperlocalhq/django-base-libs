    ...
    if ml.mailchimp_id:
        ...
        for mc_member in ms.listMembers(
            ...
            sub, created = Subscription.objects.get_or_create(
                ...
                mailinglist=ml,
                defaults={
                    'first_name': mc_member_info['data'][0]['merges'].get('FNAME', ""),
                    'last_name': mc_member_info['data'][0]['merges'].get('LNAME', ""),
                    'ip': "127.0.0.1",
                    }
                )
        ...
        for mc_member in ms.listMembers(
            ...
            sub.first_name = mc_member_info['data'][0]['merges'].get('FNAME', "")
