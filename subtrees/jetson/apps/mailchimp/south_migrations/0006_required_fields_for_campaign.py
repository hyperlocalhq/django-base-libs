...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'Campaign.sender_email'
        db.alter_column(u'mailchimp_campaign', 'sender_email', self.gf('django.db.models.fields.EmailField')(max_length=75))

        # Changing field 'Campaign.sender_name'
        db.alter_column(u'mailchimp_campaign', 'sender_name', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):
        # Changing field 'Campaign.sender_email'
        db.alter_column(u'mailchimp_campaign', 'sender_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))

        # Changing field 'Campaign.sender_name'
        db.alter_column(u'mailchimp_campaign', 'sender_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    models = {
        ...
        u'mailchimp.campaign': {
            ...
            'sender_email': ('django.db.models.fields.EmailField', [], {'default': "'kontakt@kubinaut.de'", 'max_length': '75'}),
            'sender_name': ('django.db.models.fields.CharField', [], {'default': "'Kubinaut'", 'max_length': '255'}),
