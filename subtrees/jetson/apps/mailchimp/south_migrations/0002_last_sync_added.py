...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MList.last_sync'
        db.add_column('mailchimp_mlist', 'last_sync', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'MList.last_sync'
        db.delete_column('mailchimp_mlist', 'last_sync')
