...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NewlyOpenedExhibitionExt'
        db.create_table('cmsplugin_newlyopenedexhibitionext', south_cleaned_fields((
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('exhibition', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exhibitions.Exhibition'])),
            ('teaser_text', self.gf('base_libs.models.fields.ExtendedTextField')(blank=True)),
            ('teaser_text_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False)),
        )))
        db.send_create_signal('exhibitions_plugins', ['NewlyOpenedExhibitionExt'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'NewlyOpenedExhibitionExt'
        db.delete_table('cmsplugin_newlyopenedexhibitionext')
    ...
    models = {
        ...
        'exhibitions_plugins.newlyopenedexhibitionext': {
            'Meta': {'ordering': "['exhibition__title']", 'object_name': 'NewlyOpenedExhibitionExt', 'db_table': "'cmsplugin_newlyopenedexhibitionext'", '_ormbases': ['cms.CMSPlugin']},
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'exhibition': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['exhibitions.Exhibition']"}),
            'teaser_text': ('base_libs.models.fields.ExtendedTextField', [], {'blank': 'True'}),
            'teaser_text_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'})
        },
        'museums.museum': {
    ...
    complete_apps = ['exhibitions_plugins']
