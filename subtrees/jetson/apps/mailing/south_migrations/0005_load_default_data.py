...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        call_command("loaddata", "default_mailing_data.json", ignorenonexistent=True)
    ...
    models = {
        ...
        'mailing.emailmessage': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'emailmessage_creator'", 'null': 'True', 'to': "orm['auth.User']"}),
            ...
            'modifier': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'emailmessage_modifier'", 'null': 'True', 'to': "orm['auth.User']"}),
            'recipient': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'received_by_message_set'", 'null': 'True', 'to': "orm['auth.User']"}),
            'recipient_emails': ('base_libs.models.fields.PlainTextModelField', [], {'null': 'True', 'blank': 'True'}),
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'sent_by_message_set'", 'null': 'True', 'to': "orm['auth.User']"}),
        ...
        'mailing.emailtemplateplaceholder': {
            ...
            'name_de': ('django.db.models.fields.CharField', ["u'Placeholder Name'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '64', 'db_tablespace': "''", 'blank': 'False', 'unique': 'True', 'db_index': 'False'}),
            'name_en': ('django.db.models.fields.CharField', ["u'Placeholder Name'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '64', 'db_tablespace': "''", 'blank': 'False', 'unique': 'True', 'db_index': 'False'}),
