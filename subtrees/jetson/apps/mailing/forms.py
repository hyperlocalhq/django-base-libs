...
class GenericMailForm(dynamicforms.Form):
    ...
    recipients_email_list = forms.MultipleChoiceField(
        ...
        help_text=_(
            "Please select one or more recipients from the list and/or enter recipients in the text field below."
        ),
    )
    recipients_email_input = MultiEmailTextField(
        ...
        help_text=_(
            "Email addresses must have the form 'John Doe (john.doe@domain.com)' or just 'john.doe@domain.com'."
        ),
    )
