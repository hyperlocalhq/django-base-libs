...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'infoblock.content_markup_type'
        db.delete_column(u'blocks_infoblock', 'content_markup_type')

        # Changing field 'InfoBlock.title'
        db.alter_column(u'blocks_infoblock', 'title', self.gf('base_libs.models.fields.MultilingualCharField')(max_length=512, null=True))

        # Changing field 'InfoBlock.content'
        db.alter_column(u'blocks_infoblock', 'content', self.gf('base_libs.models.fields.MultilingualTextField')(null=True))
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'blocks_infoblock', 'content_markup_type',
            self.gf('models.CharField')('Markup type', default='pt', max_length=10, blank=False),
            keep_default=False)

        # Changing field 'InfoBlock.title'
        db.alter_column(u'blocks_infoblock', 'title', self.gf('MultilingualCharField')(_('title'), max_length=512))

        # Changing field 'InfoBlock.content'
        db.alter_column(u'blocks_infoblock', 'content', self.gf('MultilingualTextField')(_('content')))
