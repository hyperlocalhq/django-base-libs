...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Mailing.status'
        db.add_column('email_campaigns_mailing', 'status', models.PositiveIntegerField(_("Status"), default=1))
        
        # Changing field 'Mailing.template'
        db.alter_column('email_campaigns_mailing', 'template', TemplatePathField(_("Template"), path="email_campaigns/mailing/", match="\.html$"))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Mailing.status'
        db.delete_column('email_campaigns_mailing', 'status')
        
        # Changing field 'Mailing.template'
        db.alter_column('email_campaigns_mailing', 'template', TemplatePathField(path='email_campaigns/mailing/', match=r'\.html$'))
