...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'NoticeSetting.send'
        db.delete_column('notification_noticesetting', 'send')

    
    def backwards(self, orm):
        
        # Adding field 'NoticeSetting.send'
        db.add_column('notification_noticesetting', 'send', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
