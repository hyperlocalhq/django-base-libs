...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EventTimeLabel'
        db.create_table('events_eventtimelabel', south_cleaned_fields((
        ...
        db.send_create_signal('events', ['EventTimeLabel'])

        # Adding model 'EventBase'
        db.create_table('events_eventbase', south_cleaned_fields((
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('modified_date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='eventbase_creator', null=True, to=orm['auth.User'])),
            ('modifier', self.gf('django.db.models.fields.related.ForeignKey')(related_name='eventbase_modifier', null=True, to=orm['auth.User'])),
        ...
        db.send_create_signal('events', ['EventBase'])

        # Adding model 'EventType'
        db.create_table('events_eventtype', south_cleaned_fields((
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=255, db_index=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='child_set', null=True, to=orm['events.EventType'])),
            ('title', self.gf('base_libs.models.fields.MultilingualCharField')(max_length=255, null=True)),
            ('title_de', self.gf('django.db.models.fields.CharField')(u'title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=False, unique=False, db_index=False)),
            ('title_en', self.gf('django.db.models.fields.CharField')(u'title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=False, unique=False, db_index=False)),
        ...
        db.create_table('events_event', south_cleaned_fields((
            ('eventbase_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['events.EventBase'], unique=True, primary_key=True)),
            ...
            ('event_type', self.gf('mptt.fields.TreeForeignKey')(related_name='type_events', to=orm['events.EventType'])),
            ...
            ('postal_address', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='address_events', null=True, to=orm['location.Address'])),
            ...
            ('phone0_type', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='events0', null=True, blank=True, to=orm['optionset.PhoneType'])),
            ('phone0_country', self.gf('django.db.models.fields.CharField')(default='49', max_length=4, blank=True)),
            ('phone0_area', self.gf('django.db.models.fields.CharField')(max_length=6, blank=True)),
            ...
            ('phone1_type', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='events1', null=True, blank=True, to=orm['optionset.PhoneType'])),
            ('phone1_country', self.gf('django.db.models.fields.CharField')(default='49', max_length=4, blank=True)),
            ('phone1_area', self.gf('django.db.models.fields.CharField')(max_length=6, blank=True)),
            ...
            ('phone2_type', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='events2', null=True, blank=True, to=orm['optionset.PhoneType'])),
            ...
            ('url0_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='events0', null=True, to=orm['optionset.URLType'])),
            ...
            ('url1_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='events1', null=True, to=orm['optionset.URLType'])),
            ...
            ('url2_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='events2', null=True, to=orm['optionset.URLType'])),
            ...
            ('im0_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='events0', null=True, to=orm['optionset.IMType'])),
            ...
            ('im1_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='events1', null=True, to=orm['optionset.IMType'])),
            ...
            ('im2_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='events2', null=True, to=orm['optionset.IMType'])),
            ...
            ('email0_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='events0', null=True, to=orm['optionset.EmailType'])),
            ...
            ('email1_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='events1', null=True, to=orm['optionset.EmailType'])),
            ...
            ('email2_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='events2', null=True, to=orm['optionset.EmailType'])),
        ...
        db.create_table('events_eventtime', south_cleaned_fields((
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.EventBase'])),
            ('start_yyyy', self.gf('django.db.models.fields.IntegerField')(default=2012)),
            ...
            ('label', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='label_event_types', null=True, to=orm['events.EventTimeLabel'])),
        )))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'EventTimeLabel'
        db.delete_table('events_eventtimelabel')

        # Deleting model 'EventBase'
        db.delete_table('events_eventbase')
    ...
    models = {
        ...
        'events.event': {
            ...
            'phone1_type': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'events1'", 'null': 'True', 'blank': 'True', 'to': "orm['optionset.PhoneType']"}),
            ...
            'phone2_type': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'events2'", 'null': 'True', 'blank': 'True', 'to': "orm['optionset.PhoneType']"}),
