...
class EventBase(CreationModificationMixin, UrlMixin):
    ...
    image = FileBrowseField(_('Image'), max_length=200, directory="%s/" % URL_ID_EVENTS, extensions=['.jpg', '.jpeg', '.gif','.png','.tif','.tiff'], blank=True)
...
class ComplexEventBase(EventBase, OpeningHoursMixin):
    ...
    phone0_type = models.ForeignKey(PhoneType, verbose_name=_("Phone Type"), blank=True, null=True, related_name='events0', default=DefaultPhoneType("default"))
    ...
    phone1_type = models.ForeignKey(PhoneType, verbose_name=_("Phone Type"), blank=True, null=True, related_name='events1', default=DefaultPhoneType("fax"))
    ...
    phone2_type = models.ForeignKey(PhoneType, verbose_name=_("Phone Type"), blank=True, null=True, related_name='events2', default=DefaultPhoneType("mobile"))
    ...
    email0_type = models.ForeignKey(EmailType, verbose_name=_("Email Type"), blank=True, null=True, related_name='events0', on_delete=models.SET_NULL)
    ...
    email1_type = models.ForeignKey(EmailType, verbose_name=_("Email Type"), blank=True, null=True, related_name='events1', on_delete=models.SET_NULL)
    ...
    email2_type = models.ForeignKey(EmailType, verbose_name=_("Email Type"), blank=True, null=True, related_name='events2', on_delete=models.SET_NULL)
    ...
    def get_emails(self):
        if not hasattr(self, '_emails_cache'):
            self._emails_cache = [{
                ...
                "address_protected": getattr(self, "email%d_address" % pos).replace("@", _(" (at) ")).replace(".", _(" (dot) ")),
...
class EventTimeBase(models.Model):
    ...
    start_yyyy = models.IntegerField(_("Start Year"), choices=YEAR_CHOICES, default=tz_now().year)
