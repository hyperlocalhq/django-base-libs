...
CKEDITOR.plugins.setLang('oembed', 'fr', {
	...
	pasteUrl : "Coller l'URL de partage que vous voulez publier. De nombreux services sont pris en charge tels que : (YouTube, Vimeo, Twitter, Facebook, Instagram, etc.). Vous pouvez aussi utiliser les URLs courtes.",
