...
//Deviant Art has this
    ...
    $.fn.oembed.providers = [
        ...
        new $.fn.oembed.OEmbedProvider("facebook-video", "video", ["facebook.com/.*(video).*"], "https://www.facebook.com/plugins/video/oembed.json/?url=$0"),
        //Photo
        ...
        new $.fn.oembed.OEmbedProvider("instagram", "photo", ["instagr\\.?am(\\.com)?/.+"], checkProtocol() + "api.instagram.com/oembed", {dataType: 'text json'}),
    ...
    //	{ templateRegex: /.*message\/([^\/]+).*/, embedtag: { tag: 'img'},nocache:1 }),
        ...
        new $.fn.oembed.OEmbedProvider("facebook-post", "rich", ["facebook.com/.+"], "https://www.facebook.com/plugins/post/oembed.json/?url=$0"),
