...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Exhibition.catalog_ordering'
        db.add_column('exhibitions_exhibition', 'catalog_ordering', self.gf('base_libs.models.fields.MultilingualCharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Exhibition.catalog_ordering_de'
        db.add_column('exhibitions_exhibition', 'catalog_ordering_de', self.gf('django.db.models.fields.CharField')(u'Catalog ordering possibilities', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False), keep_default=False)

        # Adding field 'Exhibition.catalog_ordering_en'
        db.add_column('exhibitions_exhibition', 'catalog_ordering_en', self.gf('django.db.models.fields.CharField')(u'Catalog ordering possibilities', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Exhibition.catalog_ordering'
        db.delete_column('exhibitions_exhibition', 'catalog_ordering')

        # Deleting field 'Exhibition.catalog_ordering_de'
        db.delete_column('exhibitions_exhibition', 'catalog_ordering_de')

        # Deleting field 'Exhibition.catalog_ordering_en'
        db.delete_column('exhibitions_exhibition', 'catalog_ordering_en')
