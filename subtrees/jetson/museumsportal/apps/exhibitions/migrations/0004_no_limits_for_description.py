...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('exhibitions_exhibition', 'description_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Beschreibung', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Exhibition.description'
        db.alter_column('exhibitions_exhibition', 'description', self.gf('base_libs.models.fields.MultilingualTextField')(null=True))

        # Changing field 'Exhibition.description_en'
        db.alter_column('exhibitions_exhibition', 'description_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Beschreibung', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))
    
    
    def backwards(self, orm):
        
        # Changing field 'Exhibition.description_de'
        db.alter_column('exhibitions_exhibition', 'description_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Beschreibung', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=255, db_tablespace=''))

        # Changing field 'Exhibition.description'
        db.alter_column('exhibitions_exhibition', 'description', self.gf('base_libs.models.fields.MultilingualTextField')(max_length=255, null=True))

        # Changing field 'Exhibition.description_en'
        db.alter_column('exhibitions_exhibition', 'description_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Beschreibung', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, max_length=255, db_tablespace=''))
