...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Exhibition.is_for_children'
        db.add_column('exhibitions_exhibition', 'is_for_children', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Exhibition.is_for_families'
        db.add_column('exhibitions_exhibition', 'is_for_families', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Exhibition.is_for_youth'
        db.add_column('exhibitions_exhibition', 'is_for_youth', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'Exhibition.suitable_for_disabled_info_en'
        db.alter_column('exhibitions_exhibition', 'suitable_for_disabled_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Spezielle Eignung f\xfcr Menschen mit Handicap', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Exhibition.group_ticket_de'
        db.alter_column('exhibitions_exhibition', 'group_ticket_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Gruppenticket', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))
        ...
        # Changing field 'Exhibition.group_ticket_en'
        db.alter_column('exhibitions_exhibition', 'group_ticket_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Gruppenticket', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Exhibition.other_tickets_de'
        db.alter_column('exhibitions_exhibition', 'other_tickets_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Weitere Tickets', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Exhibition.other_locations_en'
        db.alter_column('exhibitions_exhibition', 'other_locations_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Weitere Ausstellungsorte', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Exhibition.reduced_price_info_en'
        db.alter_column('exhibitions_exhibition', 'reduced_price_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Erm\xe4\xdfigter Eintritt Infotext', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Exhibition.free_entrance_for_de'
        db.alter_column('exhibitions_exhibition', 'free_entrance_for_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintritt frei f\xfcr', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Exhibition.reduced_price_info_de'
        db.alter_column('exhibitions_exhibition', 'reduced_price_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Erm\xe4\xdfigter Eintritt Infotext', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Exhibition.admission_price_info_de'
        db.alter_column('exhibitions_exhibition', 'admission_price_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Preisinformation', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Exhibition.yearly_ticket_en'
        db.alter_column('exhibitions_exhibition', 'yearly_ticket_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Jahreskarte', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Exhibition.catalog_de'
        db.alter_column('exhibitions_exhibition', 'catalog_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Katalog', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Exhibition.arrangements_for_children_de'
        db.alter_column('exhibitions_exhibition', 'arrangements_for_children_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintrittsregelungen f\xfcr Kinder und Jugendliche', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Exhibition.family_ticket_en'
        db.alter_column('exhibitions_exhibition', 'family_ticket_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Familienticket', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Exhibition.press_text_en'
        db.alter_column('exhibitions_exhibition', 'press_text_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Pressetext', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Exhibition.yearly_ticket_de'
        db.alter_column('exhibitions_exhibition', 'yearly_ticket_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Jahreskarte', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Exhibition.admission_price_info_en'
        db.alter_column('exhibitions_exhibition', 'admission_price_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Preisinformation', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Exhibition.family_ticket_de'
        db.alter_column('exhibitions_exhibition', 'family_ticket_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Familienticket', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Exhibition.press_text_de'
        db.alter_column('exhibitions_exhibition', 'press_text_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Pressetext', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Exhibition.free_entrance_for_en'
        db.alter_column('exhibitions_exhibition', 'free_entrance_for_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintritt frei f\xfcr', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Exhibition.other_locations_de'
        db.alter_column('exhibitions_exhibition', 'other_locations_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Weitere Ausstellungsorte', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Exhibition.other_tickets_en'
        db.alter_column('exhibitions_exhibition', 'other_tickets_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Weitere Tickets', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Exhibition.catalog_en'
        db.alter_column('exhibitions_exhibition', 'catalog_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Katalog', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Exhibition.arrangements_for_children_en'
        db.alter_column('exhibitions_exhibition', 'arrangements_for_children_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintrittsregelungen f\xfcr Kinder und Jugendliche', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Exhibition.is_for_children'
        db.delete_column('exhibitions_exhibition', 'is_for_children')

        # Deleting field 'Exhibition.is_for_families'
        db.delete_column('exhibitions_exhibition', 'is_for_families')

        # Deleting field 'Exhibition.is_for_youth'
        db.delete_column('exhibitions_exhibition', 'is_for_youth')

        # Changing field 'Exhibition.suitable_for_disabled_info_en'
        db.alter_column('exhibitions_exhibition', 'suitable_for_disabled_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Suitability for people with disabilities info', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Exhibition.group_ticket_de'
        db.alter_column('exhibitions_exhibition', 'group_ticket_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Group ticket', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Exhibition.suitable_for_disabled_info_de'
        db.alter_column('exhibitions_exhibition', 'suitable_for_disabled_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Suitability for people with disabilities info', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Exhibition.group_ticket_en'
        db.alter_column('exhibitions_exhibition', 'group_ticket_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Group ticket', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Exhibition.other_tickets_de'
        db.alter_column('exhibitions_exhibition', 'other_tickets_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Other tickets', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Exhibition.other_locations_en'
        db.alter_column('exhibitions_exhibition', 'other_locations_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Other exhibition locations', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Exhibition.reduced_price_info_en'
        db.alter_column('exhibitions_exhibition', 'reduced_price_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Reduced admission price info', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Exhibition.free_entrance_for_de'
        db.alter_column('exhibitions_exhibition', 'free_entrance_for_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Free entrance for', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Exhibition.reduced_price_info_de'
        db.alter_column('exhibitions_exhibition', 'reduced_price_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Reduced admission price info', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Exhibition.admission_price_info_de'
        db.alter_column('exhibitions_exhibition', 'admission_price_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Admission price info', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Exhibition.yearly_ticket_en'
        db.alter_column('exhibitions_exhibition', 'yearly_ticket_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Yearly ticket', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Exhibition.catalog_de'
        db.alter_column('exhibitions_exhibition', 'catalog_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Catalog', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Exhibition.arrangements_for_children_de'
        db.alter_column('exhibitions_exhibition', 'arrangements_for_children_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Admission arrangements for children and youth', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Exhibition.family_ticket_en'
        db.alter_column('exhibitions_exhibition', 'family_ticket_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Family ticket', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Exhibition.press_text_en'
        db.alter_column('exhibitions_exhibition', 'press_text_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Press text', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Exhibition.yearly_ticket_de'
        db.alter_column('exhibitions_exhibition', 'yearly_ticket_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Yearly ticket', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Exhibition.admission_price_info_en'
        db.alter_column('exhibitions_exhibition', 'admission_price_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Admission price info', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Exhibition.family_ticket_de'
        db.alter_column('exhibitions_exhibition', 'family_ticket_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Family ticket', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Exhibition.press_text_de'
        db.alter_column('exhibitions_exhibition', 'press_text_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Press text', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Exhibition.free_entrance_for_en'
        db.alter_column('exhibitions_exhibition', 'free_entrance_for_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Free entrance for', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Exhibition.other_locations_de'
        db.alter_column('exhibitions_exhibition', 'other_locations_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Other exhibition locations', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Exhibition.other_tickets_en'
        db.alter_column('exhibitions_exhibition', 'other_tickets_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Other tickets', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Exhibition.catalog_en'
        db.alter_column('exhibitions_exhibition', 'catalog_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Catalog', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Exhibition.arrangements_for_children_en'
        db.alter_column('exhibitions_exhibition', 'arrangements_for_children_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Admission arrangements for children and youth', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))
