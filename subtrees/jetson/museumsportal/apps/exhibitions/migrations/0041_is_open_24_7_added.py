...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Season.is_open_24_7'
        db.add_column('exhibitions_season', 'is_open_24_7', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Season.is_open_24_7'
        db.delete_column('exhibitions_season', 'is_open_24_7')
