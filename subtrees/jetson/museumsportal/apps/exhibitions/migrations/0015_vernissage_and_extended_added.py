...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Exhibition.vernissage'
        db.add_column('exhibitions_exhibition', 'vernissage', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Exhibition.exhibition_extended'
        db.add_column('exhibitions_exhibition', 'exhibition_extended', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Exhibition.vernissage'
        db.delete_column('exhibitions_exhibition', 'vernissage')

        # Deleting field 'Exhibition.exhibition_extended'
        db.delete_column('exhibitions_exhibition', 'exhibition_extended')
