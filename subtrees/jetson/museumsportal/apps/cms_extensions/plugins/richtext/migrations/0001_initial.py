...
from museumsportal.apps.cms_extensions.plugins.richtext.models import *
...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_richtext', south_cleaned_fields((
            ('cmsplugin_ptr', orm['richtext.RichText:cmsplugin_ptr']),
            ('body', orm['richtext.RichText:body']),
            ('body_markup_type', orm['richtext.RichText:body_markup_type']),
        )))
        db.send_create_signal('richtext', ['RichText'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('cmsplugin_richtext')
    ...
    models = {
        ...
        'richtext.richtext': {
            'Meta': {'db_table': "'cmsplugin_richtext'"},
