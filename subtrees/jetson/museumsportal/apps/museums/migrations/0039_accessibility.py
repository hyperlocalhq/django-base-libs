...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AccessibilityOption.image'
        db.alter_column('museums_accessibilityoption', 'image', self.gf('filebrowser.fields.FileBrowseField')(directory='accessibility/', max_length=255, extensions=['.jpg', '.jpeg', '.gif', '.png', '.tif', '.tiff']))
    
    
    def backwards(self, orm):

        # Changing field 'AccessibilityOption.image'
        db.alter_column('museums_accessibilityoption', 'image', self.gf('filebrowser.fields.FileBrowseField')(directory='museums/', max_length=255, extensions=['.jpg', '.jpeg', '.gif', '.png', '.tif', '.tiff']))
