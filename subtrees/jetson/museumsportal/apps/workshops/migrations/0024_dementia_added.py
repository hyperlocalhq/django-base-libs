...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Workshop.is_for_dementia_sufferers'
        db.add_column('workshops_workshop', 'is_for_dementia_sufferers', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    
    def backwards(self, orm):
        # Deleting field 'Workshop.is_for_dementia_sufferers'
        db.delete_column('workshops_workshop', 'is_for_dementia_sufferers')
