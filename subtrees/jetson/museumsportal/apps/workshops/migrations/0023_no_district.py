...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Workshop.district'
        db.delete_column('workshops_workshop', 'district')
    
    
    def backwards(self, orm):
        
        # Adding field 'Workshop.district'
        db.add_column('workshops_workshop', 'district', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)
