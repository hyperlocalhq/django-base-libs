...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('workshops_organizer', south_cleaned_fields((
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('workshop', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workshops.Workshop'])),
            ('organizing_museum', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='workshop_organizer', null=True, to=orm['museums.Museum'])),
            ('organizer_title', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('organizer_url_link', self.gf('base_libs.models.fields.URLField')(max_length=200, blank=True)),
        )))
        db.send_create_signal('workshops', ['Organizer'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'Organizer'
        db.delete_table('workshops_organizer')
