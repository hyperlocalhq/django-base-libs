...
class Migration(SchemaMigration):
    def forwards(self, orm):
                # Adding field 'Event.shop_link'
        db.add_column(u'events_event', 'shop_link',
                      self.gf('base_libs.models.fields.MultilingualCharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.shop_link_de'
        db.add_column(u'events_event', 'shop_link_de',
        ...
        # Adding field 'Event.shop_link_en'
        db.add_column(u'events_event', 'shop_link_en',
                      self.gf('django.db.models.fields.CharField')(u'Buy ticket', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'Event.shop_link_fr'
        db.add_column(u'events_event', 'shop_link_fr',
                      self.gf('django.db.models.fields.CharField')(u'Buy ticket', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'Event.shop_link_pl'
        db.add_column(u'events_event', 'shop_link_pl',
                      self.gf('django.db.models.fields.CharField')(u'Buy ticket', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'Event.shop_link_tr'
        db.add_column(u'events_event', 'shop_link_tr',
                      self.gf('django.db.models.fields.CharField')(u'Buy ticket', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'Event.shop_link_es'
        db.add_column(u'events_event', 'shop_link_es',
                      self.gf('django.db.models.fields.CharField')(u'Buy ticket', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'Event.shop_link_it'
        db.add_column(u'events_event', 'shop_link_it',
                      self.gf('django.db.models.fields.CharField')(u'Buy ticket', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

    def backwards(self, orm):
                # Deleting field 'Event.shop_link'
        db.delete_column(u'events_event', 'shop_link')

        # Deleting field 'Event.shop_link_de'
        db.delete_column(u'events_event', 'shop_link_de')

        # Deleting field 'Event.shop_link_en'
        db.delete_column(u'events_event', 'shop_link_en')

        # Deleting field 'Event.shop_link_fr'
        db.delete_column(u'events_event', 'shop_link_fr')

        # Deleting field 'Event.shop_link_pl'
        db.delete_column(u'events_event', 'shop_link_pl')

        # Deleting field 'Event.shop_link_tr'
        db.delete_column(u'events_event', 'shop_link_tr')

        # Deleting field 'Event.shop_link_es'
        db.delete_column(u'events_event', 'shop_link_es')

        # Deleting field 'Event.shop_link_it'
        db.delete_column(u'events_event', 'shop_link_it')
