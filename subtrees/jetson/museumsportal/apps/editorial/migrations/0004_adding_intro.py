...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Intro'
        db.create_table('cmsplugin_intro', south_cleaned_fields((
            ...
            ('subdescription', self.gf('base_libs.models.fields.ExtendedTextField')(blank=True)),
            ('description_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False)),
            ('subdescription_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False)),
        )))
        db.send_create_signal('editorial', ['Intro'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'Intro'
        db.delete_table('cmsplugin_intro')
