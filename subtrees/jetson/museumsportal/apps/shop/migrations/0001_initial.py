...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'shop', ['ShopProductType'])
        ...
        db.send_create_signal(u'shop', ['ShopProductCategory'])

        # Adding model 'ShopProduct'
        db.create_table(u'shop_shopproduct', south_cleaned_fields((
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'shop', ['ShopProduct'])
        # Adding M2M table for field product_categories on 'ShopProduct'
        m2m_table_name = db.shorten_name(u'shop_shopproduct_product_categories')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('shopproduct', models.ForeignKey(orm[u'shop.shopproduct'], null=False)),
            ('shopproductcategory', models.ForeignKey(orm[u'shop.shopproductcategory'], null=False))
        ))
        db.create_unique(m2m_table_name, ['shopproduct_id', 'shopproductcategory_id'])

        # Adding M2M table for field product_types on 'ShopProduct'
        m2m_table_name = db.shorten_name(u'shop_shopproduct_product_types')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('shopproduct', models.ForeignKey(orm[u'shop.shopproduct'], null=False)),
            ('shopproducttype', models.ForeignKey(orm[u'shop.shopproducttype'], null=False))
        ))
        db.create_unique(m2m_table_name, ['shopproduct_id', 'shopproducttype_id'])

        # Adding M2M table for field languages on 'ShopProduct'
        m2m_table_name = db.shorten_name(u'shop_shopproduct_languages')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('shopproduct', models.ForeignKey(orm[u'shop.shopproduct'], null=False)),
            ('language', models.ForeignKey(orm[u'i18n.language'], null=False))
        ))
        db.create_unique(m2m_table_name, ['shopproduct_id', 'language_id'])

        # Adding M2M table for field museums on 'ShopProduct'
        m2m_table_name = db.shorten_name(u'shop_shopproduct_museums')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('shopproduct', models.ForeignKey(orm[u'shop.shopproduct'], null=False)),
            ('museum', models.ForeignKey(orm[u'museums.museum'], null=False))
        ))
        db.create_unique(m2m_table_name, ['shopproduct_id', 'museum_id'])

        # Adding M2M table for field exhibitions on 'ShopProduct'
        m2m_table_name = db.shorten_name(u'shop_shopproduct_exhibitions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('shopproduct', models.ForeignKey(orm[u'shop.shopproduct'], null=False)),
            ('exhibition', models.ForeignKey(orm[u'exhibitions.exhibition'], null=False))
        ))
        db.create_unique(m2m_table_name, ['shopproduct_id', 'exhibition_id'])

        # Adding M2M table for field events on 'ShopProduct'
        m2m_table_name = db.shorten_name(u'shop_shopproduct_events')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('shopproduct', models.ForeignKey(orm[u'shop.shopproduct'], null=False)),
            ('event', models.ForeignKey(orm[u'events.event'], null=False))
        ))
        db.create_unique(m2m_table_name, ['shopproduct_id', 'event_id'])

        # Adding M2M table for field workshops on 'ShopProduct'
        m2m_table_name = db.shorten_name(u'shop_shopproduct_workshops')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('shopproduct', models.ForeignKey(orm[u'shop.shopproduct'], null=False)),
            ('workshop', models.ForeignKey(orm[u'workshops.workshop'], null=False))
        ))
        db.create_unique(m2m_table_name, ['shopproduct_id', 'workshop_id'])

    
    
    def backwards(self, orm):
                # Deleting model 'ShopProductType'
        db.delete_table(u'shop_shopproducttype')

        # Deleting model 'ShopProductCategory'
        db.delete_table(u'shop_shopproductcategory')

        # Deleting model 'ShopProduct'
        db.delete_table(u'shop_shopproduct')

        # Removing M2M table for field product_categories on 'ShopProduct'
        db.delete_table(db.shorten_name(u'shop_shopproduct_product_categories'))

        # Removing M2M table for field product_types on 'ShopProduct'
        db.delete_table(db.shorten_name(u'shop_shopproduct_product_types'))

        # Removing M2M table for field languages on 'ShopProduct'
        db.delete_table(db.shorten_name(u'shop_shopproduct_languages'))

        # Removing M2M table for field museums on 'ShopProduct'
        db.delete_table(db.shorten_name(u'shop_shopproduct_museums'))

        # Removing M2M table for field exhibitions on 'ShopProduct'
        db.delete_table(db.shorten_name(u'shop_shopproduct_exhibitions'))

        # Removing M2M table for field events on 'ShopProduct'
        db.delete_table(db.shorten_name(u'shop_shopproduct_events'))

        # Removing M2M table for field workshops on 'ShopProduct'
        db.delete_table(db.shorten_name(u'shop_shopproduct_workshops'))
    ...
    models = {
        ...
        u'shop.shopproduct': {
            'Meta': {'ordering': "['title']", 'object_name': 'ShopProduct'},
            'creation_date': ('django.db.models.fields.DateTimeField', [], {}),
            'description': ('base_libs.models.fields.MultilingualTextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            'description_de': ('base_libs.models.fields.ExtendedTextField', ["u'Description'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'description_de_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            ...
            'description_tr': ('base_libs.models.fields.ExtendedTextField', ["u'Description'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'description_tr_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            'events': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['events.Event']", 'null': 'True', 'blank': 'True'}),
            'exhibitions': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['exhibitions.Exhibition']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('filebrowser.fields.FileBrowseField', [], {'directory': "'shop/'", 'max_length': '255', 'extensions': "['.jpg', '.jpeg', '.gif', '.png']"}),
            'is_featured': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_for_children': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_new': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'languages': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['i18n.Language']", 'null': 'True', 'blank': 'True'}),
            ...
            'title_pl': ('django.db.models.fields.CharField', ["u'Name'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'title_tr': ('django.db.models.fields.CharField', ["u'Name'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'workshops': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['workshops.Workshop']", 'null': 'True', 'blank': 'True'})
        },
