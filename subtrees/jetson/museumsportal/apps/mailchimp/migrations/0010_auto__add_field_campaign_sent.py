...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'mailchimp_campaign', 'sent',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'mailchimp_campaign', 'sent')
    ...
    models = {
        ...
        u'mailchimp.campaign': {
            ...
            'sender_email': ('django.db.models.fields.EmailField', [], {'default': "'museumsportal@kulturprojekte-berlin.de'", 'max_length': '75'}),
            'sender_name': ('django.db.models.fields.CharField', [], {'default': "'Museumsportal Berlin'", 'max_length': '255'}),
