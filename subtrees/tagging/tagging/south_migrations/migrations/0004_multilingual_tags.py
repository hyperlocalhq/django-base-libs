    ...
    def forwards(self, orm):
        ...
        for lang_code, lang_name in settings.LANGUAGES:
            if lang_code in ("en", "de"):
                # Adding field 'Tag.name_*'
                db.add_column('tagging_tag', 'name_%s' % lang_code, self.gf('django.db.models.fields.CharField')(u'name', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=50, db_tablespace='', blank=True, unique=False, db_index=True), keep_default=False)

        # Changing field 'Tag.name'
        db.alter_column('tagging_tag', 'name', self.gf('base_libs.models.fields.MultilingualCharField')(max_length=50, null=True))
    ...
    def backwards(self, orm):
        ...
        for lang_code, lang_name in settings.LANGUAGES:
            if lang_code in ("en", "de"):
                ...
                db.delete_column('tagging_tag', 'name_%s' % lang_code)

        # Changing field 'Tag.name'
        db.alter_column('tagging_tag', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=50, unique=True))
