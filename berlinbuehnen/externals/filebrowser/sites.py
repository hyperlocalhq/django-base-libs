...
class FileBrowserSite(object):
    ...
    def detail(self, request):
        ...
        if request.method == 'POST':
            ...
            form = ChangeForm(initial=dict(name=fileobject.filename, **file_description.__dict__), path=path, fileobject=fileobject, filebrowser_site=self, instance=file_description)
