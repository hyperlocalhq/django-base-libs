...
from berlinbuehnen.apps.mailchimp.models import Subscription
from berlinbuehnen.apps.mailchimp.models import MList
from berlinbuehnen.apps.mailchimp.models import Settings
