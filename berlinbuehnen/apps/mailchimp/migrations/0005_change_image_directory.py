...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'mailchimp_campaign', 'image', self.gf('filebrowser.fields.FileBrowseField')(directory='newsletter-headers/', max_length=255, extensions=['.jpg', '.jpeg', '.gif', '.png']))
    
    
    def backwards(self, orm):
        
        # Changing field 'Campaign.image'
        db.alter_column(u'mailchimp_campaign', 'image', self.gf('filebrowser.fields.FileBrowseField')(directory='uploads/', max_length=255, extensions=['.jpg', '.jpeg', '.gif', '.png']))
