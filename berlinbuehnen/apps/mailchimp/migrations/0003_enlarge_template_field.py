...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'mailchimp_campaign', 'template', self.gf('base_libs.models.fields.TemplatePathField')(path='mailchimp/campaign/', max_length=150, match='\\.html$'))
    
    
    def backwards(self, orm):
        
        # Changing field 'Campaign.template'
        db.alter_column(u'mailchimp_campaign', 'template', self.gf('base_libs.models.fields.TemplatePathField')(path='mailchimp/campaign/', max_length=100, match='\\.html$'))
