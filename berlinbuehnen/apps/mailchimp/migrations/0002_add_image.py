...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'mailchimp_campaign', 'image',
                      self.gf('filebrowser.fields.FileBrowseField')(directory='uploads/', default='', max_length=255, extensions=['.jpg', '.jpeg', '.gif', '.png']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'mailchimp_campaign', 'image')
