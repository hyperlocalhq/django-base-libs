...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MailingContentBlock.content_type'
        db.alter_column(u'mailchimp_mailingcontentblock', 'content_type', self.gf('django.db.models.fields.CharField')(max_length=40))
    
    
    def backwards(self, orm):
        
        # Changing field 'MailingContentBlock.content_type'
        db.alter_column(u'mailchimp_mailingcontentblock', 'content_type', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        u'mailchimp.campaign': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('filebrowser.fields.FileBrowseField', [], {'directory': "'newsletter-headers/'", 'max_length': '255', 'extensions': "['.jpg', '.jpeg', '.gif', '.png']"}),
            ...
            'sender_email': ('django.db.models.fields.EmailField', [], {'default': "u'berlin-buehnen@kulturprojekte-berlin.de'", 'max_length': '75'}),
            'sender_name': ('django.db.models.fields.CharField', [], {'default': "u'Berlin B\\xfchnen'", 'max_length': '255'}),
        ...
        u'mailchimp.mailingcontentblock': {
            ...
            'content_type': ('django.db.models.fields.CharField', [], {'max_length': '40', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
