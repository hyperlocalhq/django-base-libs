...
def get_blog_params(request, post_slug=None, **kwargs):
    ...
    # allow only one blog per site
    obj = None                  # request.current_page
    url_identifier = "blog"     # request.current_page.get_path()
...
def handle_request(request, year=None, month=None, day=None, post_slug=None, tag=None, status=STATUS_CODE_PUBLISHED, paginate_by=None, page=None, allow_future=False, allow_empty=True, extra_context={}, context_processors=None, **kwargs):
    """
