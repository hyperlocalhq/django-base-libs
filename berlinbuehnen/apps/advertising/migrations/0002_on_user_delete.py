...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AdBase.creator'
        db.alter_column(u'advertising_adbase', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'AdBase.modifier'
        db.alter_column(u'advertising_adbase', 'modifier_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))
    
    
    def backwards(self, orm):
        
        # Changing field 'AdBase.creator'
        db.alter_column(u'advertising_adbase', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'AdBase.modifier'
        db.alter_column(u'advertising_adbase', 'modifier_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
    ...
    models = {
        u'advertising.adbase': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'adbase_creator'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            ...
            'modifier': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'adbase_modifier'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            ...
            'stop_showing': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 12, 31, 0, 0)'}),
