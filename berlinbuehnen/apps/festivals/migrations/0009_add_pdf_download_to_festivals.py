...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FestivalPDF'
        db.create_table(u'festivals_festivalpdf', south_cleaned_fields((
            ...
            ('path', self.gf('filebrowser.fields.FileBrowseField')(directory='festivals/', max_length=255, extensions=['.pdf'])),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(default=None)),
        )))
        db.send_create_signal(u'festivals', ['FestivalPDF'])
    
    
    def backwards(self, orm):
                # Deleting model 'FestivalPDF'
        db.delete_table(u'festivals_festivalpdf')
