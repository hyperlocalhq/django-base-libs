...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Festival.creator'
        db.alter_column(u'festivals_festival', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'Festival.modifier'
        db.alter_column(u'festivals_festival', 'modifier_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))
    
    
    def backwards(self, orm):
        
        # Changing field 'Festival.creator'
        db.alter_column(u'festivals_festival', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Festival.modifier'
        db.alter_column(u'festivals_festival', 'modifier_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
    ...
    models = {
        ...
        u'festivals.festivalpdf': {
            'Meta': {'ordering': "['sort_order', 'creation_date']", 'object_name': 'FestivalPDF'},
            'creation_date': ('django.db.models.fields.DateTimeField', [], {}),
            'festival': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['festivals.Festival']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'path': ('filebrowser.fields.FileBrowseField', [], {'directory': "'festivals/'", 'max_length': '255', 'extensions': "['.pdf']"}),
