...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'Festival.is_appointment_based'
        db.add_column(u'festivals_festival', 'is_appointment_based',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Festival.mon_open'
        db.add_column(u'festivals_festival', 'mon_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.mon_break_close'
        db.add_column(u'festivals_festival', 'mon_break_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.mon_break_open'
        db.add_column(u'festivals_festival', 'mon_break_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.mon_close'
        db.add_column(u'festivals_festival', 'mon_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.tue_open'
        db.add_column(u'festivals_festival', 'tue_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.tue_break_close'
        db.add_column(u'festivals_festival', 'tue_break_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.tue_break_open'
        db.add_column(u'festivals_festival', 'tue_break_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.tue_close'
        db.add_column(u'festivals_festival', 'tue_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.wed_open'
        db.add_column(u'festivals_festival', 'wed_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.wed_break_close'
        db.add_column(u'festivals_festival', 'wed_break_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.wed_break_open'
        db.add_column(u'festivals_festival', 'wed_break_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.wed_close'
        db.add_column(u'festivals_festival', 'wed_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.thu_open'
        db.add_column(u'festivals_festival', 'thu_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.thu_break_close'
        db.add_column(u'festivals_festival', 'thu_break_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.thu_break_open'
        db.add_column(u'festivals_festival', 'thu_break_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.thu_close'
        db.add_column(u'festivals_festival', 'thu_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.fri_open'
        db.add_column(u'festivals_festival', 'fri_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.fri_break_close'
        db.add_column(u'festivals_festival', 'fri_break_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.fri_break_open'
        db.add_column(u'festivals_festival', 'fri_break_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.fri_close'
        db.add_column(u'festivals_festival', 'fri_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.sat_open'
        db.add_column(u'festivals_festival', 'sat_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.sat_break_close'
        db.add_column(u'festivals_festival', 'sat_break_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.sat_break_open'
        db.add_column(u'festivals_festival', 'sat_break_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.sat_close'
        db.add_column(u'festivals_festival', 'sat_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.sun_open'
        db.add_column(u'festivals_festival', 'sun_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.sun_break_close'
        db.add_column(u'festivals_festival', 'sun_break_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.sun_break_open'
        db.add_column(u'festivals_festival', 'sun_break_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.sun_close'
        db.add_column(u'festivals_festival', 'sun_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.exceptions'
        db.add_column(u'festivals_festival', 'exceptions',
                      self.gf('base_libs.models.fields.MultilingualTextField')(default='', null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.exceptions_de'
        db.add_column(u'festivals_festival', 'exceptions_de',
        ...
        # Adding field 'Festival.exceptions_de_markup_type'
        db.add_column(u'festivals_festival', 'exceptions_de_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Festival.exceptions_en'
        db.add_column(u'festivals_festival', 'exceptions_en',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Exceptions for working hours', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Festival.exceptions_en_markup_type'
        db.add_column(u'festivals_festival', 'exceptions_en_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
                # Deleting field 'Festival.is_appointment_based'
        db.delete_column(u'festivals_festival', 'is_appointment_based')

        # Deleting field 'Festival.mon_open'
        db.delete_column(u'festivals_festival', 'mon_open')

        # Deleting field 'Festival.mon_break_close'
        db.delete_column(u'festivals_festival', 'mon_break_close')

        # Deleting field 'Festival.mon_break_open'
        db.delete_column(u'festivals_festival', 'mon_break_open')

        # Deleting field 'Festival.mon_close'
        db.delete_column(u'festivals_festival', 'mon_close')

        # Deleting field 'Festival.tue_open'
        db.delete_column(u'festivals_festival', 'tue_open')

        # Deleting field 'Festival.tue_break_close'
        db.delete_column(u'festivals_festival', 'tue_break_close')

        # Deleting field 'Festival.tue_break_open'
        db.delete_column(u'festivals_festival', 'tue_break_open')

        # Deleting field 'Festival.tue_close'
        db.delete_column(u'festivals_festival', 'tue_close')

        # Deleting field 'Festival.wed_open'
        db.delete_column(u'festivals_festival', 'wed_open')

        # Deleting field 'Festival.wed_break_close'
        db.delete_column(u'festivals_festival', 'wed_break_close')

        # Deleting field 'Festival.wed_break_open'
        db.delete_column(u'festivals_festival', 'wed_break_open')

        # Deleting field 'Festival.wed_close'
        db.delete_column(u'festivals_festival', 'wed_close')

        # Deleting field 'Festival.thu_open'
        db.delete_column(u'festivals_festival', 'thu_open')

        # Deleting field 'Festival.thu_break_close'
        db.delete_column(u'festivals_festival', 'thu_break_close')

        # Deleting field 'Festival.thu_break_open'
        db.delete_column(u'festivals_festival', 'thu_break_open')

        # Deleting field 'Festival.thu_close'
        db.delete_column(u'festivals_festival', 'thu_close')

        # Deleting field 'Festival.fri_open'
        db.delete_column(u'festivals_festival', 'fri_open')

        # Deleting field 'Festival.fri_break_close'
        db.delete_column(u'festivals_festival', 'fri_break_close')

        # Deleting field 'Festival.fri_break_open'
        db.delete_column(u'festivals_festival', 'fri_break_open')

        # Deleting field 'Festival.fri_close'
        db.delete_column(u'festivals_festival', 'fri_close')

        # Deleting field 'Festival.sat_open'
        db.delete_column(u'festivals_festival', 'sat_open')

        # Deleting field 'Festival.sat_break_close'
        db.delete_column(u'festivals_festival', 'sat_break_close')

        # Deleting field 'Festival.sat_break_open'
        db.delete_column(u'festivals_festival', 'sat_break_open')

        # Deleting field 'Festival.sat_close'
        db.delete_column(u'festivals_festival', 'sat_close')

        # Deleting field 'Festival.sun_open'
        db.delete_column(u'festivals_festival', 'sun_open')

        # Deleting field 'Festival.sun_break_close'
        db.delete_column(u'festivals_festival', 'sun_break_close')

        # Deleting field 'Festival.sun_break_open'
        db.delete_column(u'festivals_festival', 'sun_break_open')

        # Deleting field 'Festival.sun_close'
        db.delete_column(u'festivals_festival', 'sun_close')

        # Deleting field 'Festival.exceptions'
        db.delete_column(u'festivals_festival', 'exceptions')

        # Deleting field 'Festival.exceptions_de'
        db.delete_column(u'festivals_festival', 'exceptions_de')

        # Deleting field 'Festival.exceptions_de_markup_type'
        db.delete_column(u'festivals_festival', 'exceptions_de_markup_type')

        # Deleting field 'Festival.exceptions_en'
        db.delete_column(u'festivals_festival', 'exceptions_en')

        # Deleting field 'Festival.exceptions_en_markup_type'
        db.delete_column(u'festivals_festival', 'exceptions_en_markup_type')
