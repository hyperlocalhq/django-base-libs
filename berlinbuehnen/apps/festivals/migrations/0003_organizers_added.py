...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding M2M table for field organizers on 'Festival'
        m2m_table_name = db.shorten_name(u'festivals_festival_organizers')
        ...
        db.create_unique(m2m_table_name, ['festival_id', 'location_id'])

    
    
    def backwards(self, orm):
                # Removing M2M table for field organizers on 'Festival'
        db.delete_table(db.shorten_name(u'festivals_festival_organizers'))
