...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'Festival.logo'
        db.add_column(u'festivals_festival', 'logo',
                      self.gf('filebrowser.fields.FileBrowseField')(directory='festivals/', default='', max_length=255, extensions=['.jpg', '.jpeg', '.gif', '.png'], blank=True),
                      keep_default=False)

        # Adding field 'Festival.phone_country'
        db.add_column(u'festivals_festival', 'phone_country',
                      self.gf('django.db.models.fields.CharField')(default='49', max_length=4, blank=True),
                      keep_default=False)

        # Adding field 'Festival.phone_area'
        db.add_column(u'festivals_festival', 'phone_area',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=6, blank=True),
                      keep_default=False)

        # Adding field 'Festival.phone_number'
        db.add_column(u'festivals_festival', 'phone_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'Festival.fax_country'
        db.add_column(u'festivals_festival', 'fax_country',
                      self.gf('django.db.models.fields.CharField')(default='49', max_length=4, blank=True),
                      keep_default=False)

        # Adding field 'Festival.fax_area'
        db.add_column(u'festivals_festival', 'fax_area',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=6, blank=True),
                      keep_default=False)

        # Adding field 'Festival.fax_number'
        db.add_column(u'festivals_festival', 'fax_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'Festival.email'
        db.add_column(u'festivals_festival', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Festival.tickets_street_address'
        db.add_column(u'festivals_festival', 'tickets_street_address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Festival.tickets_street_address2'
        db.add_column(u'festivals_festival', 'tickets_street_address2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Festival.tickets_postal_code'
        db.add_column(u'festivals_festival', 'tickets_postal_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Festival.tickets_city'
        db.add_column(u'festivals_festival', 'tickets_city',
                      self.gf('django.db.models.fields.CharField')(default='Berlin', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Festival.tickets_email'
        db.add_column(u'festivals_festival', 'tickets_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Festival.tickets_website'
        db.add_column(u'festivals_festival', 'tickets_website',
                      self.gf('base_libs.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Festival.tickets_phone_country'
        db.add_column(u'festivals_festival', 'tickets_phone_country',
                      self.gf('django.db.models.fields.CharField')(default='49', max_length=4, blank=True),
                      keep_default=False)

        # Adding field 'Festival.tickets_phone_area'
        db.add_column(u'festivals_festival', 'tickets_phone_area',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=6, blank=True),
                      keep_default=False)

        # Adding field 'Festival.tickets_phone_number'
        db.add_column(u'festivals_festival', 'tickets_phone_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'Festival.tickets_fax_country'
        db.add_column(u'festivals_festival', 'tickets_fax_country',
                      self.gf('django.db.models.fields.CharField')(default='49', max_length=4, blank=True),
                      keep_default=False)

        # Adding field 'Festival.tickets_fax_area'
        db.add_column(u'festivals_festival', 'tickets_fax_area',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=6, blank=True),
                      keep_default=False)

        # Adding field 'Festival.tickets_fax_number'
        db.add_column(u'festivals_festival', 'tickets_fax_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'Festival.tickets_calling_prices'
        db.add_column(u'festivals_festival', 'tickets_calling_prices',
                      self.gf('base_libs.models.fields.MultilingualTextField')(default='', null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.press_contact_name'
        db.add_column(u'festivals_festival', 'press_contact_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Festival.press_phone_country'
        db.add_column(u'festivals_festival', 'press_phone_country',
                      self.gf('django.db.models.fields.CharField')(default='49', max_length=4, blank=True),
                      keep_default=False)

        # Adding field 'Festival.press_phone_area'
        db.add_column(u'festivals_festival', 'press_phone_area',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=6, blank=True),
                      keep_default=False)

        # Adding field 'Festival.press_phone_number'
        db.add_column(u'festivals_festival', 'press_phone_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'Festival.press_fax_country'
        db.add_column(u'festivals_festival', 'press_fax_country',
                      self.gf('django.db.models.fields.CharField')(default='49', max_length=4, blank=True),
                      keep_default=False)

        # Adding field 'Festival.press_fax_area'
        db.add_column(u'festivals_festival', 'press_fax_area',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=6, blank=True),
                      keep_default=False)

        # Adding field 'Festival.press_fax_number'
        db.add_column(u'festivals_festival', 'press_fax_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'Festival.press_email'
        db.add_column(u'festivals_festival', 'press_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Festival.press_website'
        db.add_column(u'festivals_festival', 'press_website',
                      self.gf('base_libs.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Festival.tickets_calling_prices_de'
        db.add_column(u'festivals_festival', 'tickets_calling_prices_de',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Phone calling prices', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Festival.tickets_calling_prices_de_markup_type'
        db.add_column(u'festivals_festival', 'tickets_calling_prices_de_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Festival.tickets_calling_prices_en'
        db.add_column(u'festivals_festival', 'tickets_calling_prices_en',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Phone calling prices', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Festival.tickets_calling_prices_en_markup_type'
        db.add_column(u'festivals_festival', 'tickets_calling_prices_en_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
                # Deleting field 'Festival.logo'
        db.delete_column(u'festivals_festival', 'logo')

        # Deleting field 'Festival.phone_country'
        db.delete_column(u'festivals_festival', 'phone_country')

        # Deleting field 'Festival.phone_area'
        db.delete_column(u'festivals_festival', 'phone_area')

        # Deleting field 'Festival.phone_number'
        db.delete_column(u'festivals_festival', 'phone_number')

        # Deleting field 'Festival.fax_country'
        db.delete_column(u'festivals_festival', 'fax_country')

        # Deleting field 'Festival.fax_area'
        db.delete_column(u'festivals_festival', 'fax_area')

        # Deleting field 'Festival.fax_number'
        db.delete_column(u'festivals_festival', 'fax_number')

        # Deleting field 'Festival.email'
        db.delete_column(u'festivals_festival', 'email')

        # Deleting field 'Festival.tickets_street_address'
        db.delete_column(u'festivals_festival', 'tickets_street_address')

        # Deleting field 'Festival.tickets_street_address2'
        db.delete_column(u'festivals_festival', 'tickets_street_address2')

        # Deleting field 'Festival.tickets_postal_code'
        db.delete_column(u'festivals_festival', 'tickets_postal_code')

        # Deleting field 'Festival.tickets_city'
        db.delete_column(u'festivals_festival', 'tickets_city')

        # Deleting field 'Festival.tickets_email'
        db.delete_column(u'festivals_festival', 'tickets_email')

        # Deleting field 'Festival.tickets_website'
        db.delete_column(u'festivals_festival', 'tickets_website')

        # Deleting field 'Festival.tickets_phone_country'
        db.delete_column(u'festivals_festival', 'tickets_phone_country')

        # Deleting field 'Festival.tickets_phone_area'
        db.delete_column(u'festivals_festival', 'tickets_phone_area')

        # Deleting field 'Festival.tickets_phone_number'
        db.delete_column(u'festivals_festival', 'tickets_phone_number')

        # Deleting field 'Festival.tickets_fax_country'
        db.delete_column(u'festivals_festival', 'tickets_fax_country')

        # Deleting field 'Festival.tickets_fax_area'
        db.delete_column(u'festivals_festival', 'tickets_fax_area')

        # Deleting field 'Festival.tickets_fax_number'
        db.delete_column(u'festivals_festival', 'tickets_fax_number')

        # Deleting field 'Festival.tickets_calling_prices'
        db.delete_column(u'festivals_festival', 'tickets_calling_prices')

        # Deleting field 'Festival.press_contact_name'
        db.delete_column(u'festivals_festival', 'press_contact_name')

        # Deleting field 'Festival.press_phone_country'
        db.delete_column(u'festivals_festival', 'press_phone_country')

        # Deleting field 'Festival.press_phone_area'
        db.delete_column(u'festivals_festival', 'press_phone_area')

        # Deleting field 'Festival.press_phone_number'
        db.delete_column(u'festivals_festival', 'press_phone_number')

        # Deleting field 'Festival.press_fax_country'
        db.delete_column(u'festivals_festival', 'press_fax_country')

        # Deleting field 'Festival.press_fax_area'
        db.delete_column(u'festivals_festival', 'press_fax_area')

        # Deleting field 'Festival.press_fax_number'
        db.delete_column(u'festivals_festival', 'press_fax_number')

        # Deleting field 'Festival.press_email'
        db.delete_column(u'festivals_festival', 'press_email')

        # Deleting field 'Festival.press_website'
        db.delete_column(u'festivals_festival', 'press_website')

        # Deleting field 'Festival.tickets_calling_prices_de'
        db.delete_column(u'festivals_festival', 'tickets_calling_prices_de')

        # Deleting field 'Festival.tickets_calling_prices_de_markup_type'
        db.delete_column(u'festivals_festival', 'tickets_calling_prices_de_markup_type')

        # Deleting field 'Festival.tickets_calling_prices_en'
        db.delete_column(u'festivals_festival', 'tickets_calling_prices_en')

        # Deleting field 'Festival.tickets_calling_prices_en_markup_type'
        db.delete_column(u'festivals_festival', 'tickets_calling_prices_en_markup_type')
    ...
    models = {
        ...
        u'festivals.socialmediachannel': {
