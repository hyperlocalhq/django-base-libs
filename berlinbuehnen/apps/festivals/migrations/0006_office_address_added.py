...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'Festival.street_address'
        db.add_column(u'festivals_festival', 'street_address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Festival.street_address2'
        db.add_column(u'festivals_festival', 'street_address2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Festival.postal_code'
        db.add_column(u'festivals_festival', 'postal_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Festival.city'
        db.add_column(u'festivals_festival', 'city',
                      self.gf('django.db.models.fields.CharField')(default='Berlin', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Festival.latitude'
        db.add_column(u'festivals_festival', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Festival.longitude'
        db.add_column(u'festivals_festival', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
                # Deleting field 'Festival.street_address'
        db.delete_column(u'festivals_festival', 'street_address')

        # Deleting field 'Festival.street_address2'
        db.delete_column(u'festivals_festival', 'street_address2')

        # Deleting field 'Festival.postal_code'
        db.delete_column(u'festivals_festival', 'postal_code')

        # Deleting field 'Festival.city'
        db.delete_column(u'festivals_festival', 'city')

        # Deleting field 'Festival.latitude'
        db.delete_column(u'festivals_festival', 'latitude')

        # Deleting field 'Festival.longitude'
        db.delete_column(u'festivals_festival', 'longitude')
