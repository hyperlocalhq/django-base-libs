...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'Festival.slideshow'
        db.add_column(u'festivals_festival', 'slideshow',
    ...
    def backwards(self, orm):
                # Deleting field 'Festival.slideshow'
        db.delete_column(u'festivals_festival', 'slideshow')
