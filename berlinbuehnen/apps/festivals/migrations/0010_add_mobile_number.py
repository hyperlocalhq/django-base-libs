...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'Festival.press_mobile_country'
        db.add_column(u'festivals_festival', 'press_mobile_country',
                      self.gf('django.db.models.fields.CharField')(default='49', max_length=4, blank=True),
                      keep_default=False)

        # Adding field 'Festival.press_mobile_area'
        db.add_column(u'festivals_festival', 'press_mobile_area',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=6, blank=True),
                      keep_default=False)

        # Adding field 'Festival.press_mobile_number'
        db.add_column(u'festivals_festival', 'press_mobile_number',
    ...
    def backwards(self, orm):
                # Deleting field 'Festival.press_mobile_country'
        db.delete_column(u'festivals_festival', 'press_mobile_country')

        # Deleting field 'Festival.press_mobile_area'
        db.delete_column(u'festivals_festival', 'press_mobile_area')

        # Deleting field 'Festival.press_mobile_number'
        db.delete_column(u'festivals_festival', 'press_mobile_number')
