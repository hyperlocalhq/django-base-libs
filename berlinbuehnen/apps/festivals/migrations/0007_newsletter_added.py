...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'Festival.newsletter'
        db.add_column(u'festivals_festival', 'newsletter',
    ...
    def backwards(self, orm):
                # Deleting field 'Festival.newsletter'
        db.delete_column(u'festivals_festival', 'newsletter')
