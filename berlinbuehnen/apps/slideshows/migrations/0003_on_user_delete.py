...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Slide.author'
        db.alter_column(u'slideshows_slide', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))
    
    
    def backwards(self, orm):
        
        # Changing field 'Slide.author'
        db.alter_column(u'slideshows_slide', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
    ...
    models = {
        ...
        u'slideshows.slide': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'slide_author'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
