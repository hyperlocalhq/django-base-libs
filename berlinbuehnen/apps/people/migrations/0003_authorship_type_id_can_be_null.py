...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.authorship_type'
        db.alter_column(u'people_person', 'authorship_type_id', self.gf('django.db.models.fields.related.ForeignKey')(max_length=255, to=orm['people.AuthorshipType'], null=True))
    
    
    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Person.authorship_type'
        raise RuntimeError("Cannot reverse this migration. 'Person.authorship_type' and its values cannot be restored.")
