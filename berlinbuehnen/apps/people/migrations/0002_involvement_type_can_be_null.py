...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.involvement_type'
        db.alter_column(u'people_person', 'involvement_type_id', self.gf('django.db.models.fields.related.ForeignKey')(max_length=255, to=orm['people.InvolvementType'], null=True))
    
    
    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Person.involvement_type'
        raise RuntimeError("Cannot reverse this migration. 'Person.involvement_type' and its values cannot be restored.")
