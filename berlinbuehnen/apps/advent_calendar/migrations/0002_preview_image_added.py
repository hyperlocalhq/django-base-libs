...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'Day.preview_image'
        db.add_column(u'advent_calendar_day', 'preview_image',
    ...
    def backwards(self, orm):
                # Deleting field 'Day.preview_image'
        db.delete_column(u'advent_calendar_day', 'preview_image')
