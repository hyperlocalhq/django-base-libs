...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Day'
        db.create_table(u'advent_calendar_day', south_cleaned_fields((
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('modified_date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='day_creator', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ('modifier', self.gf('django.db.models.fields.related.ForeignKey')(related_name='day_modifier', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ...
            ('description', self.gf('base_libs.models.fields.MultilingualTextField')(default='', null=True)),
            ('image', self.gf('filebrowser.fields.FileBrowseField')(directory=u'advent-calendar/', max_length=255, extensions=[u'.jpg', u'.jpeg', u'.gif', u'.png'], blank=True)),
        ...
        db.send_create_signal(u'advent_calendar', ['Day'])
    
    
    def backwards(self, orm):
                # Deleting model 'Day'
        db.delete_table(u'advent_calendar_day')
    ...
    models = {
        u'advent_calendar.day': {
            ...
            'image': ('filebrowser.fields.FileBrowseField', [], {'directory': "u'advent-calendar/'", 'max_length': '255', 'extensions': "[u'.jpg', u'.jpeg', u'.gif', u'.png']", 'blank': 'True'}),
