...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'favorites_favorite', south_cleaned_fields((
        ...
        db.send_create_signal(u'favorites', ['Favorite'])

        # Adding model 'FavoriteListOptions'
        db.create_table(u'favorites_favoritelistoptions', south_cleaned_fields((
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('modified_date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ...
        db.send_create_signal(u'favorites', ['FavoriteListOptions'])
    
    
    def backwards(self, orm):
                # Deleting model 'Favorite'
        db.delete_table(u'favorites_favorite')

        # Deleting model 'FavoriteListOptions'
        db.delete_table(u'favorites_favoritelistoptions')
    ...
    models = {
        ...
        u'favorites.favorite': {
            'Meta': {'ordering': "('-creation_date',)", 'object_name': 'Favorite'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
        ...
        u'favorites.favoritelistoptions': {
            'Meta': {'ordering': "('-creation_date',)", 'object_name': 'FavoriteListOptions'},
            'creation_date': ('django.db.models.fields.DateTimeField', [], {}),
