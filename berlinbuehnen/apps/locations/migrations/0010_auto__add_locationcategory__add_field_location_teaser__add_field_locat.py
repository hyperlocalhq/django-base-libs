...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'locations_locationcategory', south_cleaned_fields((
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('modified_date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=255)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['locations.LocationCategory'])),
        ...
        db.send_create_signal(u'locations', ['LocationCategory'])
        # Adding field 'Location.teaser'
        db.add_column(u'locations_location', 'teaser',
                      self.gf('base_libs.models.fields.MultilingualTextField')(default='', null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.district'
        db.add_column(u'locations_location', 'district',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Location.teaser_de'
        db.add_column(u'locations_location', 'teaser_de',
        ...
        # Adding field 'Location.teaser_de_markup_type'
        db.add_column(u'locations_location', 'teaser_de_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Location.teaser_en'
        db.add_column(u'locations_location', 'teaser_en',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Teaser', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Location.teaser_en_markup_type'
        db.add_column(u'locations_location', 'teaser_en_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding M2M table for field categories on 'Location'
        m2m_table_name = db.shorten_name(u'locations_location_categories')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('location', models.ForeignKey(orm[u'locations.location'], null=False)),
            ('locationcategory', models.ForeignKey(orm[u'locations.locationcategory'], null=False))
        ))
        db.create_unique(m2m_table_name, ['location_id', 'locationcategory_id'])

    
    
    def backwards(self, orm):
                # Deleting model 'LocationCategory'
        db.delete_table(u'locations_locationcategory')

        # Deleting field 'Location.teaser'
        db.delete_column(u'locations_location', 'teaser')

        # Deleting field 'Location.district'
        db.delete_column(u'locations_location', 'district')

        # Deleting field 'Location.teaser_de'
        db.delete_column(u'locations_location', 'teaser_de')

        # Deleting field 'Location.teaser_de_markup_type'
        db.delete_column(u'locations_location', 'teaser_de_markup_type')

        # Deleting field 'Location.teaser_en'
        db.delete_column(u'locations_location', 'teaser_en')

        # Deleting field 'Location.teaser_en_markup_type'
        db.delete_column(u'locations_location', 'teaser_en_markup_type')

        # Removing M2M table for field categories on 'Location'
        db.delete_table(db.shorten_name(u'locations_location_categories'))
