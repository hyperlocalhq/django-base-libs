...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'Location.tickets_calling_prices'
        db.add_column(u'locations_location', 'tickets_calling_prices',
                      self.gf('base_libs.models.fields.MultilingualTextField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.tickets_calling_prices_de'
        db.add_column(u'locations_location', 'tickets_calling_prices_de',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Phone calling prices', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=255, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Location.tickets_calling_prices_de_markup_type'
        db.add_column(u'locations_location', 'tickets_calling_prices_de_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Location.tickets_calling_prices_en'
        db.add_column(u'locations_location', 'tickets_calling_prices_en',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Phone calling prices', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=255, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Location.tickets_calling_prices_en_markup_type'
        db.add_column(u'locations_location', 'tickets_calling_prices_en_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
                # Deleting field 'Location.tickets_calling_prices'
        db.delete_column(u'locations_location', 'tickets_calling_prices')

        # Deleting field 'Location.tickets_calling_prices_de'
        db.delete_column(u'locations_location', 'tickets_calling_prices_de')

        # Deleting field 'Location.tickets_calling_prices_de_markup_type'
        db.delete_column(u'locations_location', 'tickets_calling_prices_de_markup_type')

        # Deleting field 'Location.tickets_calling_prices_en'
        db.delete_column(u'locations_location', 'tickets_calling_prices_en')

        # Deleting field 'Location.tickets_calling_prices_en_markup_type'
        db.delete_column(u'locations_location', 'tickets_calling_prices_en_markup_type')
    ...
    models = {
        ...
        u'locations.location': {
            ...
            'tickets_calling_prices': ('base_libs.models.fields.MultilingualTextField', [], {'default': "''", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'tickets_calling_prices_de': ('base_libs.models.fields.ExtendedTextField', ["u'Phone calling prices'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': '255', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'tickets_calling_prices_de_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            'tickets_calling_prices_en': ('base_libs.models.fields.ExtendedTextField', ["u'Phone calling prices'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': '255', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
