...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Removing M2M table for field distric on 'Location'
        db.delete_table(db.shorten_name(u'locations_location_distric'))

        # Adding M2M table for field districs on 'Location'
        m2m_table_name = db.shorten_name(u'locations_location_districs')
        ...
        db.create_unique(m2m_table_name, ['location_id', 'district_id'])

    
    
    def backwards(self, orm):
                # Adding M2M table for field distric on 'Location'
        m2m_table_name = db.shorten_name(u'locations_location_distric')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('location', models.ForeignKey(orm[u'locations.location'], null=False)),
            ('district', models.ForeignKey(orm[u'locations.district'], null=False))
        ...
        # Removing M2M table for field districs on 'Location'
        db.delete_table(db.shorten_name(u'locations_location_districs'))
    ...
    models = {
        ...
        u'locations.location': {
            ...
            'districs': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['locations.District']", 'symmetrical': 'False', 'blank': 'True'}),
