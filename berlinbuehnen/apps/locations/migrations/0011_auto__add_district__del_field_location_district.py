...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'locations_district', south_cleaned_fields((
    ...
    models = {
        ...
        u'locations.location': {
            ...
            'distric': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['locations.District']", 'symmetrical': 'False', 'blank': 'True'}),
