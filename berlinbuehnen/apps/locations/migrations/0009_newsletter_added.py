...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'Location.newsletter'
        db.add_column(u'locations_location', 'newsletter',
    ...
    def backwards(self, orm):
                # Deleting field 'Location.newsletter'
        db.delete_column(u'locations_location', 'newsletter')
