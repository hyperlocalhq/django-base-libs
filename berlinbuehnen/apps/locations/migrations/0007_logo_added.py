...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'locations_location', 'logo',
                      self.gf('filebrowser.fields.FileBrowseField')(directory='locations/', default='', max_length=255, extensions=['.jpg', '.jpeg', '.gif', '.png'], blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'locations_location', 'logo')
