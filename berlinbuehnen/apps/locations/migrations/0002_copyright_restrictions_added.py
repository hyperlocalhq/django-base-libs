...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'Image.copyright_restrictions'
        db.add_column(u'locations_image', 'copyright_restrictions',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)


        # Changing field 'Location.title_de'
        db.alter_column(u'locations_location', 'title_de', self.gf('django.db.models.fields.CharField')(u'Title', null=False, primary_key=False, db_column=None, editable=True, max_length=255, db_tablespace='', unique=False))

        # Changing field 'Location.title_en'
        db.alter_column(u'locations_location', 'title_en', self.gf('django.db.models.fields.CharField')(u'Title', null=False, primary_key=False, db_column=None, editable=True, max_length=255, db_tablespace='', unique=False))

        # Changing field 'Stage.title_de'
        db.alter_column(u'locations_stage', 'title_de', self.gf('django.db.models.fields.CharField')(u'Title', null=False, primary_key=False, db_column=None, editable=True, max_length=255, db_tablespace='', unique=False))

        # Changing field 'Stage.title_en'
        db.alter_column(u'locations_stage', 'title_en', self.gf('django.db.models.fields.CharField')(u'Title', null=False, primary_key=False, db_column=None, editable=True, max_length=255, db_tablespace='', unique=False))
    
    
    def backwards(self, orm):
                # Deleting field 'Image.copyright_restrictions'
        db.delete_column(u'locations_image', 'copyright_restrictions')


        # Changing field 'Location.title_de'
        db.alter_column(u'locations_location', 'title_de', self.gf('django.db.models.fields.CharField')(u'Name', unique=False, max_length=255, primary_key=False, db_column=None, null=False, editable=True, db_tablespace=''))

        # Changing field 'Location.title_en'
        db.alter_column(u'locations_location', 'title_en', self.gf('django.db.models.fields.CharField')(u'Name', unique=False, max_length=255, primary_key=False, db_column=None, null=False, editable=True, db_tablespace=''))

        # Changing field 'Stage.title_de'
        db.alter_column(u'locations_stage', 'title_de', self.gf('django.db.models.fields.CharField')(u'Name', unique=False, max_length=255, primary_key=False, db_column=None, null=False, editable=True, db_tablespace=''))

        # Changing field 'Stage.title_en'
        db.alter_column(u'locations_stage', 'title_en', self.gf('django.db.models.fields.CharField')(u'Name', unique=False, max_length=255, primary_key=False, db_column=None, null=False, editable=True, db_tablespace=''))
