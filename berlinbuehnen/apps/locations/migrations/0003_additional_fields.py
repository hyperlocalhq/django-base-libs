...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'Location.is_appointment_based'
        db.add_column(u'locations_location', 'is_appointment_based',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Location.mon_open'
        db.add_column(u'locations_location', 'mon_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.mon_break_close'
        db.add_column(u'locations_location', 'mon_break_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.mon_break_open'
        db.add_column(u'locations_location', 'mon_break_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.mon_close'
        db.add_column(u'locations_location', 'mon_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.tue_open'
        db.add_column(u'locations_location', 'tue_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.tue_break_close'
        db.add_column(u'locations_location', 'tue_break_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.tue_break_open'
        db.add_column(u'locations_location', 'tue_break_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.tue_close'
        db.add_column(u'locations_location', 'tue_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.wed_open'
        db.add_column(u'locations_location', 'wed_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.wed_break_close'
        db.add_column(u'locations_location', 'wed_break_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.wed_break_open'
        db.add_column(u'locations_location', 'wed_break_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.wed_close'
        db.add_column(u'locations_location', 'wed_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.thu_open'
        db.add_column(u'locations_location', 'thu_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.thu_break_close'
        db.add_column(u'locations_location', 'thu_break_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.thu_break_open'
        db.add_column(u'locations_location', 'thu_break_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.thu_close'
        db.add_column(u'locations_location', 'thu_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.fri_open'
        db.add_column(u'locations_location', 'fri_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.fri_break_close'
        db.add_column(u'locations_location', 'fri_break_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.fri_break_open'
        db.add_column(u'locations_location', 'fri_break_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.fri_close'
        db.add_column(u'locations_location', 'fri_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.sat_open'
        db.add_column(u'locations_location', 'sat_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.sat_break_close'
        db.add_column(u'locations_location', 'sat_break_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.sat_break_open'
        db.add_column(u'locations_location', 'sat_break_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.sat_close'
        db.add_column(u'locations_location', 'sat_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.sun_open'
        db.add_column(u'locations_location', 'sun_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.sun_break_close'
        db.add_column(u'locations_location', 'sun_break_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.sun_break_open'
        db.add_column(u'locations_location', 'sun_break_open',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.sun_close'
        db.add_column(u'locations_location', 'sun_close',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.exceptions'
        db.add_column(u'locations_location', 'exceptions',
                      self.gf('base_libs.models.fields.MultilingualTextField')(default='', null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.tickets_phone_country'
        db.add_column(u'locations_location', 'tickets_phone_country',
                      self.gf('django.db.models.fields.CharField')(default='49', max_length=4, blank=True),
                      keep_default=False)

        # Adding field 'Location.tickets_phone_area'
        db.add_column(u'locations_location', 'tickets_phone_area',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=6, blank=True),
                      keep_default=False)

        # Adding field 'Location.tickets_phone_number'
        db.add_column(u'locations_location', 'tickets_phone_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'Location.tickets_fax_country'
        db.add_column(u'locations_location', 'tickets_fax_country',
                      self.gf('django.db.models.fields.CharField')(default='49', max_length=4, blank=True),
                      keep_default=False)

        # Adding field 'Location.tickets_fax_area'
        db.add_column(u'locations_location', 'tickets_fax_area',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=6, blank=True),
                      keep_default=False)

        # Adding field 'Location.tickets_fax_number'
        db.add_column(u'locations_location', 'tickets_fax_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'Location.exceptions_de'
        db.add_column(u'locations_location', 'exceptions_de',
        ...
        # Adding field 'Location.exceptions_de_markup_type'
        db.add_column(u'locations_location', 'exceptions_de_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Location.exceptions_en'
        db.add_column(u'locations_location', 'exceptions_en',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Exceptions for working hours', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Location.exceptions_en_markup_type'
        db.add_column(u'locations_location', 'exceptions_en_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
                # Deleting field 'Location.is_appointment_based'
        db.delete_column(u'locations_location', 'is_appointment_based')

        # Deleting field 'Location.mon_open'
        db.delete_column(u'locations_location', 'mon_open')

        # Deleting field 'Location.mon_break_close'
        db.delete_column(u'locations_location', 'mon_break_close')

        # Deleting field 'Location.mon_break_open'
        db.delete_column(u'locations_location', 'mon_break_open')

        # Deleting field 'Location.mon_close'
        db.delete_column(u'locations_location', 'mon_close')

        # Deleting field 'Location.tue_open'
        db.delete_column(u'locations_location', 'tue_open')

        # Deleting field 'Location.tue_break_close'
        db.delete_column(u'locations_location', 'tue_break_close')

        # Deleting field 'Location.tue_break_open'
        db.delete_column(u'locations_location', 'tue_break_open')

        # Deleting field 'Location.tue_close'
        db.delete_column(u'locations_location', 'tue_close')

        # Deleting field 'Location.wed_open'
        db.delete_column(u'locations_location', 'wed_open')

        # Deleting field 'Location.wed_break_close'
        db.delete_column(u'locations_location', 'wed_break_close')

        # Deleting field 'Location.wed_break_open'
        db.delete_column(u'locations_location', 'wed_break_open')

        # Deleting field 'Location.wed_close'
        db.delete_column(u'locations_location', 'wed_close')

        # Deleting field 'Location.thu_open'
        db.delete_column(u'locations_location', 'thu_open')

        # Deleting field 'Location.thu_break_close'
        db.delete_column(u'locations_location', 'thu_break_close')

        # Deleting field 'Location.thu_break_open'
        db.delete_column(u'locations_location', 'thu_break_open')

        # Deleting field 'Location.thu_close'
        db.delete_column(u'locations_location', 'thu_close')

        # Deleting field 'Location.fri_open'
        db.delete_column(u'locations_location', 'fri_open')

        # Deleting field 'Location.fri_break_close'
        db.delete_column(u'locations_location', 'fri_break_close')

        # Deleting field 'Location.fri_break_open'
        db.delete_column(u'locations_location', 'fri_break_open')

        # Deleting field 'Location.fri_close'
        db.delete_column(u'locations_location', 'fri_close')

        # Deleting field 'Location.sat_open'
        db.delete_column(u'locations_location', 'sat_open')

        # Deleting field 'Location.sat_break_close'
        db.delete_column(u'locations_location', 'sat_break_close')

        # Deleting field 'Location.sat_break_open'
        db.delete_column(u'locations_location', 'sat_break_open')

        # Deleting field 'Location.sat_close'
        db.delete_column(u'locations_location', 'sat_close')

        # Deleting field 'Location.sun_open'
        db.delete_column(u'locations_location', 'sun_open')

        # Deleting field 'Location.sun_break_close'
        db.delete_column(u'locations_location', 'sun_break_close')

        # Deleting field 'Location.sun_break_open'
        db.delete_column(u'locations_location', 'sun_break_open')

        # Deleting field 'Location.sun_close'
        db.delete_column(u'locations_location', 'sun_close')

        # Deleting field 'Location.exceptions'
        db.delete_column(u'locations_location', 'exceptions')

        # Deleting field 'Location.tickets_phone_country'
        db.delete_column(u'locations_location', 'tickets_phone_country')

        # Deleting field 'Location.tickets_phone_area'
        db.delete_column(u'locations_location', 'tickets_phone_area')

        # Deleting field 'Location.tickets_phone_number'
        db.delete_column(u'locations_location', 'tickets_phone_number')

        # Deleting field 'Location.tickets_fax_country'
        db.delete_column(u'locations_location', 'tickets_fax_country')

        # Deleting field 'Location.tickets_fax_area'
        db.delete_column(u'locations_location', 'tickets_fax_area')

        # Deleting field 'Location.tickets_fax_number'
        db.delete_column(u'locations_location', 'tickets_fax_number')

        # Deleting field 'Location.exceptions_de'
        db.delete_column(u'locations_location', 'exceptions_de')

        # Deleting field 'Location.exceptions_de_markup_type'
        db.delete_column(u'locations_location', 'exceptions_de_markup_type')

        # Deleting field 'Location.exceptions_en'
        db.delete_column(u'locations_location', 'exceptions_en')

        # Deleting field 'Location.exceptions_en_markup_type'
        db.delete_column(u'locations_location', 'exceptions_en_markup_type')
