...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field districts on 'Location'
        m2m_table_name = db.shorten_name(u'locations_location_districts')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field districts on 'Location'
        db.delete_table(db.shorten_name(u'locations_location_districts'))
