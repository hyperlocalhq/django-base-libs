...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Location.tickets_calling_prices'
        db.alter_column(u'locations_location', 'tickets_calling_prices', self.gf('base_libs.models.fields.MultilingualTextField')(null=True))

        # Changing field 'Location.tickets_calling_prices_en'
        db.alter_column(u'locations_location', 'tickets_calling_prices_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Phone calling prices', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Location.tickets_calling_prices_de'
        db.alter_column(u'locations_location', 'tickets_calling_prices_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Phone calling prices', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))
    
    
    def backwards(self, orm):
        
        # Changing field 'Location.tickets_calling_prices'
        db.alter_column(u'locations_location', 'tickets_calling_prices', self.gf('base_libs.models.fields.MultilingualTextField')(max_length=255, null=True))

        # Changing field 'Location.tickets_calling_prices_en'
        db.alter_column(u'locations_location', 'tickets_calling_prices_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Phone calling prices', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=255, db_tablespace=''))

        # Changing field 'Location.tickets_calling_prices_de'
        db.alter_column(u'locations_location', 'tickets_calling_prices_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Phone calling prices', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=255, db_tablespace=''))
