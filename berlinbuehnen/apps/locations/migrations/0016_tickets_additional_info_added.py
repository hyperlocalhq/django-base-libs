...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'Location.tickets_additional_info'
        db.add_column(u'locations_location', 'tickets_additional_info',
                      self.gf('base_libs.models.fields.MultilingualTextField')(default='', null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.tickets_additional_info_de'
        db.add_column(u'locations_location', 'tickets_additional_info_de',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Additional information', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Location.tickets_additional_info_de_markup_type'
        db.add_column(u'locations_location', 'tickets_additional_info_de_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Location.tickets_additional_info_en'
        db.add_column(u'locations_location', 'tickets_additional_info_en',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Additional information', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Location.tickets_additional_info_en_markup_type'
        db.add_column(u'locations_location', 'tickets_additional_info_en_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
                # Deleting field 'Location.tickets_additional_info'
        db.delete_column(u'locations_location', 'tickets_additional_info')

        # Deleting field 'Location.tickets_additional_info_de'
        db.delete_column(u'locations_location', 'tickets_additional_info_de')

        # Deleting field 'Location.tickets_additional_info_de_markup_type'
        db.delete_column(u'locations_location', 'tickets_additional_info_de_markup_type')

        # Deleting field 'Location.tickets_additional_info_en'
        db.delete_column(u'locations_location', 'tickets_additional_info_en')

        # Deleting field 'Location.tickets_additional_info_en_markup_type'
        db.delete_column(u'locations_location', 'tickets_additional_info_en_markup_type')
