...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Deleting field 'Stage.districts'
        db.delete_column(u'locations_stage', 'districts_id')

        # Adding field 'Stage.district'
        db.add_column(u'locations_stage', 'district',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.District'], null=True, blank=True),
                      keep_default=False)

    
    
    def backwards(self, orm):
                # Adding field 'Stage.districts'
        db.add_column(u'locations_stage', 'districts',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.District'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Stage.district'
        db.delete_column(u'locations_stage', 'district_id')
