...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'Location.press_contact_name'
        db.add_column(u'locations_location', 'press_contact_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Location.press_phone_country'
        db.add_column(u'locations_location', 'press_phone_country',
                      self.gf('django.db.models.fields.CharField')(default='49', max_length=4, blank=True),
                      keep_default=False)

        # Adding field 'Location.press_phone_area'
        db.add_column(u'locations_location', 'press_phone_area',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=6, blank=True),
                      keep_default=False)

        # Adding field 'Location.press_phone_number'
        db.add_column(u'locations_location', 'press_phone_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'Location.press_fax_country'
        db.add_column(u'locations_location', 'press_fax_country',
                      self.gf('django.db.models.fields.CharField')(default='49', max_length=4, blank=True),
                      keep_default=False)

        # Adding field 'Location.press_fax_area'
        db.add_column(u'locations_location', 'press_fax_area',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=6, blank=True),
                      keep_default=False)

        # Adding field 'Location.press_fax_number'
        db.add_column(u'locations_location', 'press_fax_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'Location.press_email'
        db.add_column(u'locations_location', 'press_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Location.press_website'
        db.add_column(u'locations_location', 'press_website',
    ...
    def backwards(self, orm):
                # Deleting field 'Location.press_contact_name'
        db.delete_column(u'locations_location', 'press_contact_name')

        # Deleting field 'Location.press_phone_country'
        db.delete_column(u'locations_location', 'press_phone_country')

        # Deleting field 'Location.press_phone_area'
        db.delete_column(u'locations_location', 'press_phone_area')

        # Deleting field 'Location.press_phone_number'
        db.delete_column(u'locations_location', 'press_phone_number')

        # Deleting field 'Location.press_fax_country'
        db.delete_column(u'locations_location', 'press_fax_country')

        # Deleting field 'Location.press_fax_area'
        db.delete_column(u'locations_location', 'press_fax_area')

        # Deleting field 'Location.press_fax_number'
        db.delete_column(u'locations_location', 'press_fax_number')

        # Deleting field 'Location.press_email'
        db.delete_column(u'locations_location', 'press_email')

        # Deleting field 'Location.press_website'
        db.delete_column(u'locations_location', 'press_website')
