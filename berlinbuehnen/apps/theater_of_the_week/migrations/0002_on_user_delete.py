...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TheaterOfTheWeek.author'
        db.alter_column(u'theater_of_the_week_theateroftheweek', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))
    
    
    def backwards(self, orm):
        
        # Changing field 'TheaterOfTheWeek.author'
        db.alter_column(u'theater_of_the_week_theateroftheweek', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
    ...
    models = {
        ...
        u'theater_of_the_week.theateroftheweek': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'theateroftheweek_author'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
