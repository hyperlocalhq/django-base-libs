...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Parent'
        db.create_table(u'multiparts_parent', south_cleaned_fields((
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('modified_date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='parent_creator', null=True, to=orm['auth.User'])),
            ('modifier', self.gf('django.db.models.fields.related.ForeignKey')(related_name='parent_modifier', null=True, to=orm['auth.User'])),
            ('production', self.gf('django.db.models.fields.related.OneToOneField')(related_name='multipart', unique=True, to=orm['productions.Production'])),
        )))
        db.send_create_signal(u'multiparts', ['Parent'])

        # Adding model 'Part'
        db.create_table(u'multiparts_part', south_cleaned_fields((
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['multiparts.Parent'])),
        ...
        db.send_create_signal(u'multiparts', ['Part'])
    
    
    def backwards(self, orm):
                # Deleting model 'Parent'
        db.delete_table(u'multiparts_parent')

        # Deleting model 'Part'
        db.delete_table(u'multiparts_part')
    ...
    models = {
        ...
        u'multiparts.parent': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'parent_creator'", 'null': 'True', 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'modifier': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'parent_modifier'", 'null': 'True', 'to': u"orm['auth.User']"}),
