...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Deleting field 'ProjectImage.project'
        db.delete_column(u'education_projectimage', 'project_id')

        # Adding field 'ProjectImage.education'
        db.add_column(u'education_projectimage', 'education',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ProjectImage.project'
        raise RuntimeError("Cannot reverse this migration. 'ProjectImage.project' and its values cannot be restored.")
        # Deleting field 'ProjectImage.education'
        db.delete_column(u'education_projectimage', 'education_id')
