...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Removing M2M table for field target_group on 'Project'
        db.delete_table(db.shorten_name(u'education_project_target_group'))

        # Removing M2M table for field format on 'Project'
        db.delete_table(db.shorten_name(u'education_project_format'))

        # Adding M2M table for field target_groups on 'Project'
        m2m_table_name = db.shorten_name(u'education_project_target_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm[u'education.project'], null=False)),
            ('projecttargetgroup', models.ForeignKey(orm[u'education.projecttargetgroup'], null=False))
        ))
        db.create_unique(m2m_table_name, ['project_id', 'projecttargetgroup_id'])

        # Adding M2M table for field formats on 'Project'
        m2m_table_name = db.shorten_name(u'education_project_formats')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm[u'education.project'], null=False)),
            ('projectformat', models.ForeignKey(orm[u'education.projectformat'], null=False))
        ))
        db.create_unique(m2m_table_name, ['project_id', 'projectformat_id'])

    
    
    def backwards(self, orm):
                # Adding M2M table for field target_group on 'Project'
        m2m_table_name = db.shorten_name(u'education_project_target_group')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm[u'education.project'], null=False)),
            ('projecttargetgroup', models.ForeignKey(orm[u'education.projecttargetgroup'], null=False))
        ...
        # Adding M2M table for field format on 'Project'
        m2m_table_name = db.shorten_name(u'education_project_format')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm[u'education.project'], null=False)),
            ('projectformat', models.ForeignKey(orm[u'education.projectformat'], null=False))
        ...
        # Removing M2M table for field target_groups on 'Project'
        db.delete_table(db.shorten_name(u'education_project_target_groups'))

        # Removing M2M table for field formats on 'Project'
        db.delete_table(db.shorten_name(u'education_project_formats'))
    ...
    models = {
        ...
        u'education.projectimage': {
            ...
            'copyright_restrictions': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            'creation_date': ('django.db.models.fields.DateTimeField', [], {}),
            'education': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['education.Project']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'path': ('filebrowser.fields.FileBrowseField', [], {'directory': "'education/'", 'max_length': '255', 'extensions': "['.jpg', '.jpeg', '.gif', '.png']"}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'default': 'None'})
