...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Deleting field 'PDF.department'
        db.delete_column(u'education_pdf', 'department_id')

        # Adding field 'PDF.education'
        db.add_column(u'education_pdf', 'education',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['education.Department']),
                      keep_default=False)

        # Deleting field 'ProjectPDF.project'
        db.delete_column(u'education_projectpdf', 'project_id')

        # Adding field 'ProjectPDF.education'
        db.add_column(u'education_projectpdf', 'education',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['education.Project']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'PDF.department'
        raise RuntimeError("Cannot reverse this migration. 'PDF.department' and its values cannot be restored.")
        # Deleting field 'PDF.education'
        db.delete_column(u'education_pdf', 'education_id')


        # User chose to not deal with backwards NULL issues for 'ProjectPDF.project'
        raise RuntimeError("Cannot reverse this migration. 'ProjectPDF.project' and its values cannot be restored.")
        # Deleting field 'ProjectPDF.education'
        db.delete_column(u'education_projectpdf', 'education_id')
    ...
    models = {
        ...
        u'education.project': {
            ...
            'fax_country': ('django.db.models.fields.CharField', [], {'default': "'49'", 'max_length': '4', 'blank': 'True'}),
            'fax_number': ('django.db.models.fields.CharField', [], {'max_length': '25', 'blank': 'True'}),
            'format': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['education.ProjectFormat']", 'null': 'True', 'blank': 'True'}),
            ...
            'target_group': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['education.ProjectTargetGroup']", 'null': 'True', 'blank': 'True'}),
