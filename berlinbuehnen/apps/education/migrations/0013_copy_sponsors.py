...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for proj in orm.Project.objects.all():
            proj.projectsponsor_set.all().delete()
            for sp_old in proj.sponsors.all():
                if sp_old.title_de or sp_old.title_en or sp_old.website or sp_old.image:
                    sp_new = orm.ProjectSponsor(project=proj)
                    ...
                    if sp_old.image:
                        ...
                        new_rel_dir = os.path.join("education", "projects", proj.slug, "sponsors")
    ...
    def backwards(self, orm):
        orm.ProjectSponsor.objects.all().delete()
