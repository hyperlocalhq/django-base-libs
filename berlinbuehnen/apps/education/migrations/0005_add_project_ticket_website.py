...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'Project.tickets_website'
        db.add_column(u'education_project', 'tickets_website',
                      self.gf('base_libs.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)

    
    
    def backwards(self, orm):
                # Deleting field 'Project.tickets_website'
        db.delete_column(u'education_project', 'tickets_website')
