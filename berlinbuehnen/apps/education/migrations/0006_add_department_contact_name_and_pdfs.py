...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PDF'
        db.create_table(u'education_pdf', south_cleaned_fields((
            ...
            ('path', self.gf('filebrowser.fields.FileBrowseField')(directory='education/', max_length=255, extensions=['.pdf'])),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(default=None)),
        )))
        db.send_create_signal(u'education', ['PDF'])

        # Adding model 'ProjectPDF'
        db.create_table(u'education_projectpdf', south_cleaned_fields((
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('modified_date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ...
        db.send_create_signal(u'education', ['ProjectPDF'])
        # Adding field 'Department.contact_name'
        db.add_column(u'education_department', 'contact_name',
    ...
    def backwards(self, orm):
                # Deleting model 'PDF'
        db.delete_table(u'education_pdf')

        # Deleting model 'ProjectPDF'
        db.delete_table(u'education_projectpdf')

        # Deleting field 'Department.contact_name'
        db.delete_column(u'education_department', 'contact_name')
