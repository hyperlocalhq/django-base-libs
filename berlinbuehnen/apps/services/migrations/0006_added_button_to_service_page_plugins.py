...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'ImageAndText.internal_link'
        db.add_column(u'cmsplugin_imageandtext', 'internal_link',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Page'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'ImageAndText.external_link'
        db.add_column(u'cmsplugin_imageandtext', 'external_link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'ImageAndText.link_text'
        db.add_column(u'cmsplugin_imageandtext', 'link_text',
                      self.gf('django.db.models.fields.CharField')(default=u'Yes, please', max_length=20),
                      keep_default=False)

        # Adding field 'TitleAndText.internal_link'
        db.add_column(u'cmsplugin_titleandtext', 'internal_link',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Page'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'TitleAndText.external_link'
        db.add_column(u'cmsplugin_titleandtext', 'external_link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'TitleAndText.link_text'
        db.add_column(u'cmsplugin_titleandtext', 'link_text',
                      self.gf('django.db.models.fields.CharField')(default=u'Yes, please', max_length=20),
                      keep_default=False)
    ...
    def backwards(self, orm):
                # Deleting field 'ImageAndText.internal_link'
        db.delete_column(u'cmsplugin_imageandtext', 'internal_link_id')

        # Deleting field 'ImageAndText.external_link'
        db.delete_column(u'cmsplugin_imageandtext', 'external_link')

        # Deleting field 'ImageAndText.link_text'
        db.delete_column(u'cmsplugin_imageandtext', 'link_text')

        # Deleting field 'TitleAndText.internal_link'
        db.delete_column(u'cmsplugin_titleandtext', 'internal_link_id')

        # Deleting field 'TitleAndText.external_link'
        db.delete_column(u'cmsplugin_titleandtext', 'external_link')

        # Deleting field 'TitleAndText.link_text'
        db.delete_column(u'cmsplugin_titleandtext', 'link_text')
    ...
    models = {
        ...
        u'services.imageandtext': {
            ...
            'link_text': ('django.db.models.fields.CharField', [], {'default': "u'Yes, please'", 'max_length': '20'}),
