...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'ServiceListItem.link_text'
        db.add_column(u'cmsplugin_servicelistitem', 'link_text',
    ...
    def backwards(self, orm):
                # Deleting field 'ServiceListItem.link_text'
        db.delete_column(u'cmsplugin_servicelistitem', 'link_text')
