...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Service.location'
        db.alter_column(u'services_service', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Location'], null=True))
    ...
    models = {
        ...
        u'services.service': {
            'Meta': {'ordering': "[u'sort_order']", 'object_name': 'Service'},
        ...
        u'services.servicescategory': {
            'Meta': {'ordering': "[u'sort_order']", 'object_name': 'ServicesCategory'},
            'creation_date': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('filebrowser.fields.FileBrowseField', [], {'directory': "u'services/'", 'max_length': '255', 'extensions': "[u'.jpg', u'.jpeg', u'.gif', u'.png']"}),
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
