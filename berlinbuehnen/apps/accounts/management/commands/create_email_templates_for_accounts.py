...
<p>Das Team von [site_name]</p>"""
            ...
            account_created.allowed_placeholders.add(*list(EmailTemplatePlaceholder.objects.all()))
...
Das [site_name] Team</p>"""
            ...
            account_verification.allowed_placeholders.add(*list(EmailTemplatePlaceholder.objects.all()))
