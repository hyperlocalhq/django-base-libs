...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'Article.newsletter'
        db.add_column(u'articles_article', 'newsletter',
    ...
    def backwards(self, orm):
                # Deleting field 'Article.newsletter'
        db.delete_column(u'articles_article', 'newsletter')
