...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'articles_articletype', south_cleaned_fields((
            ...
            ('title_de', self.gf('django.db.models.fields.CharField')(u'title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=512, db_tablespace='', blank=True, unique=False, db_index=False)),
            ('title_en', self.gf('django.db.models.fields.CharField')(u'title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=512, db_tablespace='', blank=True, unique=False, db_index=False)),
        )))
        db.send_create_signal(u'articles', ['ArticleType'])

        # Adding model 'ArticleCategory'
        db.create_table(u'articles_articlecategory', south_cleaned_fields((
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('modified_date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=255)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='child_set', null=True, to=orm['articles.ArticleCategory'])),
            ('title', self.gf('base_libs.models.fields.MultilingualCharField')(max_length=512, null=True)),
            ('title_de', self.gf('django.db.models.fields.CharField')(u'title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=512, db_tablespace='', blank=True, unique=False, db_index=False)),
            ('title_en', self.gf('django.db.models.fields.CharField')(u'title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=512, db_tablespace='', blank=True, unique=False, db_index=False)),
            ('lft', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ...
        db.send_create_signal(u'articles', ['ArticleCategory'])

        # Adding model 'Article'
        db.create_table(u'articles_article', south_cleaned_fields((
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('modified_date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ...
            ('category', self.gf('mptt.fields.TreeForeignKey')(to=orm['articles.ArticleCategory'], null=True, blank=True)),
        ...
        # Adding model 'ArticleSelection'
        db.create_table(u'cmsplugin_articleselection', south_cleaned_fields((
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('article', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['articles.Article'])),
        )))
        db.send_create_signal(u'articles', ['ArticleSelection'])
    
    
    def backwards(self, orm):
                # Deleting model 'ArticleType'
        db.delete_table(u'articles_articletype')

        # Deleting model 'ArticleCategory'
        db.delete_table(u'articles_articlecategory')

        # Deleting model 'Article'
        db.delete_table(u'articles_article')

        # Deleting model 'ArticleSelection'
        db.delete_table(u'cmsplugin_articleselection')
