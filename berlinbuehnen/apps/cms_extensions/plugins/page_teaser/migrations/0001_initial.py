...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PageTeaser'
        db.create_table(u'cmsplugin_pageteaser', south_cleaned_fields((
            ...
            ('link_external', self.gf('django.db.models.fields.URLField')(max_length=255, blank=True)),
            ('link_text', self.gf('django.db.models.fields.CharField')(default=u'MEHR', max_length=30)),
            ('short_description_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False)),
        )))
        db.send_create_signal(u'page_teaser', ['PageTeaser'])
    
    
    def backwards(self, orm):
                # Deleting model 'PageTeaser'
        db.delete_table(u'cmsplugin_pageteaser')
