...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cmsplugin_richtext', south_cleaned_fields((
        ...
        db.send_create_signal(u'richtext', ['RichText'])
    
    
    def backwards(self, orm):
                # Deleting model 'RichText'
        db.delete_table(u'cmsplugin_richtext')
    ...
    models = {
        ...
        u'richtext.richtext': {
            'Meta': {'object_name': 'RichText', 'db_table': "u'cmsplugin_richtext'", '_ormbases': ['cms.CMSPlugin']},
