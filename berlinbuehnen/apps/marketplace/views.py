...
def add_job_offer(request):
    ...
    if request.method == "POST":
        ...
        form = JobOfferForm()
    return render(request, "marketplace/forms/basic_info_form.html", {"form": form})
...
def change_job_offer(request, secure_id):
    ...
    return render(request, "marketplace/forms/basic_info_form.html", {"form": form, "job_offer": instance})
