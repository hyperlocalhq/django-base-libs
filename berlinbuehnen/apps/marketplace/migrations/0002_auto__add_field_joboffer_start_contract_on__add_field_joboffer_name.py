...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'JobOffer.start_contract_on'
        db.add_column(u'marketplace_joboffer', 'start_contract_on',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'JobOffer.name'
        db.add_column(u'marketplace_joboffer', 'name',
    ...
    def backwards(self, orm):
                # Deleting field 'JobOffer.start_contract_on'
        db.delete_column(u'marketplace_joboffer', 'start_contract_on')

        # Deleting field 'JobOffer.name'
        db.delete_column(u'marketplace_joboffer', 'name')
    ...
    models = {
        ...
        u'marketplace.joboffer': {
            'Meta': {'ordering': "['title']", 'object_name': 'JobOffer'},
