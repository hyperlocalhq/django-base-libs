...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Deleting field 'JobOffer.subtitle'
        db.delete_column(u'marketplace_joboffer', 'subtitle')

        # Deleting field 'JobOffer.title'
        db.delete_column(u'marketplace_joboffer', 'title')

        # Deleting field 'JobOffer.subtitle_de'
        db.delete_column(u'marketplace_joboffer', 'subtitle_de')

        # Deleting field 'JobOffer.title_de'
        db.delete_column(u'marketplace_joboffer', 'title_de')

        # Deleting field 'JobOffer.subtitle_en'
        db.delete_column(u'marketplace_joboffer', 'subtitle_en')

        # Deleting field 'JobOffer.title_en'
        db.delete_column(u'marketplace_joboffer', 'title_en')

    
    
    def backwards(self, orm):
                # Adding field 'JobOffer.subtitle'
        db.add_column(u'marketplace_joboffer', 'subtitle',
                      self.gf('base_libs.models.fields.MultilingualCharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'JobOffer.title'
        db.add_column(u'marketplace_joboffer', 'title',
                      self.gf('base_libs.models.fields.MultilingualCharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'JobOffer.subtitle_de'
        db.add_column(u'marketplace_joboffer', 'subtitle_de',
                      self.gf('django.db.models.fields.CharField')(u'Subtitle', unique=False, max_length=255, primary_key=False, db_column=None, blank=True, default='', null=False, editable=True, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'JobOffer.title_de'
        db.add_column(u'marketplace_joboffer', 'title_de',
                      self.gf('django.db.models.fields.CharField')(u'Title', unique=False, max_length=255, primary_key=False, db_column=None, blank=True, default='', null=False, editable=True, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'JobOffer.subtitle_en'
        db.add_column(u'marketplace_joboffer', 'subtitle_en',
                      self.gf('django.db.models.fields.CharField')(u'Subtitle', unique=False, max_length=255, primary_key=False, db_column=None, blank=True, default='', null=False, editable=True, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'JobOffer.title_en'
        db.add_column(u'marketplace_joboffer', 'title_en',
                      self.gf('django.db.models.fields.CharField')(u'Title', unique=False, max_length=255, primary_key=False, db_column=None, blank=True, default='', null=False, editable=True, db_tablespace='', db_index=False),
                      keep_default=False)
    ...
    models = {
        ...
        u'marketplace.jobcategory': {
            'Meta': {'ordering': "['tree_id', 'lft']", 'object_name': 'JobCategory'},
            'creation_date': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': u"orm['marketplace.JobCategory']"}),
        ...
        u'marketplace.joboffer': {
            'Meta': {'ordering': "['start_contract_on']", 'object_name': 'JobOffer'},
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['marketplace.JobCategory']", 'symmetrical': 'False', 'blank': 'True'}),
            'city': ('django.db.models.fields.CharField', [], {'default': "'Berlin'", 'max_length': '255'}),
            'company': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'creation_date': ('django.db.models.fields.DateTimeField', [], {}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'joboffer_creator'", 'null': 'True', 'to': u"orm['auth.User']"}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'job_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['marketplace.JobType']", 'null': 'True', 'blank': 'True'}),
            'latitude': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'longitude': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'modifier': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'joboffer_modifier'", 'null': 'True', 'to': u"orm['auth.User']"}),
            ...
            'position': ('base_libs.models.fields.MultilingualCharField', [], {'max_length': '200', 'null': 'True'}),
            'position_de': ('django.db.models.fields.CharField', ["u'Position'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '200', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'position_en': ('django.db.models.fields.CharField', ["u'Position'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '200', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            ...
            'start_contract_on': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'marketplace.jobtype': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'JobType'},
            'creation_date': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '255'}),
