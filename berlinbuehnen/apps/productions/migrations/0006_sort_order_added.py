...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'EventInvolvement.sort_order'
        db.add_column(u'productions_eventinvolvement', 'sort_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ProductionInvolvement.sort_order'
        db.add_column(u'productions_productioninvolvement', 'sort_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
                # Deleting field 'EventInvolvement.sort_order'
        db.delete_column(u'productions_eventinvolvement', 'sort_order')

        # Deleting field 'ProductionInvolvement.sort_order'
        db.delete_column(u'productions_productioninvolvement', 'sort_order')
