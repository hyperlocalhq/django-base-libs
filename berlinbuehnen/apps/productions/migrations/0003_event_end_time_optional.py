...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.duration'
        db.alter_column(u'productions_event', 'duration', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Event.end_time'
        db.alter_column(u'productions_event', 'end_time', self.gf('django.db.models.fields.TimeField')(null=True))
