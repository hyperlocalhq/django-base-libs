...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'EventLiveStream.title'
        db.add_column(u'productions_eventlivestream', 'title',
                      self.gf('base_libs.models.fields.MultilingualCharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'EventLiveStream.title_de'
        db.add_column(u'productions_eventlivestream', 'title_de',
        ...
        # Adding field 'EventLiveStream.title_en'
        db.add_column(u'productions_eventlivestream', 'title_en',
                      self.gf('django.db.models.fields.CharField')(u'Title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'ProductionLiveStream.title'
        db.add_column(u'productions_productionlivestream', 'title',
                      self.gf('base_libs.models.fields.MultilingualCharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'ProductionLiveStream.title_de'
        db.add_column(u'productions_productionlivestream', 'title_de',
                      self.gf('django.db.models.fields.CharField')(u'Title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'ProductionLiveStream.title_en'
        db.add_column(u'productions_productionlivestream', 'title_en',
                      self.gf('django.db.models.fields.CharField')(u'Title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'EventVideo.title'
        db.add_column(u'productions_eventvideo', 'title',
                      self.gf('base_libs.models.fields.MultilingualCharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'EventVideo.title_de'
        db.add_column(u'productions_eventvideo', 'title_de',
                      self.gf('django.db.models.fields.CharField')(u'Title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'EventVideo.title_en'
        db.add_column(u'productions_eventvideo', 'title_en',
                      self.gf('django.db.models.fields.CharField')(u'Title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'ProductionVideo.title'
        db.add_column(u'productions_productionvideo', 'title',
                      self.gf('base_libs.models.fields.MultilingualCharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'ProductionVideo.title_de'
        db.add_column(u'productions_productionvideo', 'title_de',
                      self.gf('django.db.models.fields.CharField')(u'Title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'ProductionVideo.title_en'
        db.add_column(u'productions_productionvideo', 'title_en',
                      self.gf('django.db.models.fields.CharField')(u'Title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
                # Deleting field 'EventLiveStream.title'
        db.delete_column(u'productions_eventlivestream', 'title')

        # Deleting field 'EventLiveStream.title_de'
        db.delete_column(u'productions_eventlivestream', 'title_de')

        # Deleting field 'EventLiveStream.title_en'
        db.delete_column(u'productions_eventlivestream', 'title_en')

        # Deleting field 'ProductionLiveStream.title'
        db.delete_column(u'productions_productionlivestream', 'title')

        # Deleting field 'ProductionLiveStream.title_de'
        db.delete_column(u'productions_productionlivestream', 'title_de')

        # Deleting field 'ProductionLiveStream.title_en'
        db.delete_column(u'productions_productionlivestream', 'title_en')

        # Deleting field 'EventVideo.title'
        db.delete_column(u'productions_eventvideo', 'title')

        # Deleting field 'EventVideo.title_de'
        db.delete_column(u'productions_eventvideo', 'title_de')

        # Deleting field 'EventVideo.title_en'
        db.delete_column(u'productions_eventvideo', 'title_en')

        # Deleting field 'ProductionVideo.title'
        db.delete_column(u'productions_productionvideo', 'title')

        # Deleting field 'ProductionVideo.title_de'
        db.delete_column(u'productions_productionvideo', 'title_de')

        # Deleting field 'ProductionVideo.title_en'
        db.delete_column(u'productions_productionvideo', 'title_en')
    ...
    models = {
        ...
        u'productions.production': {
            ...
            'title_de': ('django.db.models.fields.CharField', ["u'Title'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'title_en': ('django.db.models.fields.CharField', ["u'Title'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'website': ('base_libs.models.fields.URLField', [], {'max_length': '255', 'blank': 'True'}),
            'work_info': ('base_libs.models.fields.MultilingualTextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            'work_info_de': ('base_libs.models.fields.ExtendedTextField', ["u'Work info'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'work_info_de_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            'work_info_en': ('base_libs.models.fields.ExtendedTextField', ["u'Work info'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
