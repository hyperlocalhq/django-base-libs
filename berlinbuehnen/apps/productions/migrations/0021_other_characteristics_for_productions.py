...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'Production.other_characteristics'
        db.add_column(u'productions_production', 'other_characteristics',
                      self.gf('base_libs.models.fields.MultilingualTextField')(default='', null=True, blank=True),
                      keep_default=False)

        # Adding field 'Production.other_characteristics_de'
        db.add_column(u'productions_production', 'other_characteristics_de',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Other characteristics', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Production.other_characteristics_de_markup_type'
        db.add_column(u'productions_production', 'other_characteristics_de_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Production.other_characteristics_en'
        db.add_column(u'productions_production', 'other_characteristics_en',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Other characteristics', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Production.other_characteristics_en_markup_type'
        db.add_column(u'productions_production', 'other_characteristics_en_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
                # Deleting field 'Production.other_characteristics'
        db.delete_column(u'productions_production', 'other_characteristics')

        # Deleting field 'Production.other_characteristics_de'
        db.delete_column(u'productions_production', 'other_characteristics_de')

        # Deleting field 'Production.other_characteristics_de_markup_type'
        db.delete_column(u'productions_production', 'other_characteristics_de_markup_type')

        # Deleting field 'Production.other_characteristics_en'
        db.delete_column(u'productions_production', 'other_characteristics_en')

        # Deleting field 'Production.other_characteristics_en_markup_type'
        db.delete_column(u'productions_production', 'other_characteristics_en_markup_type')
