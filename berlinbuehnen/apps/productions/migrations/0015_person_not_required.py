...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventInvolvement.person'
        db.alter_column(u'productions_eventinvolvement', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Person'], null=True))

        # Changing field 'ProductionInvolvement.person'
        db.alter_column(u'productions_productioninvolvement', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Person'], null=True))

        # Changing field 'EventAuthorship.person'
        db.alter_column(u'productions_eventauthorship', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Person'], null=True))

        # Changing field 'ProductionAuthorship.person'
        db.alter_column(u'productions_productionauthorship', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Person'], null=True))

        # Changing field 'EventLeadership.person'
        db.alter_column(u'productions_eventleadership', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Person'], null=True))

        # Changing field 'ProductionLeadership.person'
        db.alter_column(u'productions_productionleadership', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Person'], null=True))
    
    
    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'EventInvolvement.person'
        raise RuntimeError("Cannot reverse this migration. 'EventInvolvement.person' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ProductionInvolvement.person'
        raise RuntimeError("Cannot reverse this migration. 'ProductionInvolvement.person' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'EventAuthorship.person'
        raise RuntimeError("Cannot reverse this migration. 'EventAuthorship.person' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ProductionAuthorship.person'
        raise RuntimeError("Cannot reverse this migration. 'ProductionAuthorship.person' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'EventLeadership.person'
        raise RuntimeError("Cannot reverse this migration. 'EventLeadership.person' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ProductionLeadership.person'
        raise RuntimeError("Cannot reverse this migration. 'ProductionLeadership.person' and its values cannot be restored.")
