...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EventLiveStream'
        db.create_table(u'productions_eventlivestream', south_cleaned_fields((
        ...
        db.send_create_signal(u'productions', ['EventLiveStream'])

        # Adding model 'ProductionSocialMediaChannel'
        db.create_table(u'productions_productionsocialmediachannel', south_cleaned_fields((
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'productions', ['ProductionSocialMediaChannel'])

        # Adding model 'ProductionLiveStream'
        db.create_table(u'productions_productionlivestream', south_cleaned_fields((
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('modified_date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('production', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['productions.Production'])),
        ...
        db.send_create_signal(u'productions', ['ProductionLiveStream'])

        # Adding model 'EventSocialMediaChannel'
        db.create_table(u'productions_eventsocialmediachannel', south_cleaned_fields((
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['productions.Event'])),
            ('channel_type', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('url', self.gf('base_libs.models.fields.URLField')(max_length=255)),
        )))
        db.send_create_signal(u'productions', ['EventSocialMediaChannel'])
    
    
    def backwards(self, orm):
                # Deleting model 'EventLiveStream'
        db.delete_table(u'productions_eventlivestream')

        # Deleting model 'ProductionSocialMediaChannel'
        db.delete_table(u'productions_productionsocialmediachannel')

        # Deleting model 'ProductionLiveStream'
        db.delete_table(u'productions_productionlivestream')

        # Deleting model 'EventSocialMediaChannel'
        db.delete_table(u'productions_eventsocialmediachannel')
