...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.pauses'
        db.alter_column(u'productions_event', 'pauses', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Event.pauses'
        db.alter_column(u'productions_event', 'pauses', self.gf('django.db.models.fields.PositiveIntegerField')())
