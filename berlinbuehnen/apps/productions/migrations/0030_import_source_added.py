...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'Production.import_source'
        db.add_column(u'productions_production', 'import_source',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['external_services.Service'], null=True, blank=True),
                      keep_default=False)

    
    
    def backwards(self, orm):
                # Deleting field 'Production.import_source'
        db.delete_column(u'productions_production', 'import_source_id')
