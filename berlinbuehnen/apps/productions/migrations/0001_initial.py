    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_from', models.DecimalField(null=True, verbose_name='Price from (\u20ac). Seperate cents by a point.', max_digits=5, decimal_places=2, blank=True)),
                ('price_till', models.DecimalField(null=True, verbose_name='Price till (\u20ac). Seperate cents by a point.', max_digits=5, decimal_places=2, blank=True)),
