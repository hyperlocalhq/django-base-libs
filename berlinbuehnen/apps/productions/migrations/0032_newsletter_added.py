...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'Production.newsletter'
        db.add_column(u'productions_production', 'newsletter',
    ...
    def backwards(self, orm):
                # Deleting field 'Production.newsletter'
        db.delete_column(u'productions_production', 'newsletter')
