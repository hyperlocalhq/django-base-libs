...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'EventInvolvement.another_type'
        db.add_column(u'productions_eventinvolvement', 'another_type',
                      self.gf('base_libs.models.fields.MultilingualCharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EventInvolvement.another_type_de'
        db.add_column(u'productions_eventinvolvement', 'another_type_de',
                      self.gf('django.db.models.fields.CharField')(u'Another type', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'EventInvolvement.another_type_en'
        db.add_column(u'productions_eventinvolvement', 'another_type_en',
                      self.gf('django.db.models.fields.CharField')(u'Another type', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'ProductionInvolvement.another_type'
        db.add_column(u'productions_productioninvolvement', 'another_type',
                      self.gf('base_libs.models.fields.MultilingualCharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProductionInvolvement.another_type_de'
        db.add_column(u'productions_productioninvolvement', 'another_type_de',
                      self.gf('django.db.models.fields.CharField')(u'Another type', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'ProductionInvolvement.another_type_en'
        db.add_column(u'productions_productioninvolvement', 'another_type_en',
                      self.gf('django.db.models.fields.CharField')(u'Another type', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
                # Deleting field 'EventInvolvement.another_type'
        db.delete_column(u'productions_eventinvolvement', 'another_type')

        # Deleting field 'EventInvolvement.another_type_de'
        db.delete_column(u'productions_eventinvolvement', 'another_type_de')

        # Deleting field 'EventInvolvement.another_type_en'
        db.delete_column(u'productions_eventinvolvement', 'another_type_en')

        # Deleting field 'ProductionInvolvement.another_type'
        db.delete_column(u'productions_productioninvolvement', 'another_type')

        # Deleting field 'ProductionInvolvement.another_type_de'
        db.delete_column(u'productions_productioninvolvement', 'another_type_de')

        # Deleting field 'ProductionInvolvement.another_type_en'
        db.delete_column(u'productions_productioninvolvement', 'another_type_en')
