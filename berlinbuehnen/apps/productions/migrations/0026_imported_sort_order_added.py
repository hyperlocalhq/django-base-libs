...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'EventInvolvement.imported_sort_order'
        db.add_column(u'productions_eventinvolvement', 'imported_sort_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ProductionInvolvement.imported_sort_order'
        db.add_column(u'productions_productioninvolvement', 'imported_sort_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'EventAuthorship.imported_sort_order'
        db.add_column(u'productions_eventauthorship', 'imported_sort_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ProductionAuthorship.imported_sort_order'
        db.add_column(u'productions_productionauthorship', 'imported_sort_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'EventLeadership.imported_sort_order'
        db.add_column(u'productions_eventleadership', 'imported_sort_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ProductionLeadership.imported_sort_order'
        db.add_column(u'productions_productionleadership', 'imported_sort_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
                # Deleting field 'EventInvolvement.imported_sort_order'
        db.delete_column(u'productions_eventinvolvement', 'imported_sort_order')

        # Deleting field 'ProductionInvolvement.imported_sort_order'
        db.delete_column(u'productions_productioninvolvement', 'imported_sort_order')

        # Deleting field 'EventAuthorship.imported_sort_order'
        db.delete_column(u'productions_eventauthorship', 'imported_sort_order')

        # Deleting field 'ProductionAuthorship.imported_sort_order'
        db.delete_column(u'productions_productionauthorship', 'imported_sort_order')

        # Deleting field 'EventLeadership.imported_sort_order'
        db.delete_column(u'productions_eventleadership', 'imported_sort_order')

        # Deleting field 'ProductionLeadership.imported_sort_order'
        db.delete_column(u'productions_productionleadership', 'imported_sort_order')
