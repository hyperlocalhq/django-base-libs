...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'Production.ensembles'
        db.add_column(u'productions_production', 'ensembles',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Production.organizers'
        db.add_column(u'productions_production', 'organizers',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Production.in_cooperation_with'
        db.add_column(u'productions_production', 'in_cooperation_with',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
                # Deleting field 'Production.ensembles'
        db.delete_column(u'productions_production', 'ensembles')

        # Deleting field 'Production.organizers'
        db.delete_column(u'productions_production', 'organizers')

        # Deleting field 'Production.in_cooperation_with'
        db.delete_column(u'productions_production', 'in_cooperation_with')
