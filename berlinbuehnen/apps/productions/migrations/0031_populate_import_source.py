...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for s in orm['external_services.service'].objects.all():
            for m in orm['external_services.objectmapper'].objects.filter(service=s, content_type__model="Production"):
                orm.Production.objects.filter(pk=m.object_id).update(import_source=s)
    ...
    models = {
        ...
        u'external_services.objectmapper': {
            ...
            'service': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['external_services.Service']"})
        },
        ...
        u'external_services.serviceactionlog': {
    ...
    complete_apps = ['external_services', 'productions']
