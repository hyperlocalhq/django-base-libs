...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        try:
            # Adding index on 'EventInvolvement', fields ['sort_order', 'event']
            db.create_index(u'productions_eventinvolvement', ['sort_order', 'event_id'])
        except:
            pass

        try:
            # Adding index on 'ProductionInvolvement', fields ['production', 'sort_order']
            db.create_index(u'productions_productioninvolvement', ['production_id', 'sort_order'])
        except:
            pass

        # Adding field 'Event.language_and_subtitles'
        db.add_column(u'productions_event', 'language_and_subtitles',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['productions.LanguageAndSubtitles'], null=True, blank=True),
                      keep_default=False)

        try:
            # Adding index on 'Production', fields ['title']
            db.create_index(u'productions_production', ['title'])
        except:
            pass

        try:
            # Adding index on 'Production', fields ['title_de']
            db.create_index(u'productions_production', ['title_de'])
        except:
            pass

        try:
            # Adding index on 'Production', fields ['title_en']
            db.create_index(u'productions_production', ['title_en'])
        except:
            pass
    ...
    def backwards(self, orm):
                # Removing index on 'Production', fields ['title_en']
        db.delete_index(u'productions_production', ['title_en'])

        # Removing index on 'Production', fields ['title_de']
        db.delete_index(u'productions_production', ['title_de'])

        # Removing index on 'Production', fields ['title']
        db.delete_index(u'productions_production', ['title'])

        # Removing index on 'ProductionInvolvement', fields ['production', 'sort_order']
        db.delete_index(u'productions_productioninvolvement', ['production_id', 'sort_order'])

        # Removing index on 'EventInvolvement', fields ['sort_order', 'event']
        db.delete_index(u'productions_eventinvolvement', ['sort_order', 'event_id'])

        # Deleting field 'Event.language_and_subtitles'
        db.delete_column(u'productions_event', 'language_and_subtitles_id')
