...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'Production.website_de'
        db.add_column(u'productions_production', 'website_de',
                      self.gf('django.db.models.fields.CharField')(u'Production URL', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'Production.website_en'
        db.add_column(u'productions_production', 'website_en',
                      self.gf('django.db.models.fields.CharField')(u'Production URL', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)


        # Changing field 'Production.website'
        db.alter_column(u'productions_production', 'website', self.gf('base_libs.models.fields.MultilingualURLField')(max_length=255, null=True))
    
    
    def backwards(self, orm):
                # Deleting field 'Production.website_de'
        db.delete_column(u'productions_production', 'website_de')

        # Deleting field 'Production.website_en'
        db.delete_column(u'productions_production', 'website_en')


        # Changing field 'Production.website'
        db.alter_column(u'productions_production', 'website', self.gf('base_libs.models.fields.URLField')(default='', max_length=255))
