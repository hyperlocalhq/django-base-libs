...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Deleting field 'Production.organizer_title'
        db.delete_column(u'productions_production', 'organizer_title')

    
    
    def backwards(self, orm):
                # Adding field 'Production.organizer_title'
        db.add_column(u'productions_production', 'organizer_title',
