...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventInvolvement.involvement_type'
        db.alter_column(u'productions_eventinvolvement', 'involvement_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.InvolvementType'], null=True))

        # Changing field 'ProductionInvolvement.involvement_type'
        db.alter_column(u'productions_productioninvolvement', 'involvement_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.InvolvementType'], null=True))
    
    
    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'EventInvolvement.involvement_type'
        raise RuntimeError("Cannot reverse this migration. 'EventInvolvement.involvement_type' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ProductionInvolvement.involvement_type'
        raise RuntimeError("Cannot reverse this migration. 'ProductionInvolvement.involvement_type' and its values cannot be restored.")
