...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'productions_eventsponsor', south_cleaned_fields((
            ...
            ('image', self.gf('filebrowser.fields.FileBrowseField')(directory='events/', max_length=255, extensions=['.jpg', '.jpeg', '.gif', '.png'], blank=True)),
        ...
        db.send_create_signal(u'productions', ['EventSponsor'])

        # Adding model 'ProductionSponsor'
        db.create_table(u'productions_productionsponsor', south_cleaned_fields((
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('modified_date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('production', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['productions.Production'])),
            ('title', self.gf('base_libs.models.fields.MultilingualCharField')(max_length=255, null=True, blank=True)),
            ('image', self.gf('filebrowser.fields.FileBrowseField')(directory='productions/', max_length=255, extensions=['.jpg', '.jpeg', '.gif', '.png'], blank=True)),
            ('website', self.gf('base_libs.models.fields.URLField')(max_length=200, blank=True)),
            ('title_de', self.gf('django.db.models.fields.CharField')(u'Title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False)),
            ('title_en', self.gf('django.db.models.fields.CharField')(u'Title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False)),
        )))
        db.send_create_signal(u'productions', ['ProductionSponsor'])
    
    
    def backwards(self, orm):
                # Deleting model 'EventSponsor'
        db.delete_table(u'productions_eventsponsor')

        # Deleting model 'ProductionSponsor'
        db.delete_table(u'productions_productionsponsor')
