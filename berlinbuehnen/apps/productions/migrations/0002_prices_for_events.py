...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'Event.free_entrance'
        db.add_column(u'productions_event', 'free_entrance',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Event.price_from'
        db.add_column(u'productions_event', 'price_from',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Event.price_till'
        db.add_column(u'productions_event', 'price_till',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Event.tickets_website'
        db.add_column(u'productions_event', 'tickets_website',
                      self.gf('base_libs.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Event.price_information'
        db.add_column(u'productions_event', 'price_information',
                      self.gf('base_libs.models.fields.MultilingualTextField')(default='', null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.price_information_de'
        db.add_column(u'productions_event', 'price_information_de',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Additional price information', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Event.price_information_de_markup_type'
        db.add_column(u'productions_event', 'price_information_de_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Event.price_information_en'
        db.add_column(u'productions_event', 'price_information_en',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Additional price information', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Event.price_information_en_markup_type'
        db.add_column(u'productions_event', 'price_information_en_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
                # Deleting field 'Event.free_entrance'
        db.delete_column(u'productions_event', 'free_entrance')

        # Deleting field 'Event.price_from'
        db.delete_column(u'productions_event', 'price_from')

        # Deleting field 'Event.price_till'
        db.delete_column(u'productions_event', 'price_till')

        # Deleting field 'Event.tickets_website'
        db.delete_column(u'productions_event', 'tickets_website')

        # Deleting field 'Event.price_information'
        db.delete_column(u'productions_event', 'price_information')

        # Deleting field 'Event.price_information_de'
        db.delete_column(u'productions_event', 'price_information_de')

        # Deleting field 'Event.price_information_de_markup_type'
        db.delete_column(u'productions_event', 'price_information_de_markup_type')

        # Deleting field 'Event.price_information_en'
        db.delete_column(u'productions_event', 'price_information_en')

        # Deleting field 'Event.price_information_en_markup_type'
        db.delete_column(u'productions_event', 'price_information_en_markup_type')
