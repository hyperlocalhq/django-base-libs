...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'productions_event', 'organizer_title')

        # Adding field 'Event.organizers'
        db.add_column(u'productions_event', 'organizers',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'productions_event', 'organizer_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'Event.organizers'
        db.delete_column(u'productions_event', 'organizers')
