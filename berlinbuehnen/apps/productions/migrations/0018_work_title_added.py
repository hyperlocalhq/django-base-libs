...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'EventAuthorship.work_title'
        db.add_column(u'productions_eventauthorship', 'work_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'ProductionAuthorship.work_title'
        db.add_column(u'productions_productionauthorship', 'work_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
                # Deleting field 'EventAuthorship.work_title'
        db.delete_column(u'productions_eventauthorship', 'work_title')

        # Deleting field 'ProductionAuthorship.work_title'
        db.delete_column(u'productions_productionauthorship', 'work_title')
