...
class BasicInfoForm(autocomplete_light.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['play_locations'].label = ugettext('Stage') + ' (' + ugettext('or') + ' <a href="" class="enter_location">' + ugettext('enter a new location below') + '</a>)'
        self.fields['play_stages'].label = ugettext('Venue')
