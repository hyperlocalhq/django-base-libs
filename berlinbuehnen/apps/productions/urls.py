...
urlpatterns = patterns('berlinbuehnen.apps.productions.views',
    ...
    url(r'^(?P<slug>[^/]+)/(?P<event_id>[^/]+)/change/gallery/overview/$', 'event_gallery_overview', name='event_gallery_overview'),
    url(r'^(?P<slug>[^/]+)/(?P<event_id>[^/]+)/change/gallery/add/$', 'event_create_update_mediafile', name='event_add_mediafile'),
    url(r'^(?P<slug>[^/]+)/(?P<event_id>[^/]+)/change/gallery/file_(?P<mediafile_token>[^/]+)/$', 'event_create_update_mediafile', name='event_change_mediafile'),
    url(r'^(?P<slug>[^/]+)/(?P<event_id>[^/]+)/change/gallery/file_(?P<mediafile_token>[^/]+)/delete/$', 'event_delete_mediafile', name='event_delete_mediafile'),
