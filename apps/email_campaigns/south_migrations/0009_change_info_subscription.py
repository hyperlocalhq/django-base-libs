...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'InfoSubscription.site'
        db.delete_column('email_campaigns_infosubscription', 'site_id')
        
        # Changing field 'InfoSubscription.subscriber_name'
        db.alter_column('email_campaigns_infosubscription', 'subscriber_name', models.CharField(_("Subscriber's name"), max_length=200, blank=True))
        
        # Changing field 'InfoSubscription.ip'
        db.alter_column('email_campaigns_infosubscription', 'ip', models.IPAddressField(_("IP Address"), blank=True))
        
        # Changing field 'InfoSubscription.email'
        db.alter_column('email_campaigns_infosubscription', 'email', models.EmailField(_("Email address"), blank=True))
        
        # Changing field 'MailingList.campaign'
        db.alter_column('email_campaigns_mailinglist', 'campaign_id', models.ForeignKey(orm['email_campaigns.Campaign'], null=True, blank=True))
        
    
    
    def backwards(self, orm):
        
        # Adding field 'InfoSubscription.site'
        db.add_column('email_campaigns_infosubscription', 'site', models.ForeignKey(orm['sites.Site'], null=True, blank=True))
        
        # Changing field 'InfoSubscription.subscriber_name'
        db.alter_column('email_campaigns_infosubscription', 'subscriber_name', models.CharField(_("Subscriber's name"), max_length=200))
        
        # Changing field 'InfoSubscription.ip'
        db.alter_column('email_campaigns_infosubscription', 'ip', models.IPAddressField(_("IP Address")))
        
        # Changing field 'InfoSubscription.email'
        db.alter_column('email_campaigns_infosubscription', 'email', models.EmailField(_("Email address")))
        
        # Changing field 'MailingList.campaign'
        db.alter_column('email_campaigns_mailinglist', 'campaign_id', models.ForeignKey(orm['email_campaigns.Campaign']))
