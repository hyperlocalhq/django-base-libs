...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'InfoSubscription.timestamp'
        db.delete_column('email_campaigns_infosubscription', 'timestamp')
        
    
    
    def backwards(self, orm):
        
        # Adding field 'InfoSubscription.timestamp'
        db.add_column('email_campaigns_infosubscription', 'timestamp', models.DateTimeField(_("Timestamp"), auto_now_add=True))
