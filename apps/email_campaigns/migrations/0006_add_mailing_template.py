...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Mailing.template'
        db.add_column('email_campaigns_mailing', 'template', TemplatePathField(path='email_campaigns/mailing/', match=r'\.html$', default=""))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Mailing.template'
        db.delete_column('email_campaigns_mailing', 'template')
