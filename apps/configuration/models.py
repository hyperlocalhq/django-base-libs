...
class SiteSettings(models.Model):
    ...
    registration_type = models.CharField(_("Registration type"), max_length=10, choices=ACCOUNT_REGISTRATION_TYPES,
                                         default="simple")
    login_by_email = models.BooleanField(_("Login by email"), default=False)
    gmaps_api_key = models.CharField(_("Google Maps API Key"), max_length=200, blank=True, help_text=mark_safe(
        "<a href=\"http://www.google.com/apis/maps/signup.html\" onclick=\"window.open(this.href, '', 'width=800,height=600,scrollbars=1,resizable=1');return false\">%s</a>" % force_unicode(
