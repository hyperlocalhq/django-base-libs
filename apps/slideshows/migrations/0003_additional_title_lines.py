...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('slideshows_slide', 'title2_de', self.gf('django.db.models.fields.CharField')(u'Title Line 2', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False), keep_default=False)

        # Adding field 'Slide.title3_de'
        db.add_column('slideshows_slide', 'title3_de', self.gf('django.db.models.fields.CharField')(u'Title Line 3', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False), keep_default=False)

        # Changing field 'Slide.title_de'
        db.alter_column('slideshows_slide', 'title_de', self.gf('django.db.models.fields.CharField')(u'Title Line 1', null=False, primary_key=False, db_column=None, editable=True, max_length=255, db_tablespace='', unique=False))

        # Changing field 'Slide.credits_de'
        db.alter_column('slideshows_slide', 'credits_de', self.gf('django.db.models.fields.CharField')(u'Photo credits', null=False, primary_key=False, db_column=None, editable=True, max_length=255, db_tablespace='', unique=False))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Slide.title_de'
        db.alter_column('slideshows_slide', 'title_de', self.gf('django.db.models.fields.CharField')(u'Title', unique=False, max_length=255, primary_key=False, db_column=None, null=False, editable=True, db_tablespace=''))

        # Changing field 'Slide.credits_de'
        db.alter_column('slideshows_slide', 'credits_de', self.gf('django.db.models.fields.CharField')(u'Credits', unique=False, max_length=255, primary_key=False, db_column=None, null=False, editable=True, db_tablespace=''))
