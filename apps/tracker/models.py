...
class Ticket(models.Model):
    ...
    submitted_date = models.DateTimeField(
        _("submitted Date"), auto_now_add=True
    )
    modified_date = models.DateTimeField(
        _("modified Date"), blank=True, null=True, editable=False
    )
    ...
    priority = models.IntegerField(
        _("priority"), default=1, choices=PRIORITY_CODES
    )

    url = models.CharField(
        _("related object's URL"), blank=True, null=True, max_length=255
    )
...
class TicketModifications(models.Model):
    ...
    ticket = models.ForeignKey(
        Ticket, verbose_name=_("ticket"), related_name="ticket_modification"
    )
