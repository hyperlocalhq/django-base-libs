...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'Ticket.concern'
        db.alter_column('tracker_ticket', 'concern_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Concern']))
    
    
    def backwards(self, orm):
        # Deleting field 'Ticket.object_id'
        db.delete_column('tracker_ticket', 'object_id')
