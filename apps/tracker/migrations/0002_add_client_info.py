...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Ticket.client_info'
        db.add_column('tracker_ticket', 'client_info', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'Ticket.client_info'
        db.delete_column('tracker_ticket', 'client_info')
    ...
    models = {
        ...
        'tracker.ticketmodifications': {
            'Meta': {'object_name': 'TicketModifications'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
