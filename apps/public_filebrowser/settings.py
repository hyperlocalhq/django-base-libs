...
URL_FILEBROWSER_MEDIA = getattr(
    settings, "FILEBROWSER_URL_FILEBROWSER_MEDIA", "/media/filebrowser/"
)
...
PATH_TINYMCE = getattr(
    settings, "FILEBROWSER_PATH_TINYMCE", DEFAULT_PATH_TINYMCE
)
...
EXTENSIONS = getattr(
    settings, "FILEBROWSER_EXTENSIONS", {
        'Folder': [''],
...
ADMIN_VERSIONS = getattr(
    settings, 'FILEBROWSER_ADMIN_VERSIONS',
...
FOLDER_REGEX = getattr(
    settings, "FILEBROWSER_FOLDER_REGEX", r'^[\sa-zA-Z0-9._/-]+$'
)
