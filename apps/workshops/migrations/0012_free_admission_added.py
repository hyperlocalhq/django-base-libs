...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Workshop.free_admission'
        db.add_column('workshops_workshop', 'free_admission', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Workshop.free_admission'
        db.delete_column('workshops_workshop', 'free_admission')
