...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Workshop.email'
        db.delete_column('workshops_workshop', 'email')
    
    
    def backwards(self, orm):
        
        # Adding field 'Workshop.email'
        db.add_column('workshops_workshop', 'email', self.gf('django.db.models.fields.EmailField')(default='', max_length=255, blank=True), keep_default=False)
