...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('workshops_workshopcategory', south_cleaned_fields((
            ('title_de', self.gf('django.db.models.fields.CharField')(u'title', unique=False, max_length=255, primary_key=False, db_column=None, blank=True, default='', null=False, editable=True, db_tablespace='', db_index=False)),
            ('rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(related_name='child_set', null=True, to=orm['workshops.WorkshopCategory'], blank=True)),
            ('title_en', self.gf('django.db.models.fields.CharField')(u'title', unique=False, max_length=255, primary_key=False, db_column=None, blank=True, default='', null=False, editable=True, db_tablespace='', db_index=False)),
