...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'WorkshopType'
        db.create_table('workshops_workshoptype', south_cleaned_fields((
        ...
        db.send_create_signal('workshops', ['WorkshopType'])

        # Adding M2M table for field types on 'Workshop'
        db.create_table('workshops_workshop_types', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('workshop', models.ForeignKey(orm['workshops.workshop'], null=False)),
            ('workshoptype', models.ForeignKey(orm['workshops.workshoptype'], null=False))
        ))
        db.create_unique('workshops_workshop_types', ['workshop_id', 'workshoptype_id'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'WorkshopType'
        db.delete_table('workshops_workshoptype')

        # Removing M2M table for field types on 'Workshop'
        db.delete_table('workshops_workshop_types')
