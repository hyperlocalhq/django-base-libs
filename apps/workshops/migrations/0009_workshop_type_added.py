...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Workshop.workshop_type'
        db.add_column('workshops_workshop', 'workshop_type', self.gf('base_libs.models.fields.MultilingualCharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Workshop.workshop_type_de'
        db.add_column('workshops_workshop', 'workshop_type_de', self.gf('django.db.models.fields.CharField')(u'Type', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False), keep_default=False)

        # Adding field 'Workshop.workshop_type_en'
        db.add_column('workshops_workshop', 'workshop_type_en', self.gf('django.db.models.fields.CharField')(u'Type', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Workshop.workshop_type'
        db.delete_column('workshops_workshop', 'workshop_type')

        # Deleting field 'Workshop.workshop_type_de'
        db.delete_column('workshops_workshop', 'workshop_type_de')

        # Deleting field 'Workshop.workshop_type_en'
        db.delete_column('workshops_workshop', 'workshop_type_en')
