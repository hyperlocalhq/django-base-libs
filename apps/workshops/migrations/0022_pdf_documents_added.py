...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Workshop.pdf_document_de'
        db.add_column('workshops_workshop', 'pdf_document_de', self.gf('filebrowser.fields.FileBrowseField')(directory='exhibitions/', default='', max_length=255, extensions=['.pdf'], blank=True), keep_default=False)

        # Adding field 'Workshop.pdf_document_en'
        db.add_column('workshops_workshop', 'pdf_document_en', self.gf('filebrowser.fields.FileBrowseField')(directory='exhibitions/', default='', max_length=255, extensions=['.pdf'], blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Workshop.pdf_document_de'
        db.delete_column('workshops_workshop', 'pdf_document_de')

        # Deleting field 'Workshop.pdf_document_en'
        db.delete_column('workshops_workshop', 'pdf_document_en')
