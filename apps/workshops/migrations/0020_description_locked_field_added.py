...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Workshop.description_locked'
        db.add_column('workshops_workshop', 'description_locked', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Workshop.description_locked'
        db.delete_column('workshops_workshop', 'description_locked')
