...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'WorkshopCategory'
        db.create_table('workshops_workshopcategory', south_cleaned_fields((
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=255, db_index=True)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='child_set', null=True, to=orm['workshops.WorkshopCategory'])),
        ...
        db.send_create_signal('workshops', ['WorkshopCategory'])

        # Adding model 'AgeGroup'
        db.create_table('workshops_agegroup', south_cleaned_fields((
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('workshops', ['AgeGroup'])

        # Adding model 'Workshop'
        db.create_table('workshops_workshop', south_cleaned_fields((
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('modified_date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='workshop_creator', null=True, to=orm['auth.User'])),
            ('modifier', self.gf('django.db.models.fields.related.ForeignKey')(related_name='workshop_modifier', null=True, to=orm['auth.User'])),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=255, db_index=True)),
            ('title', self.gf('base_libs.models.fields.MultilingualCharField')(max_length=255, null=True)),
            ('subtitle', self.gf('base_libs.models.fields.MultilingualCharField')(max_length=255, null=True)),
            ('description', self.gf('base_libs.models.fields.MultilingualTextField')(default='', null=True, blank=True)),
            ('image', self.gf('filebrowser.fields.FileBrowseField')(directory='workshops/', max_length=200, extensions=['.jpg', '.jpeg', '.gif', '.png', '.tif', '.tiff'], blank=True)),
            ('workshop_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ...
            ('other_languages', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('museum', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['museums.Museum'], null=True, blank=True)),
            ...
            ('country', self.gf('django.db.models.fields.CharField')(default='de', max_length=255, blank=True)),
            ...
            ('meeting_place', self.gf('base_libs.models.fields.MultilingualCharField')(max_length=255, null=True, blank=True)),
            ('admission_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True)),
            ('admission_price_info', self.gf('base_libs.models.fields.MultilingualTextField')(default='', null=True, blank=True)),
            ('reduced_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True)),
            ('booking_info', self.gf('base_libs.models.fields.MultilingualTextField')(default='', null=True, blank=True)),
            ...
            ('booking_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Booking info', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False)),
            ('booking_info_de_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False)),
            ('booking_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Booking info', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False)),
            ('booking_info_en_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False)),
            ('booking_info_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False)),
            ('admission_price_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Admission price info', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False)),
            ('admission_price_info_de_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False)),
            ('admission_price_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Admission price info', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False)),
            ('admission_price_info_en_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False)),
            ('admission_price_info_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False)),
            ('meeting_place_de', self.gf('django.db.models.fields.CharField')(u'Meeting place', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False)),
            ('meeting_place_en', self.gf('django.db.models.fields.CharField')(u'Meeting place', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False)),
        )))
        db.send_create_signal('workshops', ['Workshop'])

        # Adding M2M table for field categories on 'Workshop'
        db.create_table('workshops_workshop_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('workshop', models.ForeignKey(orm['workshops.workshop'], null=False)),
            ('workshopcategory', models.ForeignKey(orm['workshops.workshopcategory'], null=False))
        ))
        db.create_unique('workshops_workshop_categories', ['workshop_id', 'workshopcategory_id'])

        # Adding M2M table for field languages on 'Workshop'
        db.create_table('workshops_workshop_languages', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('workshop', models.ForeignKey(orm['workshops.workshop'], null=False)),
            ('language', models.ForeignKey(orm['i18n.language'], null=False))
        ))
        db.create_unique('workshops_workshop_languages', ['workshop_id', 'language_id'])

        # Adding M2M table for field age_groups on 'Workshop'
        db.create_table('workshops_workshop_age_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('workshop', models.ForeignKey(orm['workshops.workshop'], null=False)),
            ('agegroup', models.ForeignKey(orm['workshops.agegroup'], null=False))
        ))
        db.create_unique('workshops_workshop_age_groups', ['workshop_id', 'agegroup_id'])

        # Adding model 'WorkshopTime'
        db.create_table('workshops_workshoptime', south_cleaned_fields((
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('workshops', ['WorkshopTime'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'WorkshopCategory'
        db.delete_table('workshops_workshopcategory')

        # Deleting model 'AgeGroup'
        db.delete_table('workshops_agegroup')

        # Deleting model 'Workshop'
        db.delete_table('workshops_workshop')

        # Removing M2M table for field categories on 'Workshop'
        db.delete_table('workshops_workshop_categories')

        # Removing M2M table for field languages on 'Workshop'
        db.delete_table('workshops_workshop_languages')

        # Removing M2M table for field age_groups on 'Workshop'
        db.delete_table('workshops_workshop_age_groups')

        # Deleting model 'WorkshopTime'
        db.delete_table('workshops_workshoptime')
