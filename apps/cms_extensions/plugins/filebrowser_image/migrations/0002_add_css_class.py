...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FilebrowserImage.css_class'
        db.add_column('cmsplugin_filebrowserimage', 'css_class', orm['filebrowser_image.filebrowserimage:css_class'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'FilebrowserImage.css_class'
        db.delete_column('cmsplugin_filebrowserimage', 'css_class')
