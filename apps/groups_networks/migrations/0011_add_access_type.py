...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PersonGroup.access_type'
        db.add_column('groups_networks_persongroup', 'access_type', self.gf('django.db.models.fields.CharField')(default='secret', max_length=10), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'PersonGroup.access_type'
        db.delete_column('groups_networks_persongroup', 'access_type')
