...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PersonGroup.access_type'
        db.delete_column('groups_networks_persongroup', 'access_type_id')

    
    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'PersonGroup.access_type'
        raise RuntimeError("Cannot reverse this migration. 'PersonGroup.access_type' and its values cannot be restored.")
