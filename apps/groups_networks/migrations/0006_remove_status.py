...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PersonGroup.status'
        db.delete_column('groups_networks_persongroup', 'status_id')

    
    def backwards(self, orm):
        
        # Adding field 'PersonGroup.status'
        db.add_column('groups_networks_persongroup', 'status', self.gf('django.db.models.fields.related.ForeignKey')(default=87L, related_name='status_groups', null=True, to=orm['structure.Term'], blank=True), keep_default=False)
