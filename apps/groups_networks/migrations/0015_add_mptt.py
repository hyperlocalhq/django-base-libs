...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('groups_networks_persongroup', 'group_type_id', self.gf('mptt.fields.TreeForeignKey')(to=orm['groups_networks.GroupType']))

        # Deleting field 'GroupType.path_search'
        db.delete_column('groups_networks_grouptype', 'path_search')

        # Deleting field 'GroupType.path'
        db.delete_column('groups_networks_grouptype', 'path')

        # Adding field 'GroupType.lft'
        db.add_column('groups_networks_grouptype', 'lft', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'GroupType.rght'
        db.add_column('groups_networks_grouptype', 'rght', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'GroupType.tree_id'
        db.add_column('groups_networks_grouptype', 'tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'GroupType.level'
        db.add_column('groups_networks_grouptype', 'level', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Changing field 'GroupType.parent'
        db.alter_column('groups_networks_grouptype', 'parent_id', self.gf('mptt.fields.TreeForeignKey')(null=True, to=orm['groups_networks.GroupType']))
    
    
    def backwards(self, orm):
        
        # Changing field 'PersonGroup.group_type'
        db.alter_column('groups_networks_persongroup', 'group_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['groups_networks.GroupType']))

        # Adding field 'GroupType.path_search'
        db.add_column('groups_networks_grouptype', 'path_search', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'GroupType.path'
        db.add_column('groups_networks_grouptype', 'path', self.gf('django.db.models.fields.CharField')(max_length=8192, null=True), keep_default=False)

        # Deleting field 'GroupType.lft'
        db.delete_column('groups_networks_grouptype', 'lft')

        # Deleting field 'GroupType.rght'
        db.delete_column('groups_networks_grouptype', 'rght')

        # Deleting field 'GroupType.tree_id'
        db.delete_column('groups_networks_grouptype', 'tree_id')

        # Deleting field 'GroupType.level'
        db.delete_column('groups_networks_grouptype', 'level')

        # Changing field 'GroupType.parent'
        db.alter_column('groups_networks_grouptype', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['groups_networks.GroupType']))
    ...
    models = {
        ...
        'groups_networks.persongroup': {
            ...
            'creative_sectors': ('mptt.fields.TreeManyToManyField', [], {'symmetrical': 'False', 'related_name': "'creative_sectors_groups'", 'blank': 'True', 'to': "orm['structure.Term']"}),
