...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('groups_networks_persongroup', 'status', self.gf('django.db.models.fields.CharField')(default='draft', max_length=20, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'PersonGroup.status'
        db.delete_column('groups_networks_persongroup', 'status')
