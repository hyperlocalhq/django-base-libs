...
class DocumentSearchForm(dynamicforms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = layout.Layout(
            layout.Fieldset(
                _("Filter"),
                layout.Field("category", template="kb_form/custom_widgets/category_filter_field.html"),
                layout.Field("document_type", template="kb_form/custom_widgets/document_type_filter_field.html"),
