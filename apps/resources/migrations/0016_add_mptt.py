...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DocumentType.path_search'
        db.delete_column('resources_documenttype', 'path_search')

        # Deleting field 'DocumentType.path'
        db.delete_column('resources_documenttype', 'path')

        # Adding field 'DocumentType.lft'
        db.add_column('resources_documenttype', 'lft', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'DocumentType.rght'
        db.add_column('resources_documenttype', 'rght', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'DocumentType.tree_id'
        db.add_column('resources_documenttype', 'tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'DocumentType.level'
        db.add_column('resources_documenttype', 'level', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Changing field 'DocumentType.parent'
        db.alter_column('resources_documenttype', 'parent_id', self.gf('mptt.fields.TreeForeignKey')(null=True, to=orm['resources.DocumentType']))
    
    
    def backwards(self, orm):
        
        # Adding field 'DocumentType.path_search'
        db.add_column('resources_documenttype', 'path_search', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'DocumentType.path'
        db.add_column('resources_documenttype', 'path', self.gf('django.db.models.fields.CharField')(max_length=8192, null=True), keep_default=False)

        # Deleting field 'DocumentType.lft'
        db.delete_column('resources_documenttype', 'lft')

        # Deleting field 'DocumentType.rght'
        db.delete_column('resources_documenttype', 'rght')

        # Deleting field 'DocumentType.tree_id'
        db.delete_column('resources_documenttype', 'tree_id')

        # Deleting field 'DocumentType.level'
        db.delete_column('resources_documenttype', 'level')

        # Changing field 'DocumentType.parent'
        db.alter_column('resources_documenttype', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['resources.DocumentType']))
    ...
    models = {
        ...
        'resources.document': {
            ...
            'context_categories': ('mptt.fields.TreeManyToManyField', [], {'to': "orm['structure.ContextCategory']", 'symmetrical': 'False', 'blank': 'True'}),
            'creation_date': ('django.db.models.fields.DateTimeField', [], {}),
            'creative_sectors': ('mptt.fields.TreeManyToManyField', [], {'symmetrical': 'False', 'related_name': "'creative_industry_documents'", 'blank': 'True', 'to': "orm['structure.Term']"}),
            'description': ('base_libs.models.fields.MultilingualTextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            'description_de': ('base_libs.models.fields.ExtendedTextField', ["u'Beschreibung'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'description_de_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            'description_en': ('base_libs.models.fields.ExtendedTextField', ["u'Beschreibung'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            ...
            'document_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'type_documents'", 'to': "orm['resources.DocumentType']"}),
            ...
            'medium': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'medium_documents'", 'null': 'True', 'to': "orm['resources.Medium']"}),
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
        ...
        'resources.documenttype': {
            'Meta': {'ordering': "['tree_id', 'lft']", 'object_name': 'DocumentType'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'child_set'", 'null': 'True', 'to': "orm['resources.DocumentType']"}),
            'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '255', 'db_index': 'True'}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'title': ('base_libs.models.fields.MultilingualCharField', [], {'max_length': '255', 'null': 'True'}),
        ...
        'resources.medium': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'Medium'},
            'creation_date': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '255', 'db_index': 'True'}),
