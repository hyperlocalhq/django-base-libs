...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('resources_document', 'is_featured', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
        ...
        for lang_code, lang_name in settings.LANGUAGES:
            ...
            db.alter_column('resources_document', 'description_%s' % lang_code, self.gf('base_libs.models.fields.ExtendedTextField')(u'Description', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Document.document_type'
        db.alter_column('resources_document', 'document_type_id', self.gf('mptt.fields.TreeForeignKey')(to=orm['resources.DocumentType']))

    
    def backwards(self, orm):
        
        # Deleting field 'Document.is_featured'
        db.delete_column('resources_document', 'is_featured')
        ...
        for lang_code, lang_name in settings.LANGUAGES:
            # Changing field 'Document.description_de'
            db.alter_column('resources_document', 'description_%s' % lang_code, self.gf('base_libs.models.fields.ExtendedTextField')(u'Beschreibung', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Document.document_type'
        db.alter_column('resources_document', 'document_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['resources.DocumentType']))
    ...
    models = {
        ...
        'resources.document': {
            ...
            'document_type': ('mptt.fields.TreeForeignKey', [], {'related_name': "'type_documents'", 'to': "orm['resources.DocumentType']"}),
