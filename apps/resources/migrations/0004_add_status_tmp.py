...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Document.status_tmp'
        db.add_column('resources_document', 'status_tmp', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Changing field 'Document.authors_plain'
        db.alter_column('resources_document', 'authors_plain', self.gf('base_libs.models.fields.PlainTextModelField')(max_length=255))

        # Changing field 'Document.image'
        db.alter_column('resources_document', 'image', self.gf('filebrowser.fields.FileBrowseField')(directory='/documents/', max_length=255, extensions=['.jpg', '.jpeg', '.gif', '.png', '.tif', '.tiff']))

        # Changing field 'Document.url_link'
        db.alter_column('resources_document', 'url_link', self.gf('base_libs.models.fields.URLField')(max_length=200))

        # Changing field 'Document.creation_date'
        db.alter_column('resources_document', 'creation_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Document.file_size'
        db.alter_column('resources_document', 'file_size', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Document.description_de'
        db.alter_column('resources_document', 'description_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Beschreibung', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Document.modified_date'
        db.alter_column('resources_document', 'modified_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Document.published_mm'
        db.alter_column('resources_document', 'published_mm', self.gf('django.db.models.fields.SmallIntegerField')(null=True))

        # Changing field 'Document.published_yyyy'
        db.alter_column('resources_document', 'published_yyyy', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Document.document_file'
        db.alter_column('resources_document', 'document_file', self.gf('filebrowser.fields.FileBrowseField')(max_length=255))

        # Changing field 'Document.status'
        db.alter_column('resources_document', 'status_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['structure.Term']))

        # Changing field 'Document.playing_time'
        db.alter_column('resources_document', 'playing_time', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'Document.medium'
        db.alter_column('resources_document', 'medium_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['structure.Term']))

        # Changing field 'Document.description'
        db.alter_column('resources_document', 'description', self.gf('base_libs.models.fields.MultilingualTextField')(null=True))

        # Changing field 'Document.published_dd'
        db.alter_column('resources_document', 'published_dd', self.gf('django.db.models.fields.SmallIntegerField')(null=True))

        # Changing field 'Document.description_en'
        db.alter_column('resources_document', 'description_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Beschreibung', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Document.document_type'
        db.alter_column('resources_document', 'document_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structure.Term']))

        # Changing field 'Document.pages'
        db.alter_column('resources_document', 'pages', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Document.publisher'
        db.alter_column('resources_document', 'publisher_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['institutions.Institution'], null=True))

        # Changing field 'Document.slug'
        db.alter_column('resources_document', 'slug', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Document.isbn10'
        db.alter_column('resources_document', 'isbn10', self.gf('django.db.models.fields.CharField')(max_length=13))

        # Changing field 'Document.isbn13'
        db.alter_column('resources_document', 'isbn13', self.gf('django.db.models.fields.CharField')(max_length=17))

        # Changing field 'Document.title'
        db.alter_column('resources_document', 'title', self.gf('base_libs.models.fields.MultilingualCharField')(max_length=255, null=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Document.status_tmp'
        db.delete_column('resources_document', 'status_tmp')

        # Changing field 'Document.authors_plain'
        db.alter_column('resources_document', 'authors_plain', self.gf('PlainTextModelField')(_("External authors"), max_length=255))

        # Changing field 'Document.image'
        db.alter_column('resources_document', 'image', self.gf('FileBrowseField')(_('Image'), directory="/%s/"%URL_ID_DOCUMENTS, max_length=255, extensions=['.jpg','.jpeg','.gif','.png','.tif','.tiff']))

        # Changing field 'Document.url_link'
        db.alter_column('resources_document', 'url_link', self.gf('URLField')(_("URL")))

        # Changing field 'Document.creation_date'
        db.alter_column('resources_document', 'creation_date', self.gf('models.DateTimeField')(_("creation date"), editable=False))

        # Changing field 'Document.file_size'
        db.alter_column('resources_document', 'file_size', self.gf('models.PositiveIntegerField')(_("File size (MB)"), null=True))

        # Changing field 'Document.description_de'
        db.alter_column('resources_document', 'description_de', self.gf('ExtendedTextField')(u'Description', rel=None, unique_for_year=None, unique=False, unique_for_month=None, null=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace='', unique_for_date=None))

        # Changing field 'Document.modified_date'
        db.alter_column('resources_document', 'modified_date', self.gf('models.DateTimeField')(_("modified date"), null=True, editable=False))

        # Changing field 'Document.published_mm'
        db.alter_column('resources_document', 'published_mm', self.gf('models.SmallIntegerField')(_("Month of Publishing"), null=True))

        # Changing field 'Document.published_yyyy'
        db.alter_column('resources_document', 'published_yyyy', self.gf('models.IntegerField')(_("Year of Publishing"), null=True))

        # Changing field 'Document.document_file'
        db.alter_column('resources_document', 'document_file', self.gf('FileBrowseField')(_('Document file'), max_length=255))

        # Changing field 'Document.status'
        db.alter_column('resources_document', 'status_id', self.gf('models.ForeignKey')(orm['structure.Term'], limit_choices_to={'vocabulary__sysname':'basics_object_statuses'}, null=True))

        # Changing field 'Document.playing_time'
        db.alter_column('resources_document', 'playing_time', self.gf('models.TimeField')(_("Playing time"), null=True))

        # Changing field 'Document.medium'
        db.alter_column('resources_document', 'medium_id', self.gf('models.ForeignKey')(orm['structure.Term'], limit_choices_to={'vocabulary__sysname':'basics_media'}, null=True))

        # Changing field 'Document.description'
        db.alter_column('resources_document', 'description', self.gf('MultilingualTextField')(_("Description")))

        # Changing field 'Document.published_dd'
        db.alter_column('resources_document', 'published_dd', self.gf('models.SmallIntegerField')(_("Day of Publishing"), null=True))

        # Changing field 'Document.description_en'
        db.alter_column('resources_document', 'description_en', self.gf('ExtendedTextField')(u'Description', rel=None, unique_for_year=None, unique=False, unique_for_month=None, null=False, primary_key=False, db_column=None, max_length=None, db_tablespace='', unique_for_date=None))

        # Changing field 'Document.document_type'
        db.alter_column('resources_document', 'document_type_id', self.gf('models.ForeignKey')(orm['structure.Term'], limit_choices_to=models.Q(vocabulary__sysname='basics_object_types',path_search__contains=ObjectTypeFilter("document"))&~models.Q(models.Q(sysname="document"))))

        # Changing field 'Document.pages'
        db.alter_column('resources_document', 'pages', self.gf('models.PositiveIntegerField')(_("Pages"), null=True))

        # Changing field 'Document.publisher'
        db.alter_column('resources_document', 'publisher_id', self.gf('models.ForeignKey')(orm['institutions.Institution'], null=True))

        # Changing field 'Document.slug'
        db.alter_column('resources_document', 'slug', self.gf('models.CharField')(_("Slug"), max_length=255))

        # Changing field 'Document.isbn10'
        db.alter_column('resources_document', 'isbn10', self.gf('models.CharField')(_("ISBN-10"), max_length=13))

        # Changing field 'Document.isbn13'
        db.alter_column('resources_document', 'isbn13', self.gf('models.CharField')(_("ISBN-13"), max_length=17))

        # Changing field 'Document.title'
        db.alter_column('resources_document', 'title', self.gf('MultilingualCharField')(_("Title"), max_length=255))
    ...
    models = {
        ...
        'resources.document': {
            ...
            'authors': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'author_documents'", 'blank': 'True', 'to': "orm['people.Person']"}),
            'authors_plain': ('base_libs.models.fields.PlainTextModelField', [], {'max_length': '255', 'blank': 'True'}),
            'context_categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['structure.ContextCategory']", 'symmetrical': 'False', 'blank': 'True'}),
            'creation_date': ('django.db.models.fields.DateTimeField', [], {}),
            'creative_sectors': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'creative_industry_documents'", 'blank': 'True', 'to': "orm['structure.Term']"}),
            'description': ('base_libs.models.fields.MultilingualTextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            'description_de': ('base_libs.models.fields.ExtendedTextField', ["u'Beschreibung'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'description_de_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            'description_en': ('base_libs.models.fields.ExtendedTextField', ["u'Beschreibung'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'description_en_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            'description_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            'document_file': ('filebrowser.fields.FileBrowseField', [], {'max_length': '255', 'blank': 'True'}),
            'document_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'type_documents'", 'to': "orm['structure.Term']"}),
            'file_size': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('filebrowser.fields.FileBrowseField', [], {'directory': "'/documents/'", 'max_length': '255', 'extensions': "['.jpg', '.jpeg', '.gif', '.png', '.tif', '.tiff']", 'blank': 'True'}),
            'isbn10': ('django.db.models.fields.CharField', [], {'max_length': '13', 'blank': 'True'}),
            'isbn13': ('django.db.models.fields.CharField', [], {'max_length': '17', 'blank': 'True'}),
            'languages': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['i18n.Language']", 'symmetrical': 'False', 'blank': 'True'}),
            'medium': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'medium_documents'", 'null': 'True', 'to': "orm['structure.Term']"}),
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'pages': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'playing_time': ('django.db.models.fields.TimeField', [], {'null': 'True', 'blank': 'True'}),
            'published_dd': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'published_mm': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'published_yyyy': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'publisher': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['institutions.Institution']", 'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'status': ('django.db.models.fields.related.ForeignKey', [], {'default': '87L', 'related_name': "'status_documents'", 'null': 'True', 'blank': 'True', 'to': "orm['structure.Term']"}),
            'status_tmp': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'title': ('base_libs.models.fields.MultilingualCharField', [], {'max_length': '255', 'null': 'True'}),
            'title_de': ('django.db.models.fields.CharField', ["u'Title'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'title_en': ('django.db.models.fields.CharField', ["u'Title'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'url_link': ('base_libs.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'})
        },
