...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('resources_document', 'status_id')
    
    
    def backwards(self, orm):
        
        # Adding field 'Document.status'
        db.add_column('resources_document', 'status', self.gf('django.db.models.fields.related.ForeignKey')(default=87L, related_name='status_documents', null=True, to=orm['structure.Term'], blank=True), keep_default=False)
