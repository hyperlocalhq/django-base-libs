...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('mailchimp_mlist', 'title_de', self.gf('django.db.models.fields.CharField')(u'Titel', null=False, primary_key=False, db_column=None, editable=True, max_length=255, db_tablespace='', unique=False))

        # Changing field 'MList.title_en'
        db.alter_column('mailchimp_mlist', 'title_en', self.gf('django.db.models.fields.CharField')(u'Titel', null=False, primary_key=False, db_column=None, editable=True, max_length=255, db_tablespace='', unique=False))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'MList.title_de'
        db.alter_column('mailchimp_mlist', 'title_de', self.gf('django.db.models.fields.CharField')(u'Title', unique=False, max_length=255, primary_key=False, db_column=None, null=False, editable=True, db_tablespace=''))

        # Changing field 'MList.title_en'
        db.alter_column('mailchimp_mlist', 'title_en', self.gf('django.db.models.fields.CharField')(u'Title', unique=False, max_length=255, primary_key=False, db_column=None, null=False, editable=True, db_tablespace=''))
