...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MList.title_en'
        # db.add_column(u'mailchimp_mlist', 'title_en',
        ...
        # Adding field 'MList.title_fr'
        db.add_column(u'mailchimp_mlist', 'title_fr',
                      self.gf('django.db.models.fields.CharField')(u'Title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'MList.title_pl'
        db.add_column(u'mailchimp_mlist', 'title_pl',
                      self.gf('django.db.models.fields.CharField')(u'Title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'MList.title_tr'
        db.add_column(u'mailchimp_mlist', 'title_tr',
                      self.gf('django.db.models.fields.CharField')(u'Title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'MList.title_es'
        db.add_column(u'mailchimp_mlist', 'title_es',
                      self.gf('django.db.models.fields.CharField')(u'Title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'MList.title_it'
        db.add_column(u'mailchimp_mlist', 'title_it',
                      self.gf('django.db.models.fields.CharField')(u'Title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'MList.title_en'
        # db.delete_column(u'mailchimp_mlist', 'title_en')

        # Deleting field 'MList.title_fr'
        db.delete_column(u'mailchimp_mlist', 'title_fr')

        # Deleting field 'MList.title_pl'
        db.delete_column(u'mailchimp_mlist', 'title_pl')

        # Deleting field 'MList.title_tr'
        db.delete_column(u'mailchimp_mlist', 'title_tr')

        # Deleting field 'MList.title_es'
        db.delete_column(u'mailchimp_mlist', 'title_es')

        # Deleting field 'MList.title_it'
        db.delete_column(u'mailchimp_mlist', 'title_it')
    ...
    models = {
        ...
        u'mailchimp.campaign': {
            ...
            'sender_email': ('django.db.models.fields.EmailField', [], {'default': "''", 'max_length': '75'}),
            'sender_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'}),
