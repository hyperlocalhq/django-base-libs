...
class MediaGalleryOptions(ObjectRelationMixinAdminOptions(admin_order_field=XFieldList(["content_object_repr_"])[0])):
    class Media:
        js = (
    ...
    fieldsets += [
        (_("Details"), {'fields': ("is_featured", "sort_order"), 'classes': ["collapse closed"]}),
        ]
