...
class MediaGalleryAppHook(CMSApp):
    name = _("Portfolios")
    urls = ["kb.apps.media_gallery.urls"]
...
class ArchitectureMediaGalleryApphook(CMSApp):
    ...
    urls = ["kb.apps.media_gallery.urls.architecture"]
...
class VisualArtsMediaGalleryApphook(CMSApp):
    ...
    urls = ["kb.apps.media_gallery.urls.visual_arts"]
...
class DesignMediaGalleryApphook(CMSApp):
    ...
    urls = ["kb.apps.media_gallery.urls.design"]
...
class EventIndustryMediaGalleryApphook(CMSApp):
    ...
    urls = ["kb.apps.media_gallery.urls.event_industry"]
...
class FilmBroadcastMediaGalleryApphook(CMSApp):
    ...
    urls = ["kb.apps.media_gallery.urls.film_broadcast"]
...
class PhotographyMediaGalleryApphook(CMSApp):
    ...
    urls = ["kb.apps.media_gallery.urls.photography"]
...
class GamesInteractiveMediaGalleryApphook(CMSApp):
    ...
    urls = ["kb.apps.media_gallery.urls.games_interactive"]
...
class LiteraturePublishingMediaGalleryApphook(CMSApp):
    ...
    urls = ["kb.apps.media_gallery.urls.literature_publishing"]
...
class FashionTextileMediaGalleryApphook(CMSApp):
    ...
    urls = ["kb.apps.media_gallery.urls.fashion_textile"]
...
class MusicMediaGalleryApphook(CMSApp):
    ...
    urls = ["kb.apps.media_gallery.urls.music"]
...
class TheatreDanceMediaGalleryApphook(CMSApp):
    ...
    urls = ["kb.apps.media_gallery.urls.theatre_dance"]
...
class AdvertisingPRMediaGalleryApphook(CMSApp):
    ...
    urls = ["kb.apps.media_gallery.urls.advertising_pr"]
