...
class MediaGalleryForm(dynamicforms.Form):
    ...
    cover_image = ImageField(
        label= _("Cover image"),
        help_text= _("If unspecified, the first image from the album will be used. You can upload GIF, JPG, PNG, TIFF, and BMP images. The minimal dimensions are %s px.") % STR_IMAGE_MIN_DIMENSIONS,
        required=False,
        min_dimensions=IMAGE_MIN_DIMENSIONS,
        )
