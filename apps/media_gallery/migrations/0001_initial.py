    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', base_libs.models.fields.MultilingualCharField(verbose_name='Title', max_length=100, null=True, editable=False, blank=True)),
                ('description', base_libs.models.fields.MultilingualTextField(default=b'', verbose_name='Description', null=True, editable=False, blank=True)),
                ('content_object_repr', base_libs.models.fields.MultilingualCharField(default=b'', editable=False, max_length=100, blank=True, help_text='Used for search and ordering in administration.', null=True, verbose_name='Content object representation')),
