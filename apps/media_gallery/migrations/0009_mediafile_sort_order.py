...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'MediaFile.sort_order'
        db.alter_column('media_gallery_mediafile', 'sort_order', self.gf('base_libs.models.fields.PositionField')(blank=True))

        # Changing field 'MediaGallery.sort_order'
        db.alter_column('media_gallery_mediagallery', 'sort_order', self.gf('base_libs.models.fields.PositionField')(blank=True))
