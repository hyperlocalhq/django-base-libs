...
from kb.apps.events.views import event_list
from kb.apps.marketplace.views import job_offer_list
from kb.apps.bulletin_board.views import bulletin_list
from kb.apps.institutions.views import institution_list
