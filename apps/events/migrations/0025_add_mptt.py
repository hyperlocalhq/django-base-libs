...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'EventType.path_search'
        db.delete_column('events_eventtype', 'path_search')

        # Deleting field 'EventType.path'
        db.delete_column('events_eventtype', 'path')

        # Adding field 'EventType.lft'
        db.add_column('events_eventtype', 'lft', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'EventType.rght'
        db.add_column('events_eventtype', 'rght', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'EventType.tree_id'
        db.add_column('events_eventtype', 'tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'EventType.level'
        db.add_column('events_eventtype', 'level', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Changing field 'EventType.parent'
        db.alter_column('events_eventtype', 'parent_id', self.gf('mptt.fields.TreeForeignKey')(null=True, to=orm['events.EventType']))

        # Changing field 'Event.event_type'
        db.alter_column('events_event', 'event_type_id', self.gf('mptt.fields.TreeForeignKey')(to=orm['events.EventType']))
    
    
    def backwards(self, orm):
        
        # Adding field 'EventType.path_search'
        db.add_column('events_eventtype', 'path_search', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'EventType.path'
        db.add_column('events_eventtype', 'path', self.gf('django.db.models.fields.CharField')(max_length=8192, null=True), keep_default=False)

        # Deleting field 'EventType.lft'
        db.delete_column('events_eventtype', 'lft')

        # Deleting field 'EventType.rght'
        db.delete_column('events_eventtype', 'rght')

        # Deleting field 'EventType.tree_id'
        db.delete_column('events_eventtype', 'tree_id')

        # Deleting field 'EventType.level'
        db.delete_column('events_eventtype', 'level')

        # Changing field 'EventType.parent'
        db.alter_column('events_eventtype', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['events.EventType']))

        # Changing field 'Event.event_type'
        db.alter_column('events_event', 'event_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.EventType']))
