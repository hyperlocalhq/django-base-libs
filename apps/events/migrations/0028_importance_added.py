...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('events_event', 'importance', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'Event.importance'
        db.delete_column('events_event', 'importance')
