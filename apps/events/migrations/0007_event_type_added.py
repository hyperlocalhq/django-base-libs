...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('events_event', 'event_type', self.gf('base_libs.models.fields.MultilingualCharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Event.event_type_de'
        db.add_column('events_event', 'event_type_de', self.gf('django.db.models.fields.CharField')(u'Type', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False), keep_default=False)

        # Adding field 'Event.event_type_en'
        db.add_column('events_event', 'event_type_en', self.gf('django.db.models.fields.CharField')(u'Type', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False), keep_default=False)

    
    def backwards(self, orm):
        
        # Deleting field 'Event.event_type'
        db.delete_column('events_event', 'event_type')

        # Deleting field 'Event.event_type_de'
        db.delete_column('events_event', 'event_type_de')

        # Deleting field 'Event.event_type_en'
        db.delete_column('events_event', 'event_type_en')
