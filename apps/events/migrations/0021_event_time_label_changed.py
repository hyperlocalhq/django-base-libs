...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventTime.label'
        db.alter_column('events_eventtime', 'label_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['events.EventTimeLabel']))
    
    
    def backwards(self, orm):
        
        # Changing field 'EventTime.label'
        db.alter_column('events_eventtime', 'label_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['structure.Term']))
