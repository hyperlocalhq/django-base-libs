...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('events_event', 'website', self.gf('base_libs.models.fields.MultilingualCharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Event.website_de'
        db.add_column('events_event', 'website_de', self.gf('django.db.models.fields.CharField')(u'Website', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False), keep_default=False)

        # Adding field 'Event.website_en'
        db.add_column('events_event', 'website_en', self.gf('django.db.models.fields.CharField')(u'Website', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False), keep_default=False)

    
    def backwards(self, orm):
        
        # Adding field 'Event.link'
        db.add_column('events_event', 'link', self.gf('base_libs.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)

        # Deleting field 'Event.website'
        db.delete_column('events_event', 'website')

        # Deleting field 'Event.website_de'
        db.delete_column('events_event', 'website_de')

        # Deleting field 'Event.website_en'
        db.delete_column('events_event', 'website_en')
