...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.closest_event_time'
        db.add_column('events_event', 'closest_event_time', self.gf('django.db.models.fields.TimeField')(null=True, blank=True), keep_default=False)

    
    def backwards(self, orm):
        
        # Deleting field 'Event.closest_event_time'
        db.delete_column('events_event', 'closest_event_time')
