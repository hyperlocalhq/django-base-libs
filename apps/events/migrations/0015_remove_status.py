...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('events_event', 'status_id')
    
    
    def backwards(self, orm):
        
        # Adding field 'Event.status'
        db.add_column('events_event', 'status', self.gf('django.db.models.fields.related.ForeignKey')(default=87L, related_name='status_events', null=True, to=orm['structure.Term'], blank=True), keep_default=False)
