...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('events_event', 'email', self.gf('django.db.models.fields.EmailField')(default='', max_length=255, blank=True), keep_default=False)

    
    def backwards(self, orm):
        
        # Deleting field 'Event.email'
        db.delete_column('events_event', 'email')
