...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('events_organizer', south_cleaned_fields((
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Event'])),
            ('organizing_museum', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='event_organizer', null=True, to=orm['museums.Museum'])),
