...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'EventTime.start_ii'
        db.delete_column('events_eventtime', 'start_ii')

        # Deleting field 'EventTime.start_hh'
        db.delete_column('events_eventtime', 'start_hh')

        # Deleting field 'EventTime.end_yyyy'
        db.delete_column('events_eventtime', 'end_yyyy')

        # Deleting field 'EventTime.end_hh'
        db.delete_column('events_eventtime', 'end_hh')

        # Deleting field 'EventTime.end_ii'
        db.delete_column('events_eventtime', 'end_ii')

        # Deleting field 'EventTime.start_dd'
        db.delete_column('events_eventtime', 'start_dd')

        # Deleting field 'EventTime.end_dd'
        db.delete_column('events_eventtime', 'end_dd')

        # Deleting field 'EventTime.end_mm'
        db.delete_column('events_eventtime', 'end_mm')

        # Deleting field 'EventTime.start_yyyy'
        db.delete_column('events_eventtime', 'start_yyyy')

        # Deleting field 'EventTime.start_mm'
        db.delete_column('events_eventtime', 'start_mm')

        # Deleting field 'EventTime.is_all_day'
        db.delete_column('events_eventtime', 'is_all_day')

        # Adding field 'EventTime.event_date'
        db.add_column('events_eventtime', 'event_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2013, 1, 25)), keep_default=False)

        # Changing field 'EventTime.start'
        db.alter_column('events_eventtime', 'start', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'EventTime.end'
        db.alter_column('events_eventtime', 'end', self.gf('django.db.models.fields.TimeField')(null=True))
    ...
    models = {
        ...
        'events.event': {
            ...
            'organizing_museum': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'organized_events'", 'null': 'True', 'to': "orm['museums.Museum']"}),
