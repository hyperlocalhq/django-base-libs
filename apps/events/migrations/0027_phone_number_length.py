...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.phone0_area'
        db.alter_column('events_event', 'phone0_area', self.gf('django.db.models.fields.CharField')(max_length=6))

        # Changing field 'Event.description_en'
        db.alter_column('events_event', 'description_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Description', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Event.fees_en'
        db.alter_column('events_event', 'fees_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Fees', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Event.phone0_number'
        db.alter_column('events_event', 'phone0_number', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'Event.phone1_number'
        db.alter_column('events_event', 'phone1_number', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'Event.description_de'
        db.alter_column('events_event', 'description_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Description', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Event.exceptions_en'
        db.alter_column('events_event', 'exceptions_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Exceptions for working hours', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Event.phone1_area'
        db.alter_column('events_event', 'phone1_area', self.gf('django.db.models.fields.CharField')(max_length=6))

        # Changing field 'Event.phone2_area'
        db.alter_column('events_event', 'phone2_area', self.gf('django.db.models.fields.CharField')(max_length=6))

        # Changing field 'Event.additional_info_en'
        db.alter_column('events_event', 'additional_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Additional Info', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Event.phone2_number'
        db.alter_column('events_event', 'phone2_number', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'Event.exceptions_de'
        db.alter_column('events_event', 'exceptions_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Exceptions for working hours', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Event.fees_de'
        db.alter_column('events_event', 'fees_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Fees', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Event.additional_info_de'
        db.alter_column('events_event', 'additional_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Additional Info', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))
    
    
    def backwards(self, orm):
        
        # Changing field 'Event.phone0_area'
        db.alter_column('events_event', 'phone0_area', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'Event.description_en'
        db.alter_column('events_event', 'description_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Beschreibung', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Event.fees_en'
        db.alter_column('events_event', 'fees_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintrittskosten', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Event.phone0_number'
        db.alter_column('events_event', 'phone0_number', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'Event.phone1_number'
        db.alter_column('events_event', 'phone1_number', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'Event.description_de'
        db.alter_column('events_event', 'description_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Beschreibung', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Event.exceptions_en'
        db.alter_column('events_event', 'exceptions_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Sonstige \xd6ffnungszeiten', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Event.phone1_area'
        db.alter_column('events_event', 'phone1_area', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'Event.phone2_area'
        db.alter_column('events_event', 'phone2_area', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'Event.additional_info_en'
        db.alter_column('events_event', 'additional_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Zusatzinformation', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, max_length=None, db_tablespace=''))

        # Changing field 'Event.phone2_number'
        db.alter_column('events_event', 'phone2_number', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'Event.exceptions_de'
        db.alter_column('events_event', 'exceptions_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Sonstige \xd6ffnungszeiten', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, max_length=None, db_tablespace=''))

        # Changing field 'Event.fees_de'
        db.alter_column('events_event', 'fees_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintrittskosten', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, max_length=None, db_tablespace=''))

        # Changing field 'Event.additional_info_de'
        db.alter_column('events_event', 'additional_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Zusatzinformation', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, max_length=None, db_tablespace=''))
    ...
    models = {
        ...
        'events.event': {
            ...
            'creative_sectors': ('mptt.fields.TreeManyToManyField', [], {'symmetrical': 'False', 'related_name': "'creative_industry_events'", 'blank': 'True', 'to': "orm['structure.Term']"}),
            ...
            'phone1_type': ('django.db.models.fields.related.ForeignKey', [], {'default': '2L', 'related_name': "'events1'", 'null': 'True', 'blank': 'True', 'to': "orm['optionset.PhoneType']"}),
            ...
            'phone2_type': ('django.db.models.fields.related.ForeignKey', [], {'default': '3L', 'related_name': "'events2'", 'null': 'True', 'blank': 'True', 'to': "orm['optionset.PhoneType']"}),
