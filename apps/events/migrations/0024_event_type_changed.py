...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Event.event_type'
        db.alter_column('events_event', 'event_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['structure.Term']))
    ...
    models = {
        ...
        'events.event': {
            ...
            'event_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'type_events'", 'to': "orm['events.EventType']"}),
