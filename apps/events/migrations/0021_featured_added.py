...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('events_event', 'admission_price_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintrittspreis Infotext', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Event.admission_price_info_en'
        db.alter_column('events_event', 'admission_price_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintrittspreis Infotext', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Event.admission_price_info_de'
        db.alter_column('events_event', 'admission_price_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintrittpreis Infotext', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Event.admission_price_info_en'
        db.alter_column('events_event', 'admission_price_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintrittpreis Infotext', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))
