...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.status_tmp'
        db.add_column('events_event', 'status_tmp', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Changing field 'Event.description_de'
        db.alter_column('events_event', 'description_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Beschreibung', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Event.description_en'
        db.alter_column('events_event', 'description_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Beschreibung', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Event.fees_en'
        db.alter_column('events_event', 'fees_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintrittskosten', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Event.exceptions_en'
        db.alter_column('events_event', 'exceptions_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Sonstige \xd6ffnungszeiten', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Event.additional_info_en'
        db.alter_column('events_event', 'additional_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Zusatzinformation', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Event.exceptions_de'
        db.alter_column('events_event', 'exceptions_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Sonstige \xd6ffnungszeiten', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Event.fees_de'
        db.alter_column('events_event', 'fees_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintrittskosten', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Event.additional_info_de'
        db.alter_column('events_event', 'additional_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Zusatzinformation', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Event.status_tmp'
        db.delete_column('events_event', 'status_tmp')

        # Changing field 'Event.description_de'
        db.alter_column('events_event', 'description_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Description', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Event.description_en'
        db.alter_column('events_event', 'description_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Description', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Event.fees_en'
        db.alter_column('events_event', 'fees_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Fees', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Event.exceptions_en'
        db.alter_column('events_event', 'exceptions_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Exceptions for working hours', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Event.additional_info_en'
        db.alter_column('events_event', 'additional_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Additional Info', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, max_length=None, db_tablespace=''))

        # Changing field 'Event.exceptions_de'
        db.alter_column('events_event', 'exceptions_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Exceptions for working hours', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, max_length=None, db_tablespace=''))

        # Changing field 'Event.fees_de'
        db.alter_column('events_event', 'fees_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Fees', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, max_length=None, db_tablespace=''))

        # Changing field 'Event.additional_info_de'
        db.alter_column('events_event', 'additional_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Additional Info', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, max_length=None, db_tablespace=''))
    ...
    models = {
        ...
        'events.event': {
            ...
            'additional_info_de': ('base_libs.models.fields.ExtendedTextField', ["u'Zusatzinformation'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'additional_info_de_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            'additional_info_en': ('base_libs.models.fields.ExtendedTextField', ["u'Zusatzinformation'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            ...
            'fees_de': ('base_libs.models.fields.ExtendedTextField', ["u'Eintrittskosten'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'fees_de_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            'fees_en': ('base_libs.models.fields.ExtendedTextField', ["u'Eintrittskosten'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            ...
            'status': ('django.db.models.fields.related.ForeignKey', [], {'default': '87L', 'related_name': "'status_events'", 'null': 'True', 'blank': 'True', 'to': "orm['structure.Term']"}),
        ...
        'events.eventtime': {
            ...
            'label': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'label_event_types'", 'null': 'True', 'to': "orm['structure.Term']"}),
