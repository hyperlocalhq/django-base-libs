...
class ArchitectureEventsApphook(CMSApp):
    ...
    urls = ["ccb.apps.events.urls.architecture"]
...
class VisualArtsEventsApphook(CMSApp):
    ...
    urls = ["ccb.apps.events.urls.visual_arts"]
...
class DesignEventsApphook(CMSApp):
    ...
    urls = ["ccb.apps.events.urls.design"]
...
class EventIndustryEventsApphook(CMSApp):
    ...
    urls = ["ccb.apps.events.urls.event_industry"]
...
class FilmBroadcastEventsApphook(CMSApp):
    ...
    urls = ["ccb.apps.events.urls.film_broadcast"]
...
class PhotographyEventsApphook(CMSApp):
    ...
    urls = ["ccb.apps.events.urls.photography"]
...
class GamesInteractiveEventsApphook(CMSApp):
    ...
    urls = ["ccb.apps.events.urls.games_interactive"]
...
class LiteraturePublishingEventsApphook(CMSApp):
    ...
    urls = ["ccb.apps.events.urls.literature_publishing"]
...
class FashionTextileEventsApphook(CMSApp):
    ...
    urls = ["ccb.apps.events.urls.fashion_textile"]
...
class MusicEventsApphook(CMSApp):
    name = _("Music - Events")
    urls = ["ccb.apps.events.urls.music"]
...
class TheatreDanceEventsApphook(CMSApp):
    ...
    urls = ["ccb.apps.events.urls.theatre_dance"]
...
class AdvertisingPREventsApphook(CMSApp):
    ...
    urls = ["ccb.apps.events.urls.advertising_pr"]
