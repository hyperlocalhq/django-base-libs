        ...
        layout_blocks.append(bootstrap.FormActions(
            ...
            layout.HTML(u"""{% load i18n base_tags image_modifications %}
                {% if media_file %}
                    ...
                    <input type="button" id="button-id-delete-photo" class="delete_photo btn" data-href="{{ event.get_url_path }}gallery/file_{{ media_file.get_token }}/delete/" value="{% trans "Delete" %}" />&zwnj;
                    <!-- Modal -->
