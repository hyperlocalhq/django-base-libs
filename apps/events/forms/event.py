...
def load_data(instance=None):
    ...
    if instance:
        ...
        form_step_data['basic']['event_extended'] = instance.event_extended
...
def save_data(form_steps, form_step_data, instance=None):
    ...
    instance.event_extended = form_step_data['basic']['event_extended'] 
    ...
    for special_opening_dict in form_step_data['opening']['sets']['special_openings']:
        special_opening = SpecialOpeningTime(event=instance)
...
EVENT_FORM_STEPS = {
    ...
    'default_path': ["basic", "prices", "event_times"],
}
