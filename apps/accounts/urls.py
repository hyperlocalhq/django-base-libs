...
from kb.apps.accounts.forms import password_change_form_helper
from kb.apps.accounts.forms import password_reset_form_helper
from kb.apps.accounts.forms import password_reset_change_form_helper
...
urlpatterns = [
    url(
        r'^login/$',
        'kb.apps.accounts.views.login',
        {'template_name': 'accounts/login.html'},
        name="login",
    ),
    url(r'^social-login/$',
        'kb.apps.accounts.views.social_login',
        name="social_login",
    ),
    url(r'^social-connections/$',
        'kb.apps.accounts.views.social_connections',
        name="social_connections",
    ),
    url(
        r'^social-connections/link/$',
        "kb.apps.accounts.views.social_connection_link",
        name="social_connection_link",
    ),
    url(
        r'^social-connections/link/login/$',
        "kb.apps.accounts.views.social_connection_login",
        name="social_connection_login",
    ),
    url(
        r'^social-connections/link/register/$',
        "kb.apps.accounts.views.social_connection_register",
    ...
    url(
        r'^register/$',
        'kb.apps.accounts.views.register',
        name="register"
    ),
    url(
        r'^register/done/$',
    ...
    url(
        ...
        'kb.apps.accounts.views.confirm_registration',
    ...
    url(r'^ajax-auth/(?P<backend>[^/]+)/$',
        'kb.apps.accounts.views.ajax_auth',
        name='ajax-auth'
    ),
    # activity stream
