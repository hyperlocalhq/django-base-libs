...
from kb.apps.accounts.forms import EmailOrUsernameAuthentication
from kb.apps.accounts.forms import SimpleRegistrationForm
from kb.apps.accounts.forms import PrivacySettingsForm
...
def user_stream(request):
    ...
    template = "kb/accounts/activities/user_stream.html"
    context = {
...
def actor_stream(request):
    ...
    template = "kb/accounts/activities/actor_stream.html"
    context = {
        # show the latest 20 activities
        "stream": stream[:20]
    }
...
def action_object_stream(request):
    ...
    template = "kb/accounts/activities/action_object_stream.html"
    context = {
        # show the latest 20 activities
        "stream": stream[:20]
    }
...
def target_stream(request):
    ...
    template = "kb/accounts/activities/target_stream.html"
    context = {
        # show the latest 20 activities
        "stream": stream[:20]
    }
...
def model_stream(request):
    ...
    template = "kb/accounts/activities/model_stream.html"
    context = {
        # show the latest 20 activities
        "stream": stream[:20]
    }
...
def any_stream(request):
    ...
    template = "kb/accounts/activities/any_stream.html"
    context = {
        # show the latest 20 activities
        "stream": stream[:20]
    }
