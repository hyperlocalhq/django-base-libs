...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ContextCategory.path_search'
        db.delete_column('structure_contextcategory', 'path_search')

        # Deleting field 'Term.path_search'
        db.delete_column('structure_term', 'path_search')

    
    def backwards(self, orm):
        
        # Adding field 'ContextCategory.path_search'
        db.add_column('structure_contextcategory', 'path_search', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Term.path_search'
        db.add_column('structure_term', 'path_search', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
