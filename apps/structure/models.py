...
class ContextCategory(MPTTModel,  SlugMixin(), SysnameMixin()):
    ...
    is_applied4institution = models.BooleanField(_("for institutions"), default=True)
    ...
    is_applied4persongroup = models.BooleanField(_("for groups of people"), default=True)
