...
class BulletinSearchForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = layout.Layout(
            layout.Fieldset(
                _("Filter"),
                layout.Field("bulletin_type", template="kb_form/custom_widgets/filter_field.html"),
                layout.Field("bulletin_category", template="kb_form/custom_widgets/filter_field.html"),
