...
class BulletinBoardApphook(CMSApp):
    ...
    urls = ["kb.apps.bulletin_board.urls"]
...
class ArchitectureBulletinBoardApphook(CMSApp):
    ...
    urls = ["kb.apps.bulletin_board.urls.architecture"]
...
class VisualArtsBulletinBoardApphook(CMSApp):
    ...
    urls = ["kb.apps.bulletin_board.urls.visual_arts"]
...
class DesignBulletinBoardApphook(CMSApp):
    ...
    urls = ["kb.apps.bulletin_board.urls.design"]
...
class EventIndustryBulletinBoardApphook(CMSApp):
    ...
    urls = ["kb.apps.bulletin_board.urls.event_industry"]
...
class FilmBroadcastBulletinBoardApphook(CMSApp):
    ...
    urls = ["kb.apps.bulletin_board.urls.film_broadcast"]
...
class PhotographyBulletinBoardApphook(CMSApp):
    ...
    urls = ["kb.apps.bulletin_board.urls.photography"]
...
class GamesInteractiveBulletinBoardApphook(CMSApp):
    ...
    urls = ["kb.apps.bulletin_board.urls.games_interactive"]
...
class LiteraturePublishingBulletinBoardApphook(CMSApp):
    ...
    urls = ["kb.apps.bulletin_board.urls.literature_publishing"]
...
class FashionTextileBulletinBoardApphook(CMSApp):
    ...
    urls = ["kb.apps.bulletin_board.urls.fashion_textile"]
...
class MusicBulletinBoardApphook(CMSApp):
    ...
    urls = ["kb.apps.bulletin_board.urls.music"]
...
class TheatreDanceBulletinBoardApphook(CMSApp):
    ...
    urls = ["kb.apps.bulletin_board.urls.theatre_dance"]
...
class AdvertisingPRBulletinBoardApphook(CMSApp):
    ...
    urls = ["kb.apps.bulletin_board.urls.advertising_pr"]
