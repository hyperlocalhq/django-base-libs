...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('facebook_app_facebookpage', south_cleaned_fields((
            ...
            ('owner_settings', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['facebook_app.FacebookAppSettings'])),
        ...
        db.send_create_signal('facebook_app', ['FacebookPage'])

    def backwards(self, orm):
        
        # Deleting model 'FacebookPage'
        db.delete_table('facebook_app_facebookpage')
