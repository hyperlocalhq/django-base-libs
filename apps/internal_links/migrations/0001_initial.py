...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('internal_links_linkgroup', south_cleaned_fields((
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('modified_date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='linkgroup_creator', null=True, to=orm['auth.User'])),
            ('modifier', self.gf('django.db.models.fields.related.ForeignKey')(related_name='linkgroup_modifier', null=True, to=orm['auth.User'])),
            ('group_title', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('language', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('link_1_text', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('link_1_url', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('link_2_text', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('link_2_url', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('link_3_text', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('link_3_url', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        )))
        db.send_create_signal('internal_links', ['LinkGroup'])

        # Adding M2M table for field museums on 'LinkGroup'
        db.create_table('internal_links_linkgroup_museums', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('linkgroup', models.ForeignKey(orm['internal_links.linkgroup'], null=False)),
            ('museum', models.ForeignKey(orm['museums.museum'], null=False))
        ))
        db.create_unique('internal_links_linkgroup_museums', ['linkgroup_id', 'museum_id'])

        # Adding M2M table for field exhibitions on 'LinkGroup'
        db.create_table('internal_links_linkgroup_exhibitions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('linkgroup', models.ForeignKey(orm['internal_links.linkgroup'], null=False)),
            ('exhibition', models.ForeignKey(orm['exhibitions.exhibition'], null=False))
        ))
        db.create_unique('internal_links_linkgroup_exhibitions', ['linkgroup_id', 'exhibition_id'])

        # Adding M2M table for field events on 'LinkGroup'
        db.create_table('internal_links_linkgroup_events', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('linkgroup', models.ForeignKey(orm['internal_links.linkgroup'], null=False)),
            ('event', models.ForeignKey(orm['events.event'], null=False))
        ))
        db.create_unique('internal_links_linkgroup_events', ['linkgroup_id', 'event_id'])

        # Adding M2M table for field workshops on 'LinkGroup'
        db.create_table('internal_links_linkgroup_workshops', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('linkgroup', models.ForeignKey(orm['internal_links.linkgroup'], null=False)),
            ('workshop', models.ForeignKey(orm['workshops.workshop'], null=False))
        ))
        db.create_unique('internal_links_linkgroup_workshops', ['linkgroup_id', 'workshop_id'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'LinkGroup'
        db.delete_table('internal_links_linkgroup')

        # Removing M2M table for field museums on 'LinkGroup'
        db.delete_table('internal_links_linkgroup_museums')

        # Removing M2M table for field exhibitions on 'LinkGroup'
        db.delete_table('internal_links_linkgroup_exhibitions')

        # Removing M2M table for field events on 'LinkGroup'
        db.delete_table('internal_links_linkgroup_events')

        # Removing M2M table for field workshops on 'LinkGroup'
        db.delete_table('internal_links_linkgroup_workshops')
    ...
    models = {
        ...
        'events.event': {
            ...
            'admission_price_info_de': ('base_libs.models.fields.ExtendedTextField', ["u'Eintrittspreis Infotext'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'admission_price_info_de_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            'admission_price_info_en': ('base_libs.models.fields.ExtendedTextField', ["u'Eintrittspreis Infotext'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
        ...
        'exhibitions.exhibition': {
            ...
            'reduced_price_info_de': ('base_libs.models.fields.ExtendedTextField', ["u'Eintrittspreis erm\\xe4\\xdfigt Infotext'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'reduced_price_info_de_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            'reduced_price_info_en': ('base_libs.models.fields.ExtendedTextField', ["u'Eintrittspreis erm\\xe4\\xdfigt Infotext'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
        ...
        'internal_links.linkgroup': {
            'Meta': {'object_name': 'LinkGroup'},
            'creation_date': ('django.db.models.fields.DateTimeField', [], {}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'linkgroup_creator'", 'null': 'True', 'to': "orm['auth.User']"}),
            'events': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['events.Event']", 'symmetrical': 'False', 'blank': 'True'}),
            'exhibitions': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['exhibitions.Exhibition']", 'symmetrical': 'False', 'blank': 'True'}),
            ...
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'modifier': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'linkgroup_modifier'", 'null': 'True', 'to': "orm['auth.User']"}),
            'museums': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['museums.Museum']", 'symmetrical': 'False', 'blank': 'True'}),
            'workshops': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['workshops.Workshop']", 'symmetrical': 'False', 'blank': 'True'})
        },
        ...
        'workshops.workshop': {
            ...
            'title_de': ('django.db.models.fields.CharField', ["u'Title'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'title_en': ('django.db.models.fields.CharField', ["u'Title'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'types': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['workshops.WorkshopType']", 'symmetrical': 'False'}),
            'website': ('base_libs.models.fields.MultilingualCharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'website_de': ('django.db.models.fields.CharField', ["u'Website'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'website_en': ('django.db.models.fields.CharField', ["u'Website'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
