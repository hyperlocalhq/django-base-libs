...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LinkGroup.creator'
        db.alter_column(u'internal_links_linkgroup', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'LinkGroup.modifier'
        db.alter_column(u'internal_links_linkgroup', 'modifier_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))
    
    
    def backwards(self, orm):
        
        # Changing field 'LinkGroup.creator'
        db.alter_column(u'internal_links_linkgroup', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'LinkGroup.modifier'
        db.alter_column(u'internal_links_linkgroup', 'modifier_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
    ...
    models = {
        ...
        u'events.event': {
            ...
            'search_keywords_de': ('base_libs.models.fields.PlainTextModelField', ["u'Search keywords'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'search_keywords_en': ('base_libs.models.fields.PlainTextModelField', ["u'Search keywords'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'search_keywords_es': ('base_libs.models.fields.PlainTextModelField', ["u'Search keywords'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'search_keywords_fr': ('base_libs.models.fields.PlainTextModelField', ["u'Search keywords'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'search_keywords_it': ('base_libs.models.fields.PlainTextModelField', ["u'Search keywords'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'search_keywords_pl': ('base_libs.models.fields.PlainTextModelField', ["u'Search keywords'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'search_keywords_tr': ('base_libs.models.fields.PlainTextModelField', ["u'Search keywords'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'shop_link': ('base_libs.models.fields.MultilingualCharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'shop_link_de': ('django.db.models.fields.CharField', ["u'Buy ticket'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'shop_link_en': ('django.db.models.fields.CharField', ["u'Buy ticket'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'shop_link_es': ('django.db.models.fields.CharField', ["u'Buy ticket'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'shop_link_fr': ('django.db.models.fields.CharField', ["u'Buy ticket'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'shop_link_it': ('django.db.models.fields.CharField', ["u'Buy ticket'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'shop_link_pl': ('django.db.models.fields.CharField', ["u'Buy ticket'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'shop_link_tr': ('django.db.models.fields.CharField', ["u'Buy ticket'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
        ...
        u'internal_links.linkgroup': {
            'Meta': {'object_name': 'LinkGroup'},
            'creation_date': ('django.db.models.fields.DateTimeField', [], {}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'linkgroup_creator'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            'events': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['events.Event']", 'symmetrical': 'False', 'blank': 'True'}),
            'exhibitions': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['exhibitions.Exhibition']", 'symmetrical': 'False', 'blank': 'True'}),
            'group_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.CharField', [], {'max_length': '5'}),
            'link_1_text': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'link_1_url': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'link_2_text': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'link_2_url': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'link_3_text': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'link_3_url': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'modifier': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'linkgroup_modifier'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            'museums': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['museums.Museum']", 'symmetrical': 'False', 'blank': 'True'}),
            'workshops': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['workshops.Workshop']", 'symmetrical': 'False', 'blank': 'True'})
        },
