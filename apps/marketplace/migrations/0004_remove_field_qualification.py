...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'JobOffer.qualification'
        db.delete_column('marketplace_joboffer', 'qualification_id')
    
    def backwards(self, orm):
        
        # Adding field 'JobOffer.qualification'
        db.add_column('marketplace_joboffer', 'qualification', orm['marketplace.joboffer:qualification'])
    ...
    models = {
        ...
        'marketplace.jobqualification': {
            ...
            'title_de': ('models.CharField', ["u'title'"], {'unique': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'False', 'null': 'False', 'db_index': 'False'}),
            'title_en': ('models.CharField', ["u'title'"], {'unique': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'False', 'null': 'False', 'db_index': 'False'})
        },
