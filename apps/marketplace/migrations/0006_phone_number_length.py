...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JobOffer.phone0_area'
        db.alter_column('marketplace_joboffer', 'phone0_area', self.gf('django.db.models.fields.CharField')(max_length=6))

        # Changing field 'JobOffer.phone0_number'
        db.alter_column('marketplace_joboffer', 'phone0_number', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'JobOffer.phone1_number'
        db.alter_column('marketplace_joboffer', 'phone1_number', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'JobOffer.phone1_area'
        db.alter_column('marketplace_joboffer', 'phone1_area', self.gf('django.db.models.fields.CharField')(max_length=6))

        # Changing field 'JobOffer.phone2_area'
        db.alter_column('marketplace_joboffer', 'phone2_area', self.gf('django.db.models.fields.CharField')(max_length=6))

        # Changing field 'JobOffer.phone2_number'
        db.alter_column('marketplace_joboffer', 'phone2_number', self.gf('django.db.models.fields.CharField')(max_length=25))
    
    
    def backwards(self, orm):
        
        # Changing field 'JobOffer.phone0_area'
        db.alter_column('marketplace_joboffer', 'phone0_area', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'JobOffer.phone0_number'
        db.alter_column('marketplace_joboffer', 'phone0_number', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'JobOffer.phone1_number'
        db.alter_column('marketplace_joboffer', 'phone1_number', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'JobOffer.phone1_area'
        db.alter_column('marketplace_joboffer', 'phone1_area', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'JobOffer.phone2_area'
        db.alter_column('marketplace_joboffer', 'phone2_area', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'JobOffer.phone2_number'
        db.alter_column('marketplace_joboffer', 'phone2_number', self.gf('django.db.models.fields.CharField')(max_length=15))
    ...
    models = {
        ...
        'marketplace.joboffer': {
            'Meta': {'ordering': "['position', 'creation_date']", 'object_name': 'JobOffer'},
            'additional_info': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'author': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'joboffer_author'", 'null': 'True', 'to': "orm['auth.User']"}),
            ...
            'email0_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'job_offers0'", 'null': 'True', 'to': "orm['optionset.EmailType']"}),
            'email1_address': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'email1_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'job_offers1'", 'null': 'True', 'to': "orm['optionset.EmailType']"}),
            'email2_address': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'email2_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'job_offers2'", 'null': 'True', 'to': "orm['optionset.EmailType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'im0_address': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'im0_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'job_offers0'", 'null': 'True', 'to': "orm['optionset.IMType']"}),
            'im1_address': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'im1_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'job_offers1'", 'null': 'True', 'to': "orm['optionset.IMType']"}),
            'im2_address': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'im2_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'job_offers2'", 'null': 'True', 'to': "orm['optionset.IMType']"}),
            ...
            'phone0_type': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'job_offers0'", 'null': 'True', 'blank': 'True', 'to': "orm['optionset.PhoneType']"}),
            ...
            'phone1_type': ('django.db.models.fields.related.ForeignKey', [], {'default': '2L', 'related_name': "'job_offers1'", 'null': 'True', 'blank': 'True', 'to': "orm['optionset.PhoneType']"}),
            ...
            'phone2_type': ('django.db.models.fields.related.ForeignKey', [], {'default': '3L', 'related_name': "'job_offers2'", 'null': 'True', 'blank': 'True', 'to': "orm['optionset.PhoneType']"}),
            'position': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'postal_address': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'address_job_offers'", 'null': 'True', 'to': "orm['location.Address']"}),
            'publish_emails': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'url0_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'job_offers0'", 'null': 'True', 'to': "orm['optionset.URLType']"}),
            'url1_link': ('base_libs.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'url1_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'job_offers1'", 'null': 'True', 'to': "orm['optionset.URLType']"}),
            'url2_link': ('base_libs.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'url2_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'job_offers2'", 'null': 'True', 'to': "orm['optionset.URLType']"})
        },
        'marketplace.jobqualification': {
            'Meta': {'ordering': "['sort_order', 'title']", 'object_name': 'JobQualification'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '255', 'db_index': 'True'}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'title': ('base_libs.models.fields.MultilingualCharField', [], {'max_length': '255', 'null': 'True'}),
        ...
        'marketplace.jobsector': {
            'Meta': {'ordering': "['sort_order', 'title']", 'object_name': 'JobSector'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '255', 'db_index': 'True'}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'title': ('base_libs.models.fields.MultilingualCharField', [], {'max_length': '255', 'null': 'True'}),
        ...
        'marketplace.jobtype': {
            'Meta': {'ordering': "['sort_order', 'title']", 'object_name': 'JobType'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
