    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = layout.Layout(
            layout.Fieldset(
                ...
                layout.Field(
                    "categories",
                    template="kb_form/custom_widgets/checkboxselectmultipletree.html",
                ),
            ),
            bootstrap.FormActions(
                layout.HTML("""{% include "utils/step_buttons_reg.html" %}"""),
...
def save_data(form_steps, form_step_data):
    ...
    #     from kb.apps.external_services.export_to_creativeset import export_job_offer_to_creativeset
...
class JobOfferSearchForm(dynamicforms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = layout.Layout(
            layout.Fieldset(
                _("Filter"),
                layout.Field("job_sector", template="kb_form/custom_widgets/filter_field.html"),
                layout.Field("category", template="kb_form/custom_widgets/filter_field.html"),
                layout.Field("job_type", template="kb_form/custom_widgets/filter_field.html"),
                layout.Field("qualification", template="kb_form/custom_widgets/filter_field.html"),
