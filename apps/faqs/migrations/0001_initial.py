    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_title', base_libs.models.fields.MultilingualCharField(help_text='a short title to be displayed in page breadcrumbs and headline.', max_length=80, null=True, editable=False, verbose_name='short title')),
                ('description', base_libs.models.fields.MultilingualTextField(default=b'', editable=False, max_length=8192, blank=True, null=True, verbose_name='description')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', base_libs.models.fields.MultilingualCharField(verbose_name='question', max_length=255, null=True, editable=False)),
                ('answer', base_libs.models.fields.MultilingualTextField(default=b'', max_length=16384, null=True, editable=False, verbose_name='answer')),
