...
navigation_links = {
    ...
    'interviews': [
        {
            'url_de': '/de/kb-magazin/',
            'url_en': '/en/kb-magazine/',
            'text_de': 'Alle',
            'text_en': 'All',
            'should_be_shown': for_all,
            'highlight_pattern': r'^/(de|en)/kb-magazine?/($|category/)',
        },
        {
            'url_de': '/de/kb-magazin/favorites/',
            'url_en': '/en/kb-magazine/favorites/',
            'text_de': 'Favoriten',
            'text_en': 'Favorites',
            'should_be_shown': for_all,
            'highlight_pattern': r'^/(de|en)/kb-magazine?/favorites/$',
            'is_login_required': True,
        },
    ],
