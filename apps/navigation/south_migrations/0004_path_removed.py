...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'NavigationLink.path'
        db.delete_column('navigation_navigationlink', 'path')

    def backwards(self, orm):
        
        # Adding field 'NavigationLink.path'
        db.add_column('navigation_navigationlink', 'path', self.gf('django.db.models.fields.CharField')(max_length=8192, null=True), keep_default=False)
    ...
    models = {
        ...
        'navigation.navigationlink': {
            'Meta': {'ordering': "['lft']", 'object_name': 'NavigationLink'},
