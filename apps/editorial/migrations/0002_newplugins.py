...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TeaserBlock'
        db.create_table('cmsplugin_teaserblock', south_cleaned_fields((
        ...
        db.send_create_signal('editorial', ['TeaserBlock'])

        # Adding model 'Footnote'
        db.create_table('cmsplugin_footnote', south_cleaned_fields((
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('subtitle', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('description', self.gf('base_libs.models.fields.ExtendedTextField')(blank=True)),
        ...
        db.send_create_signal('editorial', ['Footnote'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'TeaserBlock'
        db.delete_table('cmsplugin_teaserblock')
