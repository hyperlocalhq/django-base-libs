...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FrontpageTeaser'
        db.create_table('cmsplugin_frontpageteaser', south_cleaned_fields((
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('title2', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('title3', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ...
        db.send_create_signal('editorial', ['FrontpageTeaser'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'FrontpageTeaser'
        db.delete_table('cmsplugin_frontpageteaser')
