...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ImageCropping.bgcolor'
        db.add_column('image_mods_imagecropping', 'bgcolor', self.gf('django.db.models.fields.CharField')(default='#ffffff', max_length=7), keep_default=False)

        # Changing field 'ImageCropping.y2'
        db.alter_column('image_mods_imagecropping', 'y2', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'ImageCropping.x2'
        db.alter_column('image_mods_imagecropping', 'x2', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'ImageCropping.y1'
        db.alter_column('image_mods_imagecropping', 'y1', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'ImageCropping.x1'
        db.alter_column('image_mods_imagecropping', 'x1', self.gf('django.db.models.fields.IntegerField')())
    
    
    def backwards(self, orm):
        
        # Deleting field 'ImageCropping.bgcolor'
        db.delete_column('image_mods_imagecropping', 'bgcolor')

        # Changing field 'ImageCropping.y2'
        db.alter_column('image_mods_imagecropping', 'y2', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'ImageCropping.x2'
        db.alter_column('image_mods_imagecropping', 'x2', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'ImageCropping.y1'
        db.alter_column('image_mods_imagecropping', 'y1', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'ImageCropping.x1'
        db.alter_column('image_mods_imagecropping', 'x1', self.gf('django.db.models.fields.PositiveIntegerField')())
