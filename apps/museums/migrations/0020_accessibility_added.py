...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Museum.accessibility'
        db.add_column('museums_museum', 'accessibility', self.gf('base_libs.models.fields.MultilingualTextField')(default='', null=True, blank=True), keep_default=False)

        # Adding field 'Museum.accessibility_de'
        db.add_column('museums_museum', 'accessibility_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Accessibility', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False), keep_default=False)

        # Adding field 'Museum.accessibility_de_markup_type'
        db.add_column('museums_museum', 'accessibility_de_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False), keep_default=False)

        # Adding field 'Museum.accessibility_en'
        db.add_column('museums_museum', 'accessibility_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Accessibility', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False), keep_default=False)

        # Adding field 'Museum.accessibility_en_markup_type'
        db.add_column('museums_museum', 'accessibility_en_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False), keep_default=False)

        # Adding field 'Museum.accessibility_markup_type'
        db.add_column('museums_museum', 'accessibility_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Museum.accessibility'
        db.delete_column('museums_museum', 'accessibility')

        # Deleting field 'Museum.accessibility_de'
        db.delete_column('museums_museum', 'accessibility_de')

        # Deleting field 'Museum.accessibility_de_markup_type'
        db.delete_column('museums_museum', 'accessibility_de_markup_type')

        # Deleting field 'Museum.accessibility_en'
        db.delete_column('museums_museum', 'accessibility_en')

        # Deleting field 'Museum.accessibility_en_markup_type'
        db.delete_column('museums_museum', 'accessibility_en_markup_type')

        # Deleting field 'Museum.accessibility_markup_type'
        db.delete_column('museums_museum', 'accessibility_markup_type')
