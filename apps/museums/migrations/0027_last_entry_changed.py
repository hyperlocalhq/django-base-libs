...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Season.thu_last_entry'
        db.delete_column('museums_season', 'thu_last_entry')

        # Deleting field 'Season.sun_last_entry'
        db.delete_column('museums_season', 'sun_last_entry')

        # Deleting field 'Season.fri_last_entry'
        db.delete_column('museums_season', 'fri_last_entry')

        # Deleting field 'Season.wed_last_entry'
        db.delete_column('museums_season', 'wed_last_entry')

        # Deleting field 'Season.mon_last_entry'
        db.delete_column('museums_season', 'mon_last_entry')

        # Deleting field 'Season.tue_last_entry'
        db.delete_column('museums_season', 'tue_last_entry')

        # Deleting field 'Season.sat_last_entry'
        db.delete_column('museums_season', 'sat_last_entry')

        # Adding field 'Season.last_entry'
        db.add_column('museums_season', 'last_entry', self.gf('base_libs.models.fields.MultilingualCharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Season.last_entry_de'
        db.add_column('museums_season', 'last_entry_de', self.gf('django.db.models.fields.CharField')(u'Last entry', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False), keep_default=False)

        # Adding field 'Season.last_entry_en'
        db.add_column('museums_season', 'last_entry_en', self.gf('django.db.models.fields.CharField')(u'Last entry', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'Season.thu_last_entry'
        db.add_column('museums_season', 'thu_last_entry', self.gf('django.db.models.fields.TimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Season.sun_last_entry'
        db.add_column('museums_season', 'sun_last_entry', self.gf('django.db.models.fields.TimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Season.fri_last_entry'
        db.add_column('museums_season', 'fri_last_entry', self.gf('django.db.models.fields.TimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Season.wed_last_entry'
        db.add_column('museums_season', 'wed_last_entry', self.gf('django.db.models.fields.TimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Season.mon_last_entry'
        db.add_column('museums_season', 'mon_last_entry', self.gf('django.db.models.fields.TimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Season.tue_last_entry'
        db.add_column('museums_season', 'tue_last_entry', self.gf('django.db.models.fields.TimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Season.sat_last_entry'
        db.add_column('museums_season', 'sat_last_entry', self.gf('django.db.models.fields.TimeField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Season.last_entry'
        db.delete_column('museums_season', 'last_entry')

        # Deleting field 'Season.last_entry_de'
        db.delete_column('museums_season', 'last_entry_de')

        # Deleting field 'Season.last_entry_en'
        db.delete_column('museums_season', 'last_entry_en')
