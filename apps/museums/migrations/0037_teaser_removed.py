...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('museums_museum', 'group_ticket_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Gruppenticket', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Museum.group_ticket_en'
        db.alter_column('museums_museum', 'group_ticket_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Gruppenticket', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Museum.other_tickets_de'
        db.alter_column('museums_museum', 'other_tickets_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Weitere Tickets', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Museum.reduced_price_info_en'
        db.alter_column('museums_museum', 'reduced_price_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Erm\xe4\xdfigter Eintritt Infotext', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Museum.accessibility_de'
        db.alter_column('museums_museum', 'accessibility_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Barrierefreiheit', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Museum.free_entrance_for_de'
        db.alter_column('museums_museum', 'free_entrance_for_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintritt frei f\xfcr', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Museum.accessibility_en'
        db.alter_column('museums_museum', 'accessibility_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Barrierefreiheit', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Museum.reduced_price_info_de'
        db.alter_column('museums_museum', 'reduced_price_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Erm\xe4\xdfigter Eintritt Infotext', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Museum.admission_price_info_de'
        db.alter_column('museums_museum', 'admission_price_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Preisinformation', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Museum.yearly_ticket_en'
        db.alter_column('museums_museum', 'yearly_ticket_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Jahreskarte', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Museum.service_other_info_de'
        db.alter_column('museums_museum', 'service_other_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Information zu weiteren Services', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Museum.arrangements_for_children_de'
        db.alter_column('museums_museum', 'arrangements_for_children_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintrittsregelungen f\xfcr Kinder und Jugendliche', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Museum.family_ticket_en'
        db.alter_column('museums_museum', 'family_ticket_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Familienticket', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Museum.press_text_en'
        db.alter_column('museums_museum', 'press_text_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Pressetext', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Museum.yearly_ticket_de'
        db.alter_column('museums_museum', 'yearly_ticket_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Jahreskarte', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Museum.admission_price_info_en'
        db.alter_column('museums_museum', 'admission_price_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Preisinformation', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Museum.family_ticket_de'
        db.alter_column('museums_museum', 'family_ticket_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Familienticket', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Museum.press_text_de'
        db.alter_column('museums_museum', 'press_text_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Pressetext', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Museum.free_entrance_for_en'
        db.alter_column('museums_museum', 'free_entrance_for_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintritt frei f\xfcr', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Museum.mediation_offer_en'
        db.alter_column('museums_museum', 'mediation_offer_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Weitere Vermittlungsangebote', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Museum.service_other_info_en'
        db.alter_column('museums_museum', 'service_other_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Information zu weiteren Services', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Museum.other_tickets_en'
        db.alter_column('museums_museum', 'other_tickets_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Weitere Tickets', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Museum.mediation_offer_de'
        db.alter_column('museums_museum', 'mediation_offer_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Weitere Vermittlungsangebote', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Museum.arrangements_for_children_en'
        db.alter_column('museums_museum', 'arrangements_for_children_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintrittsregelungen f\xfcr Kinder und Jugendliche', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))
    
    
    def backwards(self, orm):
        
        # Adding field 'Museum.teaser_en'
        db.add_column('museums_museum', 'teaser_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Teaser', rel=None, unique_for_year=None, blank=True, unique_for_date=None, db_index=False, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''), keep_default=False)
        ...
        db.add_column('museums_museum', 'teaser_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Teaser', rel=None, unique_for_year=None, blank=True, unique_for_date=None, db_index=False, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''), keep_default=False)
        ...
        # Changing field 'Museum.group_ticket_de'
        db.alter_column('museums_museum', 'group_ticket_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Group ticket', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Museum.group_ticket_en'
        db.alter_column('museums_museum', 'group_ticket_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Group ticket', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Museum.other_tickets_de'
        db.alter_column('museums_museum', 'other_tickets_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Other tickets', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Museum.reduced_price_info_en'
        db.alter_column('museums_museum', 'reduced_price_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Reduced admission price info', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Museum.accessibility_de'
        db.alter_column('museums_museum', 'accessibility_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Accessibility', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Museum.free_entrance_for_de'
        db.alter_column('museums_museum', 'free_entrance_for_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Free entrance for', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Museum.accessibility_en'
        db.alter_column('museums_museum', 'accessibility_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Accessibility', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Museum.reduced_price_info_de'
        db.alter_column('museums_museum', 'reduced_price_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Reduced admission price info', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Museum.admission_price_info_de'
        db.alter_column('museums_museum', 'admission_price_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Admission price info', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Museum.yearly_ticket_en'
        db.alter_column('museums_museum', 'yearly_ticket_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Yearly ticket', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Museum.service_other_info_de'
        db.alter_column('museums_museum', 'service_other_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Other services info', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Museum.arrangements_for_children_de'
        db.alter_column('museums_museum', 'arrangements_for_children_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Admission arrangements for children and youth', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Museum.family_ticket_en'
        db.alter_column('museums_museum', 'family_ticket_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Family ticket', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Museum.press_text_en'
        db.alter_column('museums_museum', 'press_text_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Press text', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Museum.yearly_ticket_de'
        db.alter_column('museums_museum', 'yearly_ticket_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Yearly ticket', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Museum.admission_price_info_en'
        db.alter_column('museums_museum', 'admission_price_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Admission price info', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Museum.family_ticket_de'
        db.alter_column('museums_museum', 'family_ticket_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Family ticket', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Museum.press_text_de'
        db.alter_column('museums_museum', 'press_text_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Press text', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Museum.free_entrance_for_en'
        db.alter_column('museums_museum', 'free_entrance_for_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Free entrance for', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Museum.mediation_offer_en'
        db.alter_column('museums_museum', 'mediation_offer_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Mediation offer', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Museum.service_other_info_en'
        db.alter_column('museums_museum', 'service_other_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Other services info', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Museum.other_tickets_en'
        db.alter_column('museums_museum', 'other_tickets_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Other tickets', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Museum.mediation_offer_de'
        db.alter_column('museums_museum', 'mediation_offer_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Mediation offer', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Museum.arrangements_for_children_en'
        db.alter_column('museums_museum', 'arrangements_for_children_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Admission arrangements for children and youth', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))
    ...
    models = {
        ...
        'museums.museum': {
            ...
            'arrangements_for_children_de': ('base_libs.models.fields.ExtendedTextField', ["u'Eintrittsregelungen f\\xfcr Kinder und Jugendliche'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            ...
            'arrangements_for_children_en': ('base_libs.models.fields.ExtendedTextField', ["u'Eintrittsregelungen f\\xfcr Kinder und Jugendliche'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            ...
            'family_ticket_de': ('base_libs.models.fields.ExtendedTextField', ["u'Familienticket'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'family_ticket_de_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            'family_ticket_en': ('base_libs.models.fields.ExtendedTextField', ["u'Familienticket'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            ...
            'free_entrance_for_de': ('base_libs.models.fields.ExtendedTextField', ["u'Eintritt frei f\\xfcr'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'free_entrance_for_de_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            'free_entrance_for_en': ('base_libs.models.fields.ExtendedTextField', ["u'Eintritt frei f\\xfcr'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            ...
            'other_tickets_de': ('base_libs.models.fields.ExtendedTextField', ["u'Weitere Tickets'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'other_tickets_de_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            'other_tickets_en': ('base_libs.models.fields.ExtendedTextField', ["u'Weitere Tickets'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            ...
            'service_other_info_de': ('base_libs.models.fields.ExtendedTextField', ["u'Information zu weiteren Services'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'service_other_info_de_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            'service_other_info_en': ('base_libs.models.fields.ExtendedTextField', ["u'Information zu weiteren Services'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            ...
            'yearly_ticket_de': ('base_libs.models.fields.ExtendedTextField', ["u'Jahreskarte'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'yearly_ticket_de_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            'yearly_ticket_en': ('base_libs.models.fields.ExtendedTextField', ["u'Jahreskarte'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
