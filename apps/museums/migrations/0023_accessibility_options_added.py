...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('museums_accessibilityoption', south_cleaned_fields((
        ...
        db.send_create_signal('museums', ['AccessibilityOption'])

        # Adding M2M table for field accessibility_options on 'Museum'
        db.create_table('museums_museum_accessibility_options', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('museum', models.ForeignKey(orm['museums.museum'], null=False)),
            ('accessibilityoption', models.ForeignKey(orm['museums.accessibilityoption'], null=False))
        ))
        db.create_unique('museums_museum_accessibility_options', ['museum_id', 'accessibilityoption_id'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'AccessibilityOption'
        db.delete_table('museums_accessibilityoption')

        # Removing M2M table for field accessibility_options on 'Museum'
        db.delete_table('museums_museum_accessibility_options')
