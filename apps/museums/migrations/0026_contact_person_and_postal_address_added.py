...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Museum.contact_name'
        db.add_column('museums_museum', 'contact_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Museum.contact_phone_country'
        db.add_column('museums_museum', 'contact_phone_country', self.gf('django.db.models.fields.CharField')(default='49', max_length=4, blank=True), keep_default=False)

        # Adding field 'Museum.contact_phone_area'
        db.add_column('museums_museum', 'contact_phone_area', self.gf('django.db.models.fields.CharField')(default='', max_length=6, blank=True), keep_default=False)

        # Adding field 'Museum.contact_phone_number'
        db.add_column('museums_museum', 'contact_phone_number', self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True), keep_default=False)

        # Adding field 'Museum.contact_email'
        db.add_column('museums_museum', 'contact_email', self.gf('django.db.models.fields.EmailField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Museum.post_street_address'
        db.add_column('museums_museum', 'post_street_address', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Museum.post_street_address2'
        db.add_column('museums_museum', 'post_street_address2', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Museum.post_postal_code'
        db.add_column('museums_museum', 'post_postal_code', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Museum.post_city'
        db.add_column('museums_museum', 'post_city', self.gf('django.db.models.fields.CharField')(default='Berlin', max_length=255, blank=True), keep_default=False)

        # Adding field 'Museum.post_country'
        db.add_column('museums_museum', 'post_country', self.gf('django.db.models.fields.CharField')(default='de', max_length=255, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Museum.contact_name'
        db.delete_column('museums_museum', 'contact_name')

        # Deleting field 'Museum.contact_phone_country'
        db.delete_column('museums_museum', 'contact_phone_country')

        # Deleting field 'Museum.contact_phone_area'
        db.delete_column('museums_museum', 'contact_phone_area')

        # Deleting field 'Museum.contact_phone_number'
        db.delete_column('museums_museum', 'contact_phone_number')

        # Deleting field 'Museum.contact_email'
        db.delete_column('museums_museum', 'contact_email')

        # Deleting field 'Museum.post_street_address'
        db.delete_column('museums_museum', 'post_street_address')

        # Deleting field 'Museum.post_street_address2'
        db.delete_column('museums_museum', 'post_street_address2')

        # Deleting field 'Museum.post_postal_code'
        db.delete_column('museums_museum', 'post_postal_code')

        # Deleting field 'Museum.post_city'
        db.delete_column('museums_museum', 'post_city')

        # Deleting field 'Museum.post_country'
        db.delete_column('museums_museum', 'post_country')
