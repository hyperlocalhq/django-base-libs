...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Museum.fax'
        db.add_column('museums_museum', 'fax', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Changing field 'Museum.subtitle_en'
        db.alter_column('museums_museum', 'subtitle_en', self.gf('django.db.models.fields.CharField')(u'Subtitle', null=False, primary_key=False, db_column=None, editable=True, max_length=255, db_tablespace='', unique=False))

        # Changing field 'Museum.subtitle_de'
        db.alter_column('museums_museum', 'subtitle_de', self.gf('django.db.models.fields.CharField')(u'Subtitle', null=False, primary_key=False, db_column=None, editable=True, max_length=255, db_tablespace='', unique=False))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Museum.fax'
        db.delete_column('museums_museum', 'fax')

        # Changing field 'Museum.subtitle_en'
        db.alter_column('museums_museum', 'subtitle_en', self.gf('django.db.models.fields.CharField')(u'Title', unique=False, max_length=255, primary_key=False, db_column=None, null=False, editable=True, db_tablespace=''))

        # Changing field 'Museum.subtitle_de'
        db.alter_column('museums_museum', 'subtitle_de', self.gf('django.db.models.fields.CharField')(u'Title', unique=False, max_length=255, primary_key=False, db_column=None, null=False, editable=True, db_tablespace=''))
