...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Museum.latitude'
        db.add_column('museums_museum', 'latitude', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Museum.longitude'
        db.add_column('museums_museum', 'longitude', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Museum.latitude'
        db.delete_column('museums_museum', 'latitude')

        # Deleting field 'Museum.longitude'
        db.delete_column('museums_museum', 'longitude')
