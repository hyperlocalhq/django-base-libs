...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Museum.mobidat'
        db.add_column('museums_museum', 'mobidat', self.gf('base_libs.models.fields.MultilingualTextField')(default='', null=True, blank=True), keep_default=False)

        # Adding field 'Museum.mobidat_de'
        db.add_column('museums_museum', 'mobidat_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Mobidat', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False), keep_default=False)

        # Adding field 'Museum.mobidat_de_markup_type'
        db.add_column('museums_museum', 'mobidat_de_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False), keep_default=False)

        # Adding field 'Museum.mobidat_en'
        db.add_column('museums_museum', 'mobidat_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Mobidat', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False), keep_default=False)

        # Adding field 'Museum.mobidat_en_markup_type'
        db.add_column('museums_museum', 'mobidat_en_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False), keep_default=False)

        # Adding field 'Museum.mobidat_markup_type'
        db.add_column('museums_museum', 'mobidat_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Museum.mobidat'
        db.delete_column('museums_museum', 'mobidat')

        # Deleting field 'Museum.mobidat_de'
        db.delete_column('museums_museum', 'mobidat_de')

        # Deleting field 'Museum.mobidat_de_markup_type'
        db.delete_column('museums_museum', 'mobidat_de_markup_type')

        # Deleting field 'Museum.mobidat_en'
        db.delete_column('museums_museum', 'mobidat_en')

        # Deleting field 'Museum.mobidat_en_markup_type'
        db.delete_column('museums_museum', 'mobidat_en_markup_type')

        # Deleting field 'Museum.mobidat_markup_type'
        db.delete_column('museums_museum', 'mobidat_markup_type')
