...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Museum.parent'
        db.add_column('museums_museum', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['museums.Museum'], null=True, blank=True), keep_default=False)

    
    def backwards(self, orm):
        
        # Deleting field 'Museum.parent'
        db.delete_column('museums_museum', 'parent_id')
