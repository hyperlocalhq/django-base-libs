...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Museum.district'
        db.add_column('museums_museum', 'district', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Museum.district'
        db.delete_column('museums_museum', 'district')
