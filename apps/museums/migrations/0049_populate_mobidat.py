...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for m in orm.Museum.objects.all():
            m.mobidat_de = m.accessibility_de
            m.mobidat_de_markup_type = m.accessibility_de_markup_type
            m.accessibility_de = ""
            m.mobidat_en = m.accessibility_en
            m.mobidat_en_markup_type = m.accessibility_en_markup_type
            m.accessibility_en = ""
            m.save()
