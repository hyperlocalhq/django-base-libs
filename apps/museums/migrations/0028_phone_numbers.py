...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Museum.phone_country'
        db.add_column('museums_museum', 'phone_country', self.gf('django.db.models.fields.CharField')(default='49', max_length=4, blank=True), keep_default=False)

        # Adding field 'Museum.phone_area'
        db.add_column('museums_museum', 'phone_area', self.gf('django.db.models.fields.CharField')(default='', max_length=6, blank=True), keep_default=False)

        # Adding field 'Museum.phone_number'
        db.add_column('museums_museum', 'phone_number', self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True), keep_default=False)

        # Adding field 'Museum.fax_country'
        db.add_column('museums_museum', 'fax_country', self.gf('django.db.models.fields.CharField')(default='49', max_length=4, blank=True), keep_default=False)

        # Adding field 'Museum.fax_area'
        db.add_column('museums_museum', 'fax_area', self.gf('django.db.models.fields.CharField')(default='', max_length=6, blank=True), keep_default=False)

        # Adding field 'Museum.fax_number'
        db.add_column('museums_museum', 'fax_number', self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True), keep_default=False)

        # Adding field 'Museum.group_bookings_phone_country'
        db.add_column('museums_museum', 'group_bookings_phone_country', self.gf('django.db.models.fields.CharField')(default='49', max_length=4, blank=True), keep_default=False)

        # Adding field 'Museum.group_bookings_phone_area'
        db.add_column('museums_museum', 'group_bookings_phone_area', self.gf('django.db.models.fields.CharField')(default='', max_length=6, blank=True), keep_default=False)

        # Adding field 'Museum.group_bookings_phone_number'
        db.add_column('museums_museum', 'group_bookings_phone_number', self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True), keep_default=False)

        # Adding field 'Museum.service_phone_country'
        db.add_column('museums_museum', 'service_phone_country', self.gf('django.db.models.fields.CharField')(default='49', max_length=4, blank=True), keep_default=False)

        # Adding field 'Museum.service_phone_area'
        db.add_column('museums_museum', 'service_phone_area', self.gf('django.db.models.fields.CharField')(default='', max_length=6, blank=True), keep_default=False)

        # Adding field 'Museum.service_phone_number'
        db.add_column('museums_museum', 'service_phone_number', self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Museum.phone_country'
        db.delete_column('museums_museum', 'phone_country')

        # Deleting field 'Museum.phone_area'
        db.delete_column('museums_museum', 'phone_area')

        # Deleting field 'Museum.phone_number'
        db.delete_column('museums_museum', 'phone_number')

        # Deleting field 'Museum.fax_country'
        db.delete_column('museums_museum', 'fax_country')

        # Deleting field 'Museum.fax_area'
        db.delete_column('museums_museum', 'fax_area')

        # Deleting field 'Museum.fax_number'
        db.delete_column('museums_museum', 'fax_number')

        # Deleting field 'Museum.group_bookings_phone_country'
        db.delete_column('museums_museum', 'group_bookings_phone_country')

        # Deleting field 'Museum.group_bookings_phone_area'
        db.delete_column('museums_museum', 'group_bookings_phone_area')

        # Deleting field 'Museum.group_bookings_phone_number'
        db.delete_column('museums_museum', 'group_bookings_phone_number')

        # Deleting field 'Museum.service_phone_country'
        db.delete_column('museums_museum', 'service_phone_country')

        # Deleting field 'Museum.service_phone_area'
        db.delete_column('museums_museum', 'service_phone_area')

        # Deleting field 'Museum.service_phone_number'
        db.delete_column('museums_museum', 'service_phone_number')
