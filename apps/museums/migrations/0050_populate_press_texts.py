...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for m in orm.Museum.objects.all():
            if not m.press_text_de:
                m.press_text_de = m.description_de
                m.press_text_de_markup_type = m.description_de_markup_type
            if not m.press_text_en:
                m.press_text_en = m.description_en
                m.press_text_en_markup_type = m.description_en_markup_type
            m.save()
