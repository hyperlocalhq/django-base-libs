...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Museum.group_bookings_phone'
        db.add_column('museums_museum', 'group_bookings_phone', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Museum.service_phone'
        db.add_column('museums_museum', 'service_phone', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Museum.group_bookings_phone'
        db.delete_column('museums_museum', 'group_bookings_phone')

        # Deleting field 'Museum.service_phone'
        db.delete_column('museums_museum', 'service_phone')
