...
urlpatterns = patterns('',
                       ...
                       url(r'^simulate/idea_list.xml$',
                           'ccb.apps.external_services.jovoto.simulate_service.simulate_idea_list_service'),
                       url(r'^simulate/(?P<ext_id>\d+).xml$',
                           'ccb.apps.external_services.jovoto.simulate_service.simulate_idea_details_service'),

                       # urls for jovoto idea contest
                       url(r'^$', 'ccb.apps.external_services.jovoto.views.get_all_ideas',
                           dict(jovoto_ideas_info, template_name='external_services/jovoto/ideas_list.html'), ),
                       url(r'^page(?P<page>[0-9]+)/$', 'ccb.apps.external_services.jovoto.views.get_all_ideas',
                           dict(jovoto_ideas_info, template_name='external_services/jovoto/ideas_list.html'), ),

                       url(r'^idea/(?P<ext_id>\d+)/$', 'ccb.apps.external_services.jovoto.views.get_idea',
                           dict(jovoto_ideas_info, template_name='external_services/jovoto/idea_details.html'), ),
