...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ContextItem.status'
        db.delete_column('system_contextitem', 'status_id')

    
    def backwards(self, orm):
        
        # Adding field 'ContextItem.status'
        db.add_column('system_contextitem', 'status', self.gf('django.db.models.fields.related.ForeignKey')(related_name='status_contextitems', null=True, to=orm['structure.Term'], blank=True), keep_default=False)
