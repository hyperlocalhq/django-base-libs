...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContextItem.status_tmp'
        db.add_column('system_contextitem', 'status_tmp', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)

        # Changing field 'ContextItem.description_en'
        db.alter_column('system_contextitem', 'description_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Beschreibung', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'ContextItem.description_de'
        db.alter_column('system_contextitem', 'description_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Beschreibung', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))
    
    
    def backwards(self, orm):
        
        # Deleting field 'ContextItem.status_tmp'
        db.delete_column('system_contextitem', 'status_tmp')

        # Changing field 'ContextItem.description_en'
        db.alter_column('system_contextitem', 'description_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Description', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, max_length=None, db_tablespace=''))

        # Changing field 'ContextItem.description_de'
        db.alter_column('system_contextitem', 'description_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Description', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, max_length=None, db_tablespace=''))
    ...
    models = {
        ...
        'site_specific.contextitem': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'locality_contextitems'", 'null': 'True', 'to': "orm['structure.Term']"}),
            ...
            'status': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'status_contextitems'", 'null': 'True', 'to': "orm['structure.Term']"}),
