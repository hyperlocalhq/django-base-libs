...
class Migration:
    ...
    def forwards(self, orm):
        ...
        try:
            cursor.execute('ALTER TABLE `system_contextitem` DROP INDEX '
                '`fulltext_system_contextitem` , '
                'ADD FULLTEXT `fulltext_system_contextitem` ( '
                '`title_en` , '
                '`title_de` , '
                '`description_en` , '
                '`description_de` , '
        ...
        cursor.execute('UPDATE system_contextitem SET '
            'title_en=title,'
