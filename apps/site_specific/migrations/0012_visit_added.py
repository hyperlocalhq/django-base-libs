...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Visit'
        db.create_table('site_specific_visit', south_cleaned_fields((
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('modified_date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('last_activity', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ...
        db.send_create_signal('site_specific', ['Visit'])

        # Changing field 'ContextItem.description_en'
        db.alter_column('system_contextitem', 'description_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Description', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'ContextItem.description_de'
        db.alter_column('system_contextitem', 'description_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Description', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))
    
    
    def backwards(self, orm):
        
        # Deleting model 'Visit'
        db.delete_table('site_specific_visit')

        # Changing field 'ContextItem.description_en'
        db.alter_column('system_contextitem', 'description_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Beschreibung', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, max_length=None, db_tablespace=''))

        # Changing field 'ContextItem.description_de'
        db.alter_column('system_contextitem', 'description_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Beschreibung', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, max_length=None, db_tablespace=''))
    ...
    models = {
        ...
        'site_specific.claimrequest': {
            ...
            'modifier': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'claimrequest_modifier'", 'null': 'True', 'to': "orm['auth.User']"}),
        ...
        'site_specific.contextitem': {
            ...
            'creative_sectors': ('mptt.fields.TreeManyToManyField', [], {'symmetrical': 'False', 'related_name': "'creative_industry_contextitems'", 'blank': 'True', 'to': "orm['structure.Term']"}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location_type': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'locality_contextitems'", 'null': 'True', 'to': "orm['structure.Term']"}),
        ...
        'site_specific.visit': {
            'Meta': {'ordering': "('modified_date',)", 'object_name': 'Visit'},
            'creation_date': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
