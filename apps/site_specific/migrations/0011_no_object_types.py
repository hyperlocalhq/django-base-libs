...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field object_types on 'ContextItem'
        db.delete_table('system_contextitem_object_types')
    
    
    def backwards(self, orm):
        
        # Adding M2M table for field object_types on 'ContextItem'
        db.create_table('system_contextitem_object_types', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('contextitem', models.ForeignKey(orm['site_specific.contextitem'], null=False)),
            ('term', models.ForeignKey(orm['structure.term'], null=False))
        ))
        db.create_unique('system_contextitem_object_types', ['contextitem_id', 'term_id'])
