...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('system_contextitem', 'status', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        # Deleting field 'ContextItem.status'
        db.delete_column('system_contextitem', 'status')
