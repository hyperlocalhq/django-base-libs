...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Exhibition.organizing_museum'
        db.add_column('exhibitions_exhibition', 'organizing_museum', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='organized_exhibitions', null=True, to=orm['museums.Museum']), keep_default=False)

        # Adding field 'Exhibition.organizer_title'
        db.add_column('exhibitions_exhibition', 'organizer_title', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Exhibition.organizer_url_link'
        db.add_column('exhibitions_exhibition', 'organizer_url_link', self.gf('base_libs.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Exhibition.organizing_museum'
        db.delete_column('exhibitions_exhibition', 'organizing_museum_id')

        # Deleting field 'Exhibition.organizer_title'
        db.delete_column('exhibitions_exhibition', 'organizer_title')

        # Deleting field 'Exhibition.organizer_url_link'
        db.delete_column('exhibitions_exhibition', 'organizer_url_link')
