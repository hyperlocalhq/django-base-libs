...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('exhibitions_exhibition', south_cleaned_fields((
            ...
            ('website', self.gf('base_libs.models.fields.MultilingualCharField')(max_length=255, null=True, blank=True)),
            ('start', self.gf('django.db.models.fields.DateField')()),
            ('end', self.gf('django.db.models.fields.DateField')()),
            ('image', self.gf('filebrowser.fields.FileBrowseField')(directory='exhibitions/', max_length=255, extensions=['.jpg', '.jpeg', '.gif', '.png', '.tif', '.tiff'], blank=True)),
            ('image_caption', self.gf('base_libs.models.fields.MultilingualTextField')(default='', max_length=255, null=True, blank=True)),
            ('newly_opened', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('featured', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('closing_soon', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('website_de', self.gf('django.db.models.fields.CharField')(u'Website', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False)),
            ('website_en', self.gf('django.db.models.fields.CharField')(u'Website', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False)),
