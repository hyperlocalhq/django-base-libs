...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Exhibition.description_locked'
        db.add_column('exhibitions_exhibition', 'description_locked', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Exhibition.description_locked'
        db.delete_column('exhibitions_exhibition', 'description_locked')
