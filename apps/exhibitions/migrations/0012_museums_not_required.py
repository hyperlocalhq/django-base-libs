...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Exhibition.museum'
        db.alter_column('exhibitions_exhibition', 'museum_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['museums.Museum'], null=True))
    
    
    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Exhibition.museum'
        raise RuntimeError("Cannot reverse this migration. 'Exhibition.museum' and its values cannot be restored.")
