...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Exhibition.press_text'
        db.add_column('exhibitions_exhibition', 'press_text', self.gf('base_libs.models.fields.MultilingualTextField')(default='', null=True, blank=True), keep_default=False)

        # Adding field 'Exhibition.press_text_de'
        db.add_column('exhibitions_exhibition', 'press_text_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Press text', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False), keep_default=False)

        # Adding field 'Exhibition.press_text_de_markup_type'
        db.add_column('exhibitions_exhibition', 'press_text_de_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False), keep_default=False)

        # Adding field 'Exhibition.press_text_en'
        db.add_column('exhibitions_exhibition', 'press_text_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Press text', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False), keep_default=False)

        # Adding field 'Exhibition.press_text_en_markup_type'
        db.add_column('exhibitions_exhibition', 'press_text_en_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False), keep_default=False)

        # Adding field 'Exhibition.press_text_markup_type'
        db.add_column('exhibitions_exhibition', 'press_text_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Exhibition.press_text'
        db.delete_column('exhibitions_exhibition', 'press_text')

        # Deleting field 'Exhibition.press_text_de'
        db.delete_column('exhibitions_exhibition', 'press_text_de')

        # Deleting field 'Exhibition.press_text_de_markup_type'
        db.delete_column('exhibitions_exhibition', 'press_text_de_markup_type')

        # Deleting field 'Exhibition.press_text_en'
        db.delete_column('exhibitions_exhibition', 'press_text_en')

        # Deleting field 'Exhibition.press_text_en_markup_type'
        db.delete_column('exhibitions_exhibition', 'press_text_en_markup_type')

        # Deleting field 'Exhibition.press_text_markup_type'
        db.delete_column('exhibitions_exhibition', 'press_text_markup_type')
