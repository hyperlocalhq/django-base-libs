...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ExhibitionCategory.sort_order'
        db.delete_column('exhibitions_exhibitioncategory', 'sort_order')

        # Adding field 'ExhibitionCategory.parent'
        db.add_column('exhibitions_exhibitioncategory', 'parent', self.gf('mptt.fields.TreeForeignKey')(to=orm['exhibitions.ExhibitionCategory'], null=True, blank=True), keep_default=False)

        # Adding field 'ExhibitionCategory.lft'
        db.add_column('exhibitions_exhibitioncategory', 'lft', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'ExhibitionCategory.rght'
        db.add_column('exhibitions_exhibitioncategory', 'rght', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'ExhibitionCategory.tree_id'
        db.add_column('exhibitions_exhibitioncategory', 'tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'ExhibitionCategory.level'
        db.add_column('exhibitions_exhibitioncategory', 'level', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'ExhibitionCategory.sort_order'
        db.add_column('exhibitions_exhibitioncategory', 'sort_order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'ExhibitionCategory.parent'
        db.delete_column('exhibitions_exhibitioncategory', 'parent_id')

        # Deleting field 'ExhibitionCategory.lft'
        db.delete_column('exhibitions_exhibitioncategory', 'lft')

        # Deleting field 'ExhibitionCategory.rght'
        db.delete_column('exhibitions_exhibitioncategory', 'rght')

        # Deleting field 'ExhibitionCategory.tree_id'
        db.delete_column('exhibitions_exhibitioncategory', 'tree_id')

        # Deleting field 'ExhibitionCategory.level'
        db.delete_column('exhibitions_exhibitioncategory', 'level')
