...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Exhibition.museum_opening_hours'
        db.add_column('exhibitions_exhibition', 'museum_opening_hours', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Exhibition.museum_opening_hours'
        db.delete_column('exhibitions_exhibition', 'museum_opening_hours')
