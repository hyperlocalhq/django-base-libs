...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ExhibitionCategory'
        db.create_table('exhibitions_exhibitioncategory', south_cleaned_fields((
        ...
        db.send_create_signal('exhibitions', ['ExhibitionCategory'])

        # Adding M2M table for field categories on 'Exhibition'
        db.create_table('exhibitions_exhibition_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('exhibition', models.ForeignKey(orm['exhibitions.exhibition'], null=False)),
            ('exhibitioncategory', models.ForeignKey(orm['exhibitions.exhibitioncategory'], null=False))
        ))
        db.create_unique('exhibitions_exhibition_categories', ['exhibition_id', 'exhibitioncategory_id'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'ExhibitionCategory'
        db.delete_table('exhibitions_exhibitioncategory')

        # Removing M2M table for field categories on 'Exhibition'
        db.delete_table('exhibitions_exhibition_categories')
