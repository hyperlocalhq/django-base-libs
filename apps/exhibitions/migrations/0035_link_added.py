...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Exhibition.link'
        db.add_column('exhibitions_exhibition', 'link', self.gf('base_libs.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Exhibition.link'
        db.delete_column('exhibitions_exhibition', 'link')
