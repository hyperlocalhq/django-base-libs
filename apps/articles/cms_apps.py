...
class ArticleAppHook(CMSApp):
    ...
    urls = ["kb.apps.articles.urls.news"]
...
class InterviewsAppHook(CMSApp):
    ...
    urls = ["kb.apps.articles.urls.interviews"]
...
class ArchitectureNewsApphook(CMSApp):
    ...
    urls = ["kb.apps.articles.urls.architecture"]
...
class VisualArtsNewsApphook(CMSApp):
    ...
    urls = ["kb.apps.articles.urls.visual_arts"]
...
class DesignNewsApphook(CMSApp):
    name = _("Design - News")
    urls = ["kb.apps.articles.urls.design"]
...
class EventIndustryNewsApphook(CMSApp):
    ...
    urls = ["kb.apps.articles.urls.event_industry"]
...
class FilmBroadcastNewsApphook(CMSApp):
    ...
    urls = ["kb.apps.articles.urls.film_broadcast"]
...
class PhotographyNewsApphook(CMSApp):
    ...
    urls = ["kb.apps.articles.urls.photography"]
...
class GamesInteractiveNewsApphook(CMSApp):
    ...
    urls = ["kb.apps.articles.urls.games_interactive"]
...
class LiteraturePublishingNewsApphook(CMSApp):
    ...
    urls = ["kb.apps.articles.urls.literature_publishing"]
...
class FashionTextileNewsApphook(CMSApp):
    ...
    urls = ["kb.apps.articles.urls.fashion_textile"]
...
class MusicNewsApphook(CMSApp):
    name = _("Music - News")
    urls = ["kb.apps.articles.urls.music"]
...
class TheatreDanceNewsApphook(CMSApp):
    ...
    urls = ["kb.apps.articles.urls.theatre_dance"]
...
class AdvertisingPRNewsApphook(CMSApp):
    ...
    urls = ["kb.apps.articles.urls.advertising_pr"]
