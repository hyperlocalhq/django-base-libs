...
class Article(ArticleBase, MultiSiteMixin):
    ...
    external_url = URLField(_("External URL"), blank=True, help_text=_("Original location of the article if it was imported."), max_length=512)
    is_excerpt = models.BooleanField(_("Excerpt"), default=False, help_text=_("If this article is an excerpt, the link in the list of articles will lead to the external URL."))
