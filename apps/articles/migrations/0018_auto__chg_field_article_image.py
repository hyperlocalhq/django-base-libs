...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'articles_article', 'image', self.gf('filebrowser.fields.FileBrowseField')(directory='articles/', max_length=255, extensions=['.jpg', '.jpeg', '.gif', '.png', '.tif', '.tiff']))
    ...
    models = {
        u'articles.article': {
            ...
            'content_provider': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['articles.ArticleContentProvider']", 'null': 'True', 'blank': 'True'}),
            'creation_date': ('django.db.models.fields.DateTimeField', [], {}),
            'creative_sectors': ('mptt.fields.TreeManyToManyField', [], {'blank': 'True', 'related_name': "'creative_sector_articles'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['structure.Term']"}),
        ...
        u'articles.articlecontentprovider': {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 2, 16, 12, 47, 465553)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 2, 16, 12, 47, 464936)'}),
