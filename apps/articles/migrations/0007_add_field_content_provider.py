...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Article.content_provider'
        db.add_column('articles_article', 'content_provider', orm['articles.article:content_provider'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Article.content_provider'
        db.delete_column('articles_article', 'content_provider_id')
