...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ArticleContentProvider'
        db.create_table('articles_articlecontentprovider', south_cleaned_fields((
            ('id', orm['articles.articlecontentprovider:id']),
            ('title', orm['articles.articlecontentprovider:title']),
        )))
        db.send_create_signal('articles', ['ArticleContentProvider'])
        
    
    
    def backwards(self, orm):
        
        # Deleting model 'ArticleContentProvider'
        db.delete_table('articles_articlecontentprovider')
