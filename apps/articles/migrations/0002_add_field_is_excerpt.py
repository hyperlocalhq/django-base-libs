...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Article.is_excerpt'
        db.add_column('articles_article', 'is_excerpt', orm['articles.article:is_excerpt'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Article.is_excerpt'
        db.delete_column('articles_article', 'is_excerpt')
