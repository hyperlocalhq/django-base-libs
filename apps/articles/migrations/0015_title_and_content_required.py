...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('articles_article', 'content', self.gf('base_libs.models.fields.ExtendedTextField')())

        # Changing field 'Article.title'
        db.alter_column('articles_article', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        'articles.article': {
            ...
            'creative_sectors': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'creative_sector_articles'", 'blank': 'True', 'null': 'True', 'to': "orm['structure.Term']"}),
