...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for inst in orm.Institution.objects.all():
            if not inst.institution_types_tmp:
                continue
            inst_type_pks = inst.institution_types_tmp.split(",")
            for inst_type in orm.InstitutionType.objects.filter(
                pk__in=inst_type_pks,
                ):
                inst.institution_types.add(inst_type)
