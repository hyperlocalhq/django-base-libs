...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('institutions_institution', 'exceptions_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Exceptions for working hours', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Institution.description_de'
        db.alter_column('institutions_institution', 'description_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Description', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Institution.description_en'
        db.alter_column('institutions_institution', 'description_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Description', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Institution.exceptions_en'
        db.alter_column('institutions_institution', 'exceptions_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Exceptions for working hours', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'InstitutionalContact.phone0_area'
        db.alter_column('institutions_institutionalcontact', 'phone0_area', self.gf('django.db.models.fields.CharField')(max_length=6))

        # Changing field 'InstitutionalContact.phone0_number'
        db.alter_column('institutions_institutionalcontact', 'phone0_number', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'InstitutionalContact.phone1_number'
        db.alter_column('institutions_institutionalcontact', 'phone1_number', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'InstitutionalContact.phone1_area'
        db.alter_column('institutions_institutionalcontact', 'phone1_area', self.gf('django.db.models.fields.CharField')(max_length=6))

        # Changing field 'InstitutionalContact.phone2_area'
        db.alter_column('institutions_institutionalcontact', 'phone2_area', self.gf('django.db.models.fields.CharField')(max_length=6))

        # Changing field 'InstitutionalContact.phone2_number'
        db.alter_column('institutions_institutionalcontact', 'phone2_number', self.gf('django.db.models.fields.CharField')(max_length=25))

    
    def backwards(self, orm):
        
        # Changing field 'Institution.exceptions_de'
        db.alter_column('institutions_institution', 'exceptions_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Sonstige \xd6ffnungszeiten', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Institution.description_de'
        db.alter_column('institutions_institution', 'description_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Beschreibung', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Institution.description_en'
        db.alter_column('institutions_institution', 'description_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Beschreibung', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, max_length=None, db_tablespace=''))

        # Changing field 'Institution.exceptions_en'
        db.alter_column('institutions_institution', 'exceptions_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Sonstige \xd6ffnungszeiten', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, max_length=None, db_tablespace=''))
