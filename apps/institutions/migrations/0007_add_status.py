...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('institutions_institution', 'status', self.gf('django.db.models.fields.CharField')(default='draft', max_length=20, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Institution.status'
        db.delete_column('institutions_institution', 'status')
