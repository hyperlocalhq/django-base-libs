...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Institution.institution_types_tmp'
        db.add_column('institutions_institution', 'institution_types_tmp', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Institution.institution_types_tmp'
        db.delete_column('institutions_institution', 'institution_types_tmp')
    ...
    models = {
        ...
        'institutions.institution': {
            ...
            'institution_types_tmp': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
