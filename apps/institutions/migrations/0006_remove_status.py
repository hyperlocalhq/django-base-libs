...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Institution.status'
        db.delete_column('institutions_institution', 'status_id')
    
    
    def backwards(self, orm):
        
        # Adding field 'Institution.status'
        db.add_column('institutions_institution', 'status', self.gf('django.db.models.fields.related.ForeignKey')(default=87L, related_name='status_institution_set', null=True, to=orm['structure.Term'], blank=True), keep_default=False)
