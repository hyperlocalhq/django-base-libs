...
class CategoriesForm(dynamicforms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = layout.Layout(
            ...
            layout.Fieldset(
                _("Institution Types"),
                layout.Field("institution_types", template="kb_form/custom_widgets/checkboxselectmultipletree.html"),
                css_class="no-label",
            ),
            bootstrap.FormActions(
                layout.HTML("""{% include "utils/step_buttons_reg.html" %}"""),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = layout.Layout(
            layout.Fieldset(
                ...
                layout.Field("institution_type", template = "kb_form/custom_widgets/filter_field.html"),
