...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.person_repr'
        db.add_column('people_person', 'person_repr', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Person.person_repr'
        db.delete_column('people_person', 'person_repr')
