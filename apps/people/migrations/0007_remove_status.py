...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('people_person', 'status_id')
    
    
    def backwards(self, orm):
        
        # Adding field 'Person.status'
        db.add_column('people_person', 'status', self.gf('django.db.models.fields.related.ForeignKey')(default=87L, related_name='status_person_set', null=True, to=orm['structure.Term'], blank=True), keep_default=False)
