...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'IndividualType.path_search'
        db.delete_column('people_individualtype', 'path_search')

        # Deleting field 'IndividualType.path'
        db.delete_column('people_individualtype', 'path')

        # Adding field 'IndividualType.lft'
        db.add_column('people_individualtype', 'lft', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'IndividualType.rght'
        db.add_column('people_individualtype', 'rght', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'IndividualType.tree_id'
        db.add_column('people_individualtype', 'tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'IndividualType.level'
        db.add_column('people_individualtype', 'level', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Changing field 'IndividualType.parent'
        db.alter_column('people_individualtype', 'parent_id', self.gf('mptt.fields.TreeForeignKey')(null=True, to=orm['people.IndividualType']))
    
    
    def backwards(self, orm):
        
        # Adding field 'IndividualType.path_search'
        db.add_column('people_individualtype', 'path_search', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'IndividualType.path'
        db.add_column('people_individualtype', 'path', self.gf('django.db.models.fields.CharField')(max_length=8192, null=True), keep_default=False)

        # Deleting field 'IndividualType.lft'
        db.delete_column('people_individualtype', 'lft')

        # Deleting field 'IndividualType.rght'
        db.delete_column('people_individualtype', 'rght')

        # Deleting field 'IndividualType.tree_id'
        db.delete_column('people_individualtype', 'tree_id')

        # Deleting field 'IndividualType.level'
        db.delete_column('people_individualtype', 'level')

        # Changing field 'IndividualType.parent'
        db.alter_column('people_individualtype', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['people.IndividualType']))
