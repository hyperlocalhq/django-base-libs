...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.description_en_markup_type'
        db.add_column('people_person', 'description_en_markup_type', models.CharField('Markup type', default='pt', max_length=10, blank=False))
        
        # Adding field 'Person.description_markup_type'
        db.add_column('people_person', 'description_markup_type', models.CharField('Markup type', default='pt', max_length=10, blank=False))
        
        # Adding field 'Person.description_de_markup_type'
        db.add_column('people_person', 'description_de_markup_type', models.CharField('Markup type', default='pt', max_length=10, blank=False))
        
        # Adding field 'Person.description_en'
        db.add_column('people_person', 'description_en', ExtendedTextField(u'Description', unique_for_month=None, unique=False, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, null=False, unique_for_date=None, db_tablespace='', db_index=False))
        
        # Changing field 'Person.description_de'
        db.alter_column('people_person', 'description_de', ExtendedTextField(u'Description', unique_for_month=None, unique=False, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, null=False, unique_for_date=None, db_tablespace='', db_index=False))
        
        # Changing field 'Person.description'
        db.alter_column('people_person', 'description', MultilingualTextField(_("Description"), blank=True))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Person.description_en_markup_type'
        db.delete_column('people_person', 'description_en_markup_type')
        
        # Deleting field 'Person.description_markup_type'
        db.delete_column('people_person', 'description_markup_type')
        
        # Deleting field 'Person.description_de_markup_type'
        db.delete_column('people_person', 'description_de_markup_type')
        
        # Deleting field 'Person.description_en'
        db.delete_column('people_person', 'description_en')
        
        # Changing field 'Person.description_de'
        db.alter_column('people_person', 'description_de', models.TextField(_("Description (German)"), blank=True))
        
        # Changing field 'Person.description'
        db.alter_column('people_person', 'description', models.TextField(_("Description (English)"), blank=True))
