...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        call_command("loaddata", "default_individual_types.json")
    ...
    models = {
        ...
        'people.individualcontact': {
            ...
            'location_type': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['optionset.IndividualLocationType']"}),
            ...
            'phone0_type': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'related_name': "'individual_contacts0'", 'null': 'True', 'blank': 'True', 'to': "orm['optionset.PhoneType']"}),
            ...
            'phone1_type': ('django.db.models.fields.related.ForeignKey', [], {'default': '2', 'related_name': "'individual_contacts1'", 'null': 'True', 'blank': 'True', 'to': "orm['optionset.PhoneType']"}),
            ...
            'phone2_type': ('django.db.models.fields.related.ForeignKey', [], {'default': '3', 'related_name': "'individual_contacts2'", 'null': 'True', 'blank': 'True', 'to': "orm['optionset.PhoneType']"}),
