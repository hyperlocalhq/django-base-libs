...
python manage.py migrate cms zero --fake --settings=ruhrbuehnen.settings.local --traceback
python manage.py migrate cms_extensions zero --fake --settings=ruhrbuehnen.settings.local --traceback
python manage.py migrate menus zero --fake --settings=ruhrbuehnen.settings.local --traceback
