...
date
python manage.py import_from_maxim_gorki_theater --settings=ruhrbuehnen.settings.local --traceback


echo "------------"
echo "Importing from Schaubuehne"
date
python manage.py import_from_schaubuehne --settings=ruhrbuehnen.settings.local --traceback
...
#date
#python manage.py import_from_sophiensaele --settings=ruhrbuehnen.settings.local --traceback
#
#echo "------------"
...
date
python manage.py import_from_culturebase_radialsystem --settings=ruhrbuehnen.settings.local --traceback


#echo "------------"
#echo "Importing from Staatsoper im Schiller Theater"
#date
#python manage.py import_from_culturebase_sob --settings=ruhrbuehnen.settings.local --traceback
...
date
python manage.py import_from_berliner_ensemble --settings=ruhrbuehnen.settings.local --traceback
