...
"""
class HierarchyRelatedFilterSpec(RelatedFilterSpec):
...
FilterSpec.register(lambda f: bool(f.rel) and getattr(f.rel.to, 'is_hierarchical', False), HierarchyRelatedFilterSpec)
