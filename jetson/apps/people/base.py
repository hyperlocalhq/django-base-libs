...
from jetson.apps.utils.models import XFieldList # for south to work
...
class IndividualContactBase(models.Model):
    ...
    phone0_type = models.ForeignKey(PhoneType, verbose_name=_("Phone Type"), blank=True, null=True, related_name='individual_contacts0', default=DefaultPhoneType("phone"))
    ...
    phone1_type = models.ForeignKey(PhoneType, verbose_name=_("Phone Type"), blank=True, null=True, related_name='individual_contacts1', default=DefaultPhoneType("fax"))
    ...
    phone2_type = models.ForeignKey(PhoneType, verbose_name=_("Phone Type"), blank=True, null=True, related_name='individual_contacts2', default=DefaultPhoneType("mobile"))
    ...
    url0_type = models.ForeignKey(URLType, verbose_name=_("URL Type"), blank=True, null=True, related_name='individual_contacts0')
    ...
    url1_type = models.ForeignKey(URLType, verbose_name=_("URL Type"), blank=True, null=True, related_name='individual_contacts1')
    ...
    url2_type = models.ForeignKey(URLType, verbose_name=_("URL Type"), blank=True, null=True, related_name='individual_contacts2')
    ...
    im0_type = models.ForeignKey(IMType, verbose_name=_("IM Type"), blank=True, null=True, related_name='individual_contacts0')
    ...
    im1_type = models.ForeignKey(IMType, verbose_name=_("IM Type"), blank=True, null=True, related_name='individual_contacts1')
    ...
    im2_type = models.ForeignKey(IMType, verbose_name=_("IM Type"), blank=True, null=True, related_name='individual_contacts2')
    ...
    email0_type = models.ForeignKey(EmailType, verbose_name=_("Email Type"), blank=True, null=True, related_name='individual_contacts0')
    ...
    email1_type = models.ForeignKey(EmailType, verbose_name=_("Email Type"), blank=True, null=True, related_name='individual_contacts1')
    ...
    email2_type = models.ForeignKey(EmailType, verbose_name=_("Email Type"), blank=True, null=True, related_name='individual_contacts2')
