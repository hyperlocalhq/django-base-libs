...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Medium'
        db.create_table('resources_medium', south_cleaned_fields((
        ...
        db.send_create_signal('resources', ['Medium'])

        # Adding model 'DocumentType'
        db.create_table('resources_documenttype', south_cleaned_fields((
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=255, db_index=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='child_set', null=True, to=orm['resources.DocumentType'])),
        ...
        db.send_create_signal('resources', ['DocumentType'])
        ...
        db.create_table('resources_document', south_cleaned_fields((
            ...
            ('document_type', self.gf('mptt.fields.TreeForeignKey')(related_name='type_documents', to=orm['resources.DocumentType'])),
            ('medium', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='medium_documents', null=True, to=orm['resources.Medium'])),
            ('url_link', self.gf('base_libs.models.fields.URLField')(max_length=200, blank=True)),
            ('document_file', self.gf('filebrowser.fields.FileBrowseField')(max_length=255, blank=True)),
            ('authors_plain', self.gf('base_libs.models.fields.PlainTextModelField')(max_length=255, blank=True)),
            ('publisher', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['institutions.Institution'], null=True, blank=True)),
            ('published_yyyy', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('published_mm', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True)),
            ('published_dd', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True)),
            ('playing_time', self.gf('django.db.models.fields.TimeField')(null=True, blank=True)),
            ('isbn10', self.gf('django.db.models.fields.CharField')(max_length=13, blank=True)),
            ('isbn13', self.gf('django.db.models.fields.CharField')(max_length=17, blank=True)),
            ('pages', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True, blank=True)),
            ('file_size', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True, blank=True)),
            ('image', self.gf('filebrowser.fields.FileBrowseField')(directory='documents/', max_length=255, extensions=['.jpg', '.jpeg', '.gif', '.png', '.tif', '.tiff'], blank=True)),
        ...
        db.create_table('resources_document_authors', (
            ...
            ('document', models.ForeignKey(orm['resources.document'], null=False)),
            ('person', models.ForeignKey(orm['people.person'], null=False))
        ))
        db.create_unique('resources_document_authors', ['document_id', 'person_id'])

        # Adding M2M table for field languages on 'Document'
        db.create_table('resources_document_languages', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('document', models.ForeignKey(orm['resources.document'], null=False)),
            ('language', models.ForeignKey(orm['i18n.language'], null=False))
        ))
        db.create_unique('resources_document_languages', ['document_id', 'language_id'])

        # Adding M2M table for field context_categories on 'Document'
        ...
        db.create_unique('resources_document_context_categories', ['document_id', 'contextcategory_id'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'Medium'
        db.delete_table('resources_medium')

        # Deleting model 'DocumentType'
        db.delete_table('resources_documenttype')
        ...
        # Removing M2M table for field languages on 'Document'
        db.delete_table('resources_document_languages')

        # Removing M2M table for field context_categories on 'Document'
