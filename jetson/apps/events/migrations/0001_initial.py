...
class Migration:
    ...
    def forwards(self, orm):
        ...
        field_definitions = south_cleaned_fields((
            ...
            ('additional_info_de', ExtendedTextField(u'Additional Info', unique_for_month=None, unique=False, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, null=False, unique_for_date=None, db_tablespace='', db_index=False)),
            ('additional_info_de_markup_type', models.CharField('Markup type', default='pt', max_length=10, blank=False)),
            ('additional_info_en', ExtendedTextField(u'Additional Info', unique_for_month=None, unique=False, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, null=False, unique_for_date=None, db_tablespace='', db_index=False)),
        ...
        if models.get_model("institutions", "Institution"):
            field_definitions.append(
                ('venue', models.ForeignKey(orm['institutions.Institution'], related_name="events_happened", null=True, blank=True)),
                )
            field_definitions.append(
        ...
        if models.get_model("people", "Person"):
            field_definitions.append(
                ('organizing_person', models.ForeignKey(orm['people.Person'], related_name="events_organized", null=True, blank=True)),
                )
        
        db.create_table('events_event', field_definitions)
