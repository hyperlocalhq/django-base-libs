...
def person_change(request, object_id=None):
    ...
    if request.method == "POST":
        ...
        if form.is_valid() and contact_formset.is_valid():
            ...
            request.user.message_set.create(message=_('%s was successfully saved.') % unicode(person))
...
def institution_change(request, object_id=None):
    ...
    if request.method == "POST":
        ...
        if form.is_valid() and contact_formset.is_valid():
            ...
            request.user.message_set.create(message=_('%s was successfully saved.') % unicode(institution))
            if request.POST.has_key("_addanother"):
...
def document_change(request, object_id=None):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            request.user.message_set.create(message=_('%s was successfully saved.') % unicode(document))
            if request.POST.has_key("_addanother"):
...
def event_change(request, object_id=None):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            request.user.message_set.create(message=_('%s was successfully saved.') % unicode(event))
            if request.POST.has_key("_addanother"):
