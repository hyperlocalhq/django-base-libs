...
class NavigationLinkOptions(TreeEditor, ObjectRelationMixinAdminOptions(prefix_verbose=_("Linked Object"))):
    ...
    save_on_top = True
    list_display = XFieldList(['actions_column', 'indented_short_title', 'get_link_display', 'is_shown_for_visitors', 'is_shown_for_users', 'sysname',])
    search_fields = XFieldList(['title_', 'link_url', 'sysname'])

    list_filter = ('site', 'is_shown_for_visitors', 'is_shown_for_users', 'is_group')
