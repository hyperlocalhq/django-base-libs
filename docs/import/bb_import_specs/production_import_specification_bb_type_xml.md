...
ls = Location.objects.filter(status='published').order_by(Lower("title"))
for l in ls:
    print u'- {0} (Location ID = {1})'.format(l.title, l.pk)
    for s in l.stage_set.order_by(Lower("title")):
...
- Berliner Festspiele (Location ID = 80)
  ...
  - daadgalerie (Stage ID = 234)
  - Gropius Bau (Stage ID = 41)
  - Haus der Berliner Festspiele (Stage ID = 212)
  ...
  - Haus der Berliner Festspiele, Mittelbühne (Stage ID = 224)
  - Haus der Berliner Festspiele, Oberes Foyer (Stage ID = 89)
  - Haus der Berliner Festspiele, Seitenbühne (Stage ID = 88)
  - Institut Français Berlin (Stage ID = 156)
  - Kaiser-Wilhelm-Gedächtnis-Kirche Berlin (Stage ID = 149)
  - Kirche Am Hohenzollernplatz (Stage ID = 211)
  - Kraftwerk Berlin (Stage ID = 157)
  - Lido (Stage ID = 193)
  - Nationaltheater Reinickendorf (Stage ID = 200)
  - Pierre Boulez Saal (Stage ID = 192)
  - Prince Charles (Stage ID = 227)
  - Quasimodo (Stage ID = 228)
  - Radialsystem V (Stage ID = 196)
  - Rathenau-Hallen (Stage ID = 219)
  - SAVVY Contemporary (Stage ID = 194)
  - silent green Kulturquartier (Stage ID = 195)
  - St. Hedwigs-Kathedrale (Stage ID = 184)
  - Universität der Künste (Stage ID = 197)
...
- Berliner Kriminal Theater (Location ID = 48)
  - TheaterClub im Umspannwerk.Ost (Stage ID = 218)
...
- Berliner Schnauze (Location ID = 224)
  - Musikbrauerei (Stage ID = 231)
...
- DOCK 11 (Location ID = 157)
  - EDEN***** (Stage ID = 142)
- English Theatre Berlin | International Performing Arts Center (Location ID = 5
8)
- Friedrichstadt-Palast Berlin (Location ID = 39)
- Galli Theater Berlin (Location ID = 77)
- Glaspalast (Location ID = 214)
...
- Märchenhütte (Location ID = 186)
  ...
  - Jakobhütte (Stage ID = 166)
  - Wilhelmhütte (Stage ID = 167)
...
- Radialsystem (Location ID = 29)
- RambaZamba Theater (Location ID = 166)
  - Hauptbühne (Stage ID = 223)
  - Probebühne (Stage ID = 222)
...
- Shakespeare Company Berlin (Location ID = 161)
  - ehem. Stummfilmkino Delphi (Stage ID = 214)
...
- Staatsoper Unter den Linden (Location ID = 9)
  - Apollo Saal (Stage ID = 22)
  - Bebelplatz (Stage ID = 56)
  - Bode Museum (Stage ID = 44)
  - Neue Werkstatt /  Alter Orchesterprobensaal (Stage ID = 24)
...
- TAK Theater Aufbau Kreuzberg (Location ID = 133)
- Theater an der Parkaue (Location ID = 42)
  - Bühne 1 (Stage ID = 84)
  - Bühne 2 (Stage ID = 27)
  - Bühne 3 (Stage ID = 85)
- Theater im Delphi (Location ID = 221)
- Theater im Palais (Location ID = 32)
- Theater Morgenstern (Location ID = 38)
  - Theater Morgenstern im Rathaus Friedenau (Stage ID = 133)
- Theater O-TonArt (Location ID = 20)
- Theater o.N. (Location ID = 181)
- Theater Strahl Berlin (Location ID = 72)
...
- Theaterhaus Berlin Mitte (Location ID = 132)
  ...
  - ZELT auf der Sommerwiese (Stage ID = 183)
...
- Uferstudios (Location ID = 66)
  - Atelier 64 (Stage ID = 221)
  - Heizhaus (Stage ID = 120)
  - Seminarraum (Stage ID = 188)
  - Hof der Uferstudios (Stage ID = 186)
