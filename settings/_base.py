...
JETSON_PATH = os.path.abspath(os.path.join(BASE_DIR, "kb", "subtrees"))
...
SESSION_COOKIE_DOMAIN = "www.kreatives-brandenburg.de"
STAGING_DOMAIN = "kb.jetsonproject.org"

### EMAILS ###

ADMINS = (
    ("Kreatives Brandenburg Webmaster", "bendoraitis@studio38.de"),
)

MANAGERS = (
    ("Kreatives Brandenburg", "info@kreatives-brandenburg.de"),
)
...
DEFAULT_FROM_EMAIL = "info@kreatives-brandenburg.de"


### DIRS AND URLS ###

MEDIA_ROOT = os.path.join(PROJECT_PATH, "kb", "media")
STATIC_ROOT = os.path.join(PROJECT_PATH, "kb", "static")
STATICFILES_DIRS = [os.path.join(PROJECT_PATH, "kb", "site_static")]
MEDIA_URL = "/media/"
STATIC_URL = PIPELINE_URL = "/static/%s/" % get_git_changeset(STATIC_ROOT)
PATH_TMP = os.path.join(PROJECT_PATH, "kb", "tmp")
...
LOCALE_PATHS = [
    os.path.join(PROJECT_PATH, "kb", "locale"),
...
INSTALLED_APPS = [
    ...
    "kb.project_apps.DjangoContribAuthConfig",
    ...
    "kb.apps.cms_extensions.plugins.richtext",
    "kb.apps.cms_extensions.plugins.filebrowser_image",
    "kb.apps.cms_extensions.plugins.gmap",
    "kb.apps.cms_extensions.plugins.headline",
    "kb.apps.editorial",
    ...
    "kb.apps.blog",
    "kb.apps.people",
    "kb.apps.institutions",
    "kb.apps.resources",
    "kb.apps.events",
    "kb.apps.groups_networks",
    "kb.apps.marketplace",
    "kb.apps.site_specific",
    "kb.apps.articles",
    "kb.apps.tracker",
    "kb.apps.search",
    "kb.apps.favorites",
    "kb.apps.external_services",
    "kb.apps.media_gallery",
    "kb.apps.slideshows",
    "kb.apps.faqs",
    "kb.apps.async_test",
    "kb.apps.accounts",
    "kb.apps.network",
    "kb.apps.navigation",
    "kb.apps.bulletin_board",
    "kb.apps.metro",
    "kb.apps.partners",
    "kb.apps.counselling_blog",
    "kb.apps.counselling_events",
    "kb.apps.curated_lists",
    "kb.apps.cms_extensions",
    "kb",  # just for i18n in Javascript
    "actstream",
    "huey.contrib.djhuey",
]
...
MIDDLEWARE_CLASSES = [
    ...
    "kb.apps.accounts.middleware.MySocialAuthExceptionMiddleware",
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(PROJECT_PATH, "kb", "templates", "kb"),
            os.path.join(PROJECT_PATH, "kb", "templates", "admin"),
        ...
        'OPTIONS': {
            'context_processors': (
                ...
                "kb.apps.media_gallery.context_processors.media_gallery",
                "kb.apps.people.context_processors.people",
                "kb.apps.institutions.context_processors.institutions",
                "kb.apps.events.context_processors.events",
                "kb.apps.resources.context_processors.resources",
                "kb.apps.groups_networks.context_processors.groups_networks",
                "kb.apps.marketplace.context_processors.marketplace",
                "kb.apps.site_specific.context_processors.site_specific",
...
CACHE_MIDDLEWARE_KEY_PREFIX = "kb_production_"
...
MAILING_DEFAULT_FROM_NAME = "Kreatives Brandenburg"
MAILING_DEFAULT_FROM_EMAIL = "kb-contact@kulturprojekte-berlin.de"
...
HAYSTACK_ROUTERS = ["kb.apps.search.router.LanguageRouter"]
ALDRYN_SEARCH_LANGUAGE_FROM_ALIAS = lambda alias: alias
ALDRYN_SEARCH_INDEX_BASE_CLASS = "kb.apps.search.search_indexes.CMSPageIndexBase"  # custom index base for pages
...
CRISPY_ALLOWED_TEMPLATE_PACKS = ("bootstrap3", "kb_form")
...
SOCIAL_AUTH_PIPELINE = (
    ...
    "kb.apps.accounts.pipeline.login_or_registration",
    "kb.apps.accounts.pipeline.create_user",
