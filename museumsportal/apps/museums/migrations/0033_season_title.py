...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('museums_season', 'title', self.gf('base_libs.models.fields.MultilingualCharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Season.title_de'
        db.add_column('museums_season', 'title_de', self.gf('django.db.models.fields.CharField')(u'Season title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False), keep_default=False)

        # Adding field 'Season.title_en'
        db.add_column('museums_season', 'title_en', self.gf('django.db.models.fields.CharField')(u'Season title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Season.title'
        db.delete_column('museums_season', 'title')

        # Deleting field 'Season.title_de'
        db.delete_column('museums_season', 'title_de')

        # Deleting field 'Season.title_en'
        db.delete_column('museums_season', 'title_en')
