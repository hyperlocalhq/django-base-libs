...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Museum.public_transport'
        db.add_column('museums_museum', 'public_transport', self.gf('base_libs.models.fields.ExtendedTextField')(default='', blank=True), keep_default=False)

        # Adding field 'Museum.public_transport_markup_type'
        db.add_column('museums_museum', 'public_transport_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Museum.public_transport'
        db.delete_column('museums_museum', 'public_transport')

        # Deleting field 'Museum.public_transport_markup_type'
        db.delete_column('museums_museum', 'public_transport_markup_type')
    ...
    models = {
        'museums.museum': {
            ...
            'public_transport': ('base_libs.models.fields.ExtendedTextField', [], {'blank': 'True'}),
            'public_transport_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
