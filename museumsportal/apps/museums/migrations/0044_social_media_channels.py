...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('museums_socialmediachannel', south_cleaned_fields((
        ...
        db.send_create_signal('museums', ['SocialMediaChannel'])

    
    def backwards(self, orm):
        
        # Deleting model 'SocialMediaChannel'
        db.delete_table('museums_socialmediachannel')
