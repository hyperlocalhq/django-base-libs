...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('museums_mediafile', 'path', self.gf('filebrowser.fields.FileBrowseField')(directory='museums/', max_length=255))
    
    
    def backwards(self, orm):
        
        # Changing field 'MediaFile.path'
        db.alter_column('museums_mediafile', 'path', self.gf('filebrowser.fields.FileBrowseField')(max_length=255))
