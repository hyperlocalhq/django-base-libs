...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Museum.tags'
        db.add_column('museums_museum', 'tags', self.gf('tagging_autocomplete.models.TagAutocompleteField')(default=''), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Museum.tags'
        db.delete_column('museums_museum', 'tags')
