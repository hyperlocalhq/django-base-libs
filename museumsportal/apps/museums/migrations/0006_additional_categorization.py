...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Museum.open_on_mondays'
        db.add_column('museums_museum', 'open_on_mondays', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Museum.free_entrance'
        db.add_column('museums_museum', 'free_entrance', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Museum.open_on_mondays'
        db.delete_column('museums_museum', 'open_on_mondays')

        # Deleting field 'Museum.free_entrance'
        db.delete_column('museums_museum', 'free_entrance')
