...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Museum.is_for_children'
        db.add_column('museums_museum', 'is_for_children', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    
    
    def backwards(self, orm):

        # Deleting field 'Museum.is_for_children'
        db.delete_column('museums_museum', 'is_for_children')
