...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('museums_museum', 'press_text_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Press text', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False), keep_default=False)
        ...
        db.add_column('museums_museum', 'press_text_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Press text', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False), keep_default=False)
