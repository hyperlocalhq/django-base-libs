...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Museum.phone'
        db.delete_column('museums_museum', 'phone')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Museum.phone'
        db.add_column('museums_museum', 'phone', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)
