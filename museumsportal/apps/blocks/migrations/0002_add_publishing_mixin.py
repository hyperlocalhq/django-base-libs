...
from museumsportal.apps.blocks.models import *
...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InfoBlock.published_till'
        db.add_column('blocks_infoblock', 'published_till', orm['blocks.infoblock:published_till'])
        
        # Adding field 'InfoBlock.status'
        db.add_column('blocks_infoblock', 'status', orm['blocks.infoblock:status'])
        
        # Adding field 'InfoBlock.author'
        db.add_column('blocks_infoblock', 'author', orm['blocks.infoblock:author'])
        
        # Adding field 'InfoBlock.published_from'
        db.add_column('blocks_infoblock', 'published_from', orm['blocks.infoblock:published_from'])
        
    def backwards(self, orm):
        
        # Deleting field 'InfoBlock.published_till'
        db.delete_column('blocks_infoblock', 'published_till')
        
        # Deleting field 'InfoBlock.status'
        db.delete_column('blocks_infoblock', 'status')
        
        # Deleting field 'InfoBlock.author'
        db.delete_column('blocks_infoblock', 'author_id')
        
        # Deleting field 'InfoBlock.published_from'
        db.delete_column('blocks_infoblock', 'published_from')
    ...
    models = {
        ...
        'blocks.infoblock': {
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'infoblock_author'", 'blank': 'True', 'null': 'True', 'to': "orm['auth.User']"}),
            'content': ('MultilingualTextField', ["_('content')"], {}),
            'content_de': ('ExtendedTextField', ["u'content'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'False', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'content_de_markup_type': ('models.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            'content_en': ('ExtendedTextField', ["u'content'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'False', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
