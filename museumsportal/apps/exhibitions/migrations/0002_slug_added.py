...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('exhibitions_exhibition', 'slug', self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=255, db_index=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Exhibition.slug'
        db.delete_column('exhibitions_exhibition', 'slug')
