...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('exhibitions_organizer', south_cleaned_fields((
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('exhibition', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exhibitions.Exhibition'])),
            ('organizing_museum', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exhibition_organizer', null=True, to=orm['museums.Museum'])),
        ...
        db.send_create_signal('exhibitions', ['Organizer'])

    
    def backwards(self, orm):
        
        # Deleting model 'Organizer'
        db.delete_table('exhibitions_organizer')
