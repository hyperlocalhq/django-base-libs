...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Exhibition.status'
        db.add_column('exhibitions_exhibition', 'status', self.gf('django.db.models.fields.CharField')(default='draft', max_length=20, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Exhibition.status'
        db.delete_column('exhibitions_exhibition', 'status')
