...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NewlyOpenedExhibition'
        db.create_table('cmsplugin_newlyopenedexhibition', south_cleaned_fields((
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('exhibition', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exhibitions.Exhibition'])),
        )))
        db.send_create_signal('exhibitions', ['NewlyOpenedExhibition'])

        # Changing field 'Exhibition.image_caption_de'
        db.alter_column('exhibitions_exhibition', 'image_caption_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Bildbeschreibung', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=255, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Exhibition.image_caption_en'
        db.alter_column('exhibitions_exhibition', 'image_caption_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Bildbeschreibung', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=255, unique_for_year=None, rel=None, unique=False, db_tablespace=''))
    
    
    def backwards(self, orm):
        
        # Deleting model 'NewlyOpenedExhibition'
        db.delete_table('cmsplugin_newlyopenedexhibition')

        # Changing field 'Exhibition.image_caption_de'
        db.alter_column('exhibitions_exhibition', 'image_caption_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Image Caption', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=255, db_tablespace=''))

        # Changing field 'Exhibition.image_caption_en'
        db.alter_column('exhibitions_exhibition', 'image_caption_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Image Caption', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, max_length=255, db_tablespace=''))
