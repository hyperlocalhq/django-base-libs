...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Exhibition.pdf_document_de'
        db.add_column('exhibitions_exhibition', 'pdf_document_de', self.gf('filebrowser.fields.FileBrowseField')(directory='exhibitions/', default='', max_length=255, extensions=['.pdf'], blank=True), keep_default=False)

        # Adding field 'Exhibition.pdf_document_en'
        db.add_column('exhibitions_exhibition', 'pdf_document_en', self.gf('filebrowser.fields.FileBrowseField')(directory='exhibitions/', default='', max_length=255, extensions=['.pdf'], blank=True), keep_default=False)
    
    def backwards(self, orm):
        
        # Deleting field 'Exhibition.pdf_document_de'
        db.delete_column('exhibitions_exhibition', 'pdf_document_de')

        # Deleting field 'Exhibition.pdf_document_en'
        db.delete_column('exhibitions_exhibition', 'pdf_document_en')
