...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Exhibition.tags'
        db.add_column('exhibitions_exhibition', 'tags', self.gf('tagging_autocomplete.models.TagAutocompleteField')(default=''), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Exhibition.tags'
        db.delete_column('exhibitions_exhibition', 'tags')
