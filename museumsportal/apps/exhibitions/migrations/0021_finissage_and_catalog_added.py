...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Exhibition.catalog'
        db.add_column('exhibitions_exhibition', 'catalog', self.gf('base_libs.models.fields.MultilingualTextField')(default='', null=True, blank=True), keep_default=False)

        # Adding field 'Exhibition.finissage'
        db.add_column('exhibitions_exhibition', 'finissage', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Exhibition.catalog_de'
        db.add_column('exhibitions_exhibition', 'catalog_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Catalog', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False), keep_default=False)

        # Adding field 'Exhibition.catalog_de_markup_type'
        db.add_column('exhibitions_exhibition', 'catalog_de_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False), keep_default=False)

        # Adding field 'Exhibition.catalog_en'
        db.add_column('exhibitions_exhibition', 'catalog_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Catalog', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False), keep_default=False)

        # Adding field 'Exhibition.catalog_en_markup_type'
        db.add_column('exhibitions_exhibition', 'catalog_en_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False), keep_default=False)

        # Adding field 'Exhibition.catalog_markup_type'
        db.add_column('exhibitions_exhibition', 'catalog_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False), keep_default=False)

    
    def backwards(self, orm):
        
        # Deleting field 'Exhibition.catalog'
        db.delete_column('exhibitions_exhibition', 'catalog')

        # Deleting field 'Exhibition.finissage'
        db.delete_column('exhibitions_exhibition', 'finissage')

        # Deleting field 'Exhibition.catalog_de'
        db.delete_column('exhibitions_exhibition', 'catalog_de')

        # Deleting field 'Exhibition.catalog_de_markup_type'
        db.delete_column('exhibitions_exhibition', 'catalog_de_markup_type')

        # Deleting field 'Exhibition.catalog_en'
        db.delete_column('exhibitions_exhibition', 'catalog_en')

        # Deleting field 'Exhibition.catalog_en_markup_type'
        db.delete_column('exhibitions_exhibition', 'catalog_en_markup_type')

        # Deleting field 'Exhibition.catalog_markup_type'
        db.delete_column('exhibitions_exhibition', 'catalog_markup_type')
