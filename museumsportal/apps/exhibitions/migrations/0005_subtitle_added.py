...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Exhibition.subtitle'
        db.add_column('exhibitions_exhibition', 'subtitle', self.gf('base_libs.models.fields.MultilingualCharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Exhibition.subtitle_de'
        db.add_column('exhibitions_exhibition', 'subtitle_de', self.gf('django.db.models.fields.CharField')(u'Subtitle', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False), keep_default=False)

        # Adding field 'Exhibition.subtitle_en'
        db.add_column('exhibitions_exhibition', 'subtitle_en', self.gf('django.db.models.fields.CharField')(u'Subtitle', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Exhibition.subtitle'
        db.delete_column('exhibitions_exhibition', 'subtitle')

        # Deleting field 'Exhibition.subtitle_de'
        db.delete_column('exhibitions_exhibition', 'subtitle_de')

        # Deleting field 'Exhibition.subtitle_en'
        db.delete_column('exhibitions_exhibition', 'subtitle_en')
