...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Exhibition.featured_in_magazine'
        db.add_column('exhibitions_exhibition', 'featured_in_magazine', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Exhibition.featured_in_magazine'
        db.delete_column('exhibitions_exhibition', 'featured_in_magazine')
