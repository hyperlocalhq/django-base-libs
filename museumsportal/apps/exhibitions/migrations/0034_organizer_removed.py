...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('exhibitions_exhibition', 'organizing_museum', self.gf('django.db.models.fields.related.ForeignKey')(related_name='organized_exhibitions', null=True, to=orm['museums.Museum'], blank=True), keep_default=False)
