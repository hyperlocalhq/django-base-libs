...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Exhibition.permanent'
        db.add_column('exhibitions_exhibition', 'permanent', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'Exhibition.start'
        db.alter_column('exhibitions_exhibition', 'start', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Exhibition.end'
        db.alter_column('exhibitions_exhibition', 'end', self.gf('django.db.models.fields.DateField')(null=True))

    
    def backwards(self, orm):
        
        # Deleting field 'Exhibition.permanent'
        db.delete_column('exhibitions_exhibition', 'permanent')

        # Changing field 'Exhibition.start'
        db.alter_column('exhibitions_exhibition', 'start', self.gf('django.db.models.fields.DateField')(default=datetime.date(2012, 11, 28)))

        # Changing field 'Exhibition.end'
        db.alter_column('exhibitions_exhibition', 'end', self.gf('django.db.models.fields.DateField')(default=datetime.date(2012, 11, 28)))
