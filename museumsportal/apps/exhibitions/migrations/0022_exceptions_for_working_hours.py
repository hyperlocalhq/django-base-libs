...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('exhibitions_specialopeningtime', 'exceptions', self.gf('base_libs.models.fields.MultilingualTextField')(default='', null=True, blank=True), keep_default=False)

        # Adding field 'SpecialOpeningTime.exceptions_de'
        db.add_column('exhibitions_specialopeningtime', 'exceptions_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Sonstige \xd6ffnungszeiten', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False), keep_default=False)

        # Adding field 'SpecialOpeningTime.exceptions_de_markup_type'
        db.add_column('exhibitions_specialopeningtime', 'exceptions_de_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False), keep_default=False)

        # Adding field 'SpecialOpeningTime.exceptions_en'
        db.add_column('exhibitions_specialopeningtime', 'exceptions_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Sonstige \xd6ffnungszeiten', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False), keep_default=False)

        # Adding field 'SpecialOpeningTime.exceptions_en_markup_type'
        db.add_column('exhibitions_specialopeningtime', 'exceptions_en_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False), keep_default=False)

        # Adding field 'SpecialOpeningTime.exceptions_markup_type'
        db.add_column('exhibitions_specialopeningtime', 'exceptions_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False), keep_default=False)

    
    def backwards(self, orm):
        
        # Deleting field 'SpecialOpeningTime.exceptions'
        db.delete_column('exhibitions_specialopeningtime', 'exceptions')

        # Deleting field 'SpecialOpeningTime.exceptions_de'
        db.delete_column('exhibitions_specialopeningtime', 'exceptions_de')

        # Deleting field 'SpecialOpeningTime.exceptions_de_markup_type'
        db.delete_column('exhibitions_specialopeningtime', 'exceptions_de_markup_type')

        # Deleting field 'SpecialOpeningTime.exceptions_en'
        db.delete_column('exhibitions_specialopeningtime', 'exceptions_en')

        # Deleting field 'SpecialOpeningTime.exceptions_en_markup_type'
        db.delete_column('exhibitions_specialopeningtime', 'exceptions_en_markup_type')

        # Deleting field 'SpecialOpeningTime.exceptions_markup_type'
        db.delete_column('exhibitions_specialopeningtime', 'exceptions_markup_type')
