...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Exhibition.other_locations'
        db.add_column('exhibitions_exhibition', 'other_locations', self.gf('base_libs.models.fields.MultilingualTextField')(default='', null=True, blank=True), keep_default=False)

        # Adding field 'Exhibition.other_locations_de'
        db.add_column('exhibitions_exhibition', 'other_locations_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Other exhibition locations', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False), keep_default=False)

        # Adding field 'Exhibition.other_locations_de_markup_type'
        db.add_column('exhibitions_exhibition', 'other_locations_de_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False), keep_default=False)

        # Adding field 'Exhibition.other_locations_en'
        db.add_column('exhibitions_exhibition', 'other_locations_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Other exhibition locations', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False), keep_default=False)

        # Adding field 'Exhibition.other_locations_en_markup_type'
        db.add_column('exhibitions_exhibition', 'other_locations_en_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False), keep_default=False)

        # Adding field 'Exhibition.other_locations_markup_type'
        db.add_column('exhibitions_exhibition', 'other_locations_markup_type', self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False), keep_default=False)

    
    def backwards(self, orm):
        
        # Deleting field 'Exhibition.other_locations'
        db.delete_column('exhibitions_exhibition', 'other_locations')

        # Deleting field 'Exhibition.other_locations_de'
        db.delete_column('exhibitions_exhibition', 'other_locations_de')

        # Deleting field 'Exhibition.other_locations_de_markup_type'
        db.delete_column('exhibitions_exhibition', 'other_locations_de_markup_type')

        # Deleting field 'Exhibition.other_locations_en'
        db.delete_column('exhibitions_exhibition', 'other_locations_en')

        # Deleting field 'Exhibition.other_locations_en_markup_type'
        db.delete_column('exhibitions_exhibition', 'other_locations_en_markup_type')

        # Deleting field 'Exhibition.other_locations_markup_type'
        db.delete_column('exhibitions_exhibition', 'other_locations_markup_type')
