...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Exhibition.special'
        db.add_column('exhibitions_exhibition', 'special', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'Exhibition.admission_price_info_de'
        db.alter_column('exhibitions_exhibition', 'admission_price_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintrittspreis Infotext', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Exhibition.reduced_price_info_en'
        db.alter_column('exhibitions_exhibition', 'reduced_price_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintrittspreis erm\xe4\xdfigt Infotext', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Exhibition.admission_price_info_en'
        db.alter_column('exhibitions_exhibition', 'admission_price_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintrittspreis Infotext', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Exhibition.reduced_price_info_de'
        db.alter_column('exhibitions_exhibition', 'reduced_price_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintrittspreis erm\xe4\xdfigt Infotext', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

    def backwards(self, orm):
        # Deleting field 'Exhibition.special'
        db.delete_column('exhibitions_exhibition', 'special')

        # Changing field 'Exhibition.admission_price_info_de'
        db.alter_column('exhibitions_exhibition', 'admission_price_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintrittpreis Infotext', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Exhibition.reduced_price_info_en'
        db.alter_column('exhibitions_exhibition', 'reduced_price_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintrittpreis erm\xe4\xdfigt Infotext', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Exhibition.admission_price_info_en'
        db.alter_column('exhibitions_exhibition', 'admission_price_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintrittpreis Infotext', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Exhibition.reduced_price_info_de'
        db.alter_column('exhibitions_exhibition', 'reduced_price_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintrittpreis erm\xe4\xdfigt Infotext', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))
