...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Exhibition.free_entrance_times_en'
        db.alter_column('exhibitions_exhibition', 'free_entrance_times_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Informationen zu freiem Eintritt:', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Exhibition.free_entrance_times_de'
        db.alter_column('exhibitions_exhibition', 'free_entrance_times_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Informationen zu freiem Eintritt:', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Exhibition.free_entrance_times_en'
        db.alter_column('exhibitions_exhibition', 'free_entrance_times_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Free entrance times', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Exhibition.free_entrance_times_de'
        db.alter_column('exhibitions_exhibition', 'free_entrance_times_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Free entrance times', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))
