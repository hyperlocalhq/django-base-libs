...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('exhibitions_season', 'last_entry', self.gf('base_libs.models.fields.MultilingualCharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Season.last_entry_de'
        db.add_column('exhibitions_season', 'last_entry_de', self.gf('django.db.models.fields.CharField')(u'Last entry', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False), keep_default=False)

        # Adding field 'Season.last_entry_en'
        db.add_column('exhibitions_season', 'last_entry_en', self.gf('django.db.models.fields.CharField')(u'Last entry', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False), keep_default=False)

    
    def backwards(self, orm):
        
        # Deleting field 'Season.last_entry'
        db.delete_column('exhibitions_season', 'last_entry')

        # Deleting field 'Season.last_entry_de'
        db.delete_column('exhibitions_season', 'last_entry_de')

        # Deleting field 'Season.last_entry_en'
        db.delete_column('exhibitions_season', 'last_entry_en')
