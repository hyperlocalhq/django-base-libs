...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.closest_event_date'
        db.add_column('events_event', 'closest_event_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'Event.closest_event_date'
        db.delete_column('events_event', 'closest_event_date')
