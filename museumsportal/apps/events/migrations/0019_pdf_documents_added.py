...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.pdf_document_de'
        db.add_column('events_event', 'pdf_document_de', self.gf('filebrowser.fields.FileBrowseField')(directory='exhibitions/', default='', max_length=255, extensions=['.pdf'], blank=True), keep_default=False)

        # Adding field 'Event.pdf_document_en'
        db.add_column('events_event', 'pdf_document_en', self.gf('filebrowser.fields.FileBrowseField')(directory='exhibitions/', default='', max_length=255, extensions=['.pdf'], blank=True), keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Event.pdf_document_de'
        db.delete_column('events_event', 'pdf_document_de')

        # Deleting field 'Event.pdf_document_en'
        db.delete_column('events_event', 'pdf_document_en')
