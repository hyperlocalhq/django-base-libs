...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'Event.favorites_count'
        db.add_column(u'events_event', 'favorites_count',
    ...
    def backwards(self, orm):
                # Deleting field 'Event.favorites_count'
        db.delete_column(u'events_event', 'favorites_count')
