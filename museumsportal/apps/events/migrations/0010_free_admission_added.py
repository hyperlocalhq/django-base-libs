...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.free_admission'
        db.add_column('events_event', 'free_admission', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

    
    def backwards(self, orm):
        
        # Deleting field 'Event.free_admission'
        db.delete_column('events_event', 'free_admission')
