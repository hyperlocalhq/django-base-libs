...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('events_eventcategory', south_cleaned_fields((
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=255, db_index=True)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='child_set', null=True, to=orm['events.EventCategory'])),
        ...
        # Adding M2M table for field languages on 'Event'
        db.create_table('events_event_languages', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm['events.event'], null=False)),
            ('language', models.ForeignKey(orm['i18n.language'], null=False))
        ))
        db.create_unique('events_event_languages', ['event_id', 'language_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field languages on 'Event'
        db.delete_table('events_event_languages')
