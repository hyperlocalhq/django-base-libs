...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('events_event', 'organizing_museum', self.gf('django.db.models.fields.related.ForeignKey')(related_name='organized_events', null=True, to=orm['museums.Museum'], blank=True), keep_default=False)
