...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Event.district'
        db.delete_column('events_event', 'district')

    def backwards(self, orm):
        # Adding field 'Event.district'
        db.add_column('events_event', 'district', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)
