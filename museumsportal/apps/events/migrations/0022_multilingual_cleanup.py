...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Deleting field 'Event.booking_info_markup_type'
        db.delete_column(u'events_event', 'booking_info_markup_type')

        # Deleting field 'Event.description_markup_type'
        db.delete_column(u'events_event', 'description_markup_type')

        # Deleting field 'Event.admission_price_info_markup_type'
        db.delete_column(u'events_event', 'admission_price_info_markup_type')

        # Deleting field 'Event.press_text_markup_type'
        db.delete_column(u'events_event', 'press_text_markup_type')
        ...
        # Changing field 'Event.booking_info_de'
        db.alter_column(u'events_event', 'booking_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Booking info', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Event.press_text_en'
        db.alter_column(u'events_event', 'press_text_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Press text', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Event.admission_price_info_en'
        db.alter_column(u'events_event', 'admission_price_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Admission price info', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))
        ...
        # Changing field 'Event.press_text_de'
        db.alter_column(u'events_event', 'press_text_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Press text', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Event.admission_price_info_de'
        db.alter_column(u'events_event', 'admission_price_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Admission price info', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Event.booking_info_en'
        db.alter_column(u'events_event', 'booking_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Booking info', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))
        # Adding field 'EventCategory.tree_id'

    def backwards(self, orm):
                # Adding field 'Event.booking_info_markup_type'
        db.add_column(u'events_event', 'booking_info_markup_type',
        ...
        db.add_column(u'events_event', 'description_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Event.admission_price_info_markup_type'
        db.add_column(u'events_event', 'admission_price_info_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Event.press_text_markup_type'
        db.add_column(u'events_event', 'press_text_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)
        ...
        # Changing field 'Event.booking_info_de'
        db.alter_column(u'events_event', 'booking_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Buchungsinformation', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Event.press_text_en'
        db.alter_column(u'events_event', 'press_text_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Pressetext', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Event.admission_price_info_en'
        db.alter_column(u'events_event', 'admission_price_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintrittspreis Infotext', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))
        ...
        # Changing field 'Event.press_text_de'
        db.alter_column(u'events_event', 'press_text_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Pressetext', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Event.admission_price_info_de'
        db.alter_column(u'events_event', 'admission_price_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintrittspreis Infotext', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Event.booking_info_en'
        db.alter_column(u'events_event', 'booking_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Buchungsinformation', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))
