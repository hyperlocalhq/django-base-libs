...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.description_locked'
        db.add_column('events_event', 'description_locked', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

    
    def backwards(self, orm):
        
        # Deleting field 'Event.description_locked'
        db.delete_column('events_event', 'description_locked')
