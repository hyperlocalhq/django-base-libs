...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Workshop.link'
        db.delete_column('workshops_workshop', 'link')

        # Adding field 'Workshop.website'
        db.add_column('workshops_workshop', 'website', self.gf('base_libs.models.fields.MultilingualCharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Workshop.website_de'
        db.add_column('workshops_workshop', 'website_de', self.gf('django.db.models.fields.CharField')(u'Website', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False), keep_default=False)

        # Adding field 'Workshop.website_en'
        db.add_column('workshops_workshop', 'website_en', self.gf('django.db.models.fields.CharField')(u'Website', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'Workshop.link'
        db.add_column('workshops_workshop', 'link', self.gf('base_libs.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)

        # Deleting field 'Workshop.website'
        db.delete_column('workshops_workshop', 'website')

        # Deleting field 'Workshop.website_de'
        db.delete_column('workshops_workshop', 'website_de')

        # Deleting field 'Workshop.website_en'
        db.delete_column('workshops_workshop', 'website_en')
