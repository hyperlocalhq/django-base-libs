...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'Workshop.workshop_type_fr'
        db.add_column(u'workshops_workshop', 'workshop_type_fr',
                      self.gf('django.db.models.fields.CharField')(u'Type', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.workshop_type_pl'
        db.add_column(u'workshops_workshop', 'workshop_type_pl',
                      self.gf('django.db.models.fields.CharField')(u'Type', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.workshop_type_tr'
        db.add_column(u'workshops_workshop', 'workshop_type_tr',
                      self.gf('django.db.models.fields.CharField')(u'Type', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.workshop_type_es'
        db.add_column(u'workshops_workshop', 'workshop_type_es',
                      self.gf('django.db.models.fields.CharField')(u'Type', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.workshop_type_it'
        db.add_column(u'workshops_workshop', 'workshop_type_it',
                      self.gf('django.db.models.fields.CharField')(u'Type', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.subtitle_fr'
        db.add_column(u'workshops_workshop', 'subtitle_fr',
        ...
        # Adding field 'Workshop.subtitle_pl'
        db.add_column(u'workshops_workshop', 'subtitle_pl',
                      self.gf('django.db.models.fields.CharField')(u'Subtitle', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.subtitle_tr'
        db.add_column(u'workshops_workshop', 'subtitle_tr',
                      self.gf('django.db.models.fields.CharField')(u'Subtitle', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.subtitle_es'
        db.add_column(u'workshops_workshop', 'subtitle_es',
                      self.gf('django.db.models.fields.CharField')(u'Subtitle', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.subtitle_it'
        db.add_column(u'workshops_workshop', 'subtitle_it',
                      self.gf('django.db.models.fields.CharField')(u'Subtitle', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.title_fr'
        db.add_column(u'workshops_workshop', 'title_fr',
        ...
        # Adding field 'Workshop.title_pl'
        db.add_column(u'workshops_workshop', 'title_pl',
                      self.gf('django.db.models.fields.CharField')(u'Title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.title_tr'
        db.add_column(u'workshops_workshop', 'title_tr',
                      self.gf('django.db.models.fields.CharField')(u'Title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.title_es'
        db.add_column(u'workshops_workshop', 'title_es',
                      self.gf('django.db.models.fields.CharField')(u'Title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.title_it'
        db.add_column(u'workshops_workshop', 'title_it',
                      self.gf('django.db.models.fields.CharField')(u'Title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.press_text_fr'
        db.add_column(u'workshops_workshop', 'press_text_fr',
        ...
        # Adding field 'Workshop.press_text_fr_markup_type'
        db.add_column(u'workshops_workshop', 'press_text_fr_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Workshop.press_text_pl'
        db.add_column(u'workshops_workshop', 'press_text_pl',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Press text', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.press_text_pl_markup_type'
        db.add_column(u'workshops_workshop', 'press_text_pl_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Workshop.press_text_tr'
        db.add_column(u'workshops_workshop', 'press_text_tr',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Press text', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.press_text_tr_markup_type'
        db.add_column(u'workshops_workshop', 'press_text_tr_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Workshop.press_text_es'
        db.add_column(u'workshops_workshop', 'press_text_es',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Press text', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.press_text_es_markup_type'
        db.add_column(u'workshops_workshop', 'press_text_es_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Workshop.press_text_it'
        db.add_column(u'workshops_workshop', 'press_text_it',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Press text', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.press_text_it_markup_type'
        db.add_column(u'workshops_workshop', 'press_text_it_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Workshop.website_fr'
        db.add_column(u'workshops_workshop', 'website_fr',
        ...
        # Adding field 'Workshop.website_pl'
        db.add_column(u'workshops_workshop', 'website_pl',
                      self.gf('django.db.models.fields.CharField')(u'Website', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.website_tr'
        db.add_column(u'workshops_workshop', 'website_tr',
                      self.gf('django.db.models.fields.CharField')(u'Website', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.website_es'
        db.add_column(u'workshops_workshop', 'website_es',
                      self.gf('django.db.models.fields.CharField')(u'Website', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.website_it'
        db.add_column(u'workshops_workshop', 'website_it',
                      self.gf('django.db.models.fields.CharField')(u'Website', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.description_fr'
        db.add_column(u'workshops_workshop', 'description_fr',
        ...
        # Adding field 'Workshop.description_fr_markup_type'
        db.add_column(u'workshops_workshop', 'description_fr_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Workshop.description_pl'
        db.add_column(u'workshops_workshop', 'description_pl',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Description', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.description_pl_markup_type'
        db.add_column(u'workshops_workshop', 'description_pl_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Workshop.description_tr'
        db.add_column(u'workshops_workshop', 'description_tr',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Description', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.description_tr_markup_type'
        db.add_column(u'workshops_workshop', 'description_tr_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Workshop.description_es'
        db.add_column(u'workshops_workshop', 'description_es',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Description', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.description_es_markup_type'
        db.add_column(u'workshops_workshop', 'description_es_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Workshop.description_it'
        db.add_column(u'workshops_workshop', 'description_it',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Description', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.description_it_markup_type'
        db.add_column(u'workshops_workshop', 'description_it_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Workshop.booking_info_fr'
        db.add_column(u'workshops_workshop', 'booking_info_fr',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Booking info', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.booking_info_fr_markup_type'
        db.add_column(u'workshops_workshop', 'booking_info_fr_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Workshop.booking_info_pl'
        db.add_column(u'workshops_workshop', 'booking_info_pl',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Booking info', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.booking_info_pl_markup_type'
        db.add_column(u'workshops_workshop', 'booking_info_pl_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Workshop.booking_info_tr'
        db.add_column(u'workshops_workshop', 'booking_info_tr',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Booking info', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.booking_info_tr_markup_type'
        db.add_column(u'workshops_workshop', 'booking_info_tr_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Workshop.booking_info_es'
        db.add_column(u'workshops_workshop', 'booking_info_es',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Booking info', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.booking_info_es_markup_type'
        db.add_column(u'workshops_workshop', 'booking_info_es_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Workshop.booking_info_it'
        db.add_column(u'workshops_workshop', 'booking_info_it',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Booking info', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.booking_info_it_markup_type'
        db.add_column(u'workshops_workshop', 'booking_info_it_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Workshop.admission_price_info_fr'
        db.add_column(u'workshops_workshop', 'admission_price_info_fr',
        ...
        # Adding field 'Workshop.admission_price_info_fr_markup_type'
        db.add_column(u'workshops_workshop', 'admission_price_info_fr_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Workshop.admission_price_info_pl'
        db.add_column(u'workshops_workshop', 'admission_price_info_pl',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Admission price info', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.admission_price_info_pl_markup_type'
        db.add_column(u'workshops_workshop', 'admission_price_info_pl_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Workshop.admission_price_info_tr'
        db.add_column(u'workshops_workshop', 'admission_price_info_tr',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Admission price info', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.admission_price_info_tr_markup_type'
        db.add_column(u'workshops_workshop', 'admission_price_info_tr_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Workshop.admission_price_info_es'
        db.add_column(u'workshops_workshop', 'admission_price_info_es',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Admission price info', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.admission_price_info_es_markup_type'
        db.add_column(u'workshops_workshop', 'admission_price_info_es_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Workshop.admission_price_info_it'
        db.add_column(u'workshops_workshop', 'admission_price_info_it',
                      self.gf('base_libs.models.fields.ExtendedTextField')(u'Admission price info', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, blank=True, unique=False, db_tablespace='', db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.admission_price_info_it_markup_type'
        db.add_column(u'workshops_workshop', 'admission_price_info_it_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Workshop.meeting_place_fr'
        db.add_column(u'workshops_workshop', 'meeting_place_fr',
                      self.gf('django.db.models.fields.CharField')(u'Meeting place', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.meeting_place_pl'
        db.add_column(u'workshops_workshop', 'meeting_place_pl',
                      self.gf('django.db.models.fields.CharField')(u'Meeting place', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.meeting_place_tr'
        db.add_column(u'workshops_workshop', 'meeting_place_tr',
                      self.gf('django.db.models.fields.CharField')(u'Meeting place', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.meeting_place_es'
        db.add_column(u'workshops_workshop', 'meeting_place_es',
                      self.gf('django.db.models.fields.CharField')(u'Meeting place', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'Workshop.meeting_place_it'
        db.add_column(u'workshops_workshop', 'meeting_place_it',
                      self.gf('django.db.models.fields.CharField')(u'Meeting place', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=255, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'WorkshopType.title_fr'
        db.add_column(u'workshops_workshoptype', 'title_fr',
        ...
        # Adding field 'WorkshopType.title_pl'
        db.add_column(u'workshops_workshoptype', 'title_pl',
                      self.gf('django.db.models.fields.CharField')(u'Title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=200, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'WorkshopType.title_tr'
        db.add_column(u'workshops_workshoptype', 'title_tr',
                      self.gf('django.db.models.fields.CharField')(u'Title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=200, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'WorkshopType.title_es'
        db.add_column(u'workshops_workshoptype', 'title_es',
                      self.gf('django.db.models.fields.CharField')(u'Title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=200, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'WorkshopType.title_it'
        db.add_column(u'workshops_workshoptype', 'title_it',
                      self.gf('django.db.models.fields.CharField')(u'Title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=200, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
                # Deleting field 'Workshop.workshop_type_fr'
        db.delete_column(u'workshops_workshop', 'workshop_type_fr')

        # Deleting field 'Workshop.workshop_type_pl'
        db.delete_column(u'workshops_workshop', 'workshop_type_pl')

        # Deleting field 'Workshop.workshop_type_tr'
        db.delete_column(u'workshops_workshop', 'workshop_type_tr')

        # Deleting field 'Workshop.workshop_type_es'
        db.delete_column(u'workshops_workshop', 'workshop_type_es')

        # Deleting field 'Workshop.workshop_type_it'
        db.delete_column(u'workshops_workshop', 'workshop_type_it')

        # Deleting field 'Workshop.subtitle_fr'
        db.delete_column(u'workshops_workshop', 'subtitle_fr')

        # Deleting field 'Workshop.subtitle_pl'
        db.delete_column(u'workshops_workshop', 'subtitle_pl')

        # Deleting field 'Workshop.subtitle_tr'
        db.delete_column(u'workshops_workshop', 'subtitle_tr')

        # Deleting field 'Workshop.subtitle_es'
        db.delete_column(u'workshops_workshop', 'subtitle_es')

        # Deleting field 'Workshop.subtitle_it'
        db.delete_column(u'workshops_workshop', 'subtitle_it')

        # Deleting field 'Workshop.title_fr'
        db.delete_column(u'workshops_workshop', 'title_fr')

        # Deleting field 'Workshop.title_pl'
        db.delete_column(u'workshops_workshop', 'title_pl')

        # Deleting field 'Workshop.title_tr'
        db.delete_column(u'workshops_workshop', 'title_tr')

        # Deleting field 'Workshop.title_es'
        db.delete_column(u'workshops_workshop', 'title_es')

        # Deleting field 'Workshop.title_it'
        db.delete_column(u'workshops_workshop', 'title_it')

        # Deleting field 'Workshop.press_text_fr'
        db.delete_column(u'workshops_workshop', 'press_text_fr')

        # Deleting field 'Workshop.press_text_fr_markup_type'
        db.delete_column(u'workshops_workshop', 'press_text_fr_markup_type')

        # Deleting field 'Workshop.press_text_pl'
        db.delete_column(u'workshops_workshop', 'press_text_pl')

        # Deleting field 'Workshop.press_text_pl_markup_type'
        db.delete_column(u'workshops_workshop', 'press_text_pl_markup_type')

        # Deleting field 'Workshop.press_text_tr'
        db.delete_column(u'workshops_workshop', 'press_text_tr')

        # Deleting field 'Workshop.press_text_tr_markup_type'
        db.delete_column(u'workshops_workshop', 'press_text_tr_markup_type')

        # Deleting field 'Workshop.press_text_es'
        db.delete_column(u'workshops_workshop', 'press_text_es')

        # Deleting field 'Workshop.press_text_es_markup_type'
        db.delete_column(u'workshops_workshop', 'press_text_es_markup_type')

        # Deleting field 'Workshop.press_text_it'
        db.delete_column(u'workshops_workshop', 'press_text_it')

        # Deleting field 'Workshop.press_text_it_markup_type'
        db.delete_column(u'workshops_workshop', 'press_text_it_markup_type')

        # Deleting field 'Workshop.website_fr'
        db.delete_column(u'workshops_workshop', 'website_fr')

        # Deleting field 'Workshop.website_pl'
        db.delete_column(u'workshops_workshop', 'website_pl')

        # Deleting field 'Workshop.website_tr'
        db.delete_column(u'workshops_workshop', 'website_tr')

        # Deleting field 'Workshop.website_es'
        db.delete_column(u'workshops_workshop', 'website_es')

        # Deleting field 'Workshop.website_it'
        db.delete_column(u'workshops_workshop', 'website_it')

        # Deleting field 'Workshop.description_fr'
        db.delete_column(u'workshops_workshop', 'description_fr')

        # Deleting field 'Workshop.description_fr_markup_type'
        db.delete_column(u'workshops_workshop', 'description_fr_markup_type')

        # Deleting field 'Workshop.description_pl'
        db.delete_column(u'workshops_workshop', 'description_pl')

        # Deleting field 'Workshop.description_pl_markup_type'
        db.delete_column(u'workshops_workshop', 'description_pl_markup_type')

        # Deleting field 'Workshop.description_tr'
        db.delete_column(u'workshops_workshop', 'description_tr')

        # Deleting field 'Workshop.description_tr_markup_type'
        db.delete_column(u'workshops_workshop', 'description_tr_markup_type')

        # Deleting field 'Workshop.description_es'
        db.delete_column(u'workshops_workshop', 'description_es')

        # Deleting field 'Workshop.description_es_markup_type'
        db.delete_column(u'workshops_workshop', 'description_es_markup_type')

        # Deleting field 'Workshop.description_it'
        db.delete_column(u'workshops_workshop', 'description_it')

        # Deleting field 'Workshop.description_it_markup_type'
        db.delete_column(u'workshops_workshop', 'description_it_markup_type')

        # Deleting field 'Workshop.booking_info_fr'
        db.delete_column(u'workshops_workshop', 'booking_info_fr')

        # Deleting field 'Workshop.booking_info_fr_markup_type'
        db.delete_column(u'workshops_workshop', 'booking_info_fr_markup_type')

        # Deleting field 'Workshop.booking_info_pl'
        db.delete_column(u'workshops_workshop', 'booking_info_pl')

        # Deleting field 'Workshop.booking_info_pl_markup_type'
        db.delete_column(u'workshops_workshop', 'booking_info_pl_markup_type')

        # Deleting field 'Workshop.booking_info_tr'
        db.delete_column(u'workshops_workshop', 'booking_info_tr')

        # Deleting field 'Workshop.booking_info_tr_markup_type'
        db.delete_column(u'workshops_workshop', 'booking_info_tr_markup_type')

        # Deleting field 'Workshop.booking_info_es'
        db.delete_column(u'workshops_workshop', 'booking_info_es')

        # Deleting field 'Workshop.booking_info_es_markup_type'
        db.delete_column(u'workshops_workshop', 'booking_info_es_markup_type')

        # Deleting field 'Workshop.booking_info_it'
        db.delete_column(u'workshops_workshop', 'booking_info_it')

        # Deleting field 'Workshop.booking_info_it_markup_type'
        db.delete_column(u'workshops_workshop', 'booking_info_it_markup_type')

        # Deleting field 'Workshop.admission_price_info_fr'
        db.delete_column(u'workshops_workshop', 'admission_price_info_fr')

        # Deleting field 'Workshop.admission_price_info_fr_markup_type'
        db.delete_column(u'workshops_workshop', 'admission_price_info_fr_markup_type')

        # Deleting field 'Workshop.admission_price_info_pl'
        db.delete_column(u'workshops_workshop', 'admission_price_info_pl')

        # Deleting field 'Workshop.admission_price_info_pl_markup_type'
        db.delete_column(u'workshops_workshop', 'admission_price_info_pl_markup_type')

        # Deleting field 'Workshop.admission_price_info_tr'
        db.delete_column(u'workshops_workshop', 'admission_price_info_tr')

        # Deleting field 'Workshop.admission_price_info_tr_markup_type'
        db.delete_column(u'workshops_workshop', 'admission_price_info_tr_markup_type')

        # Deleting field 'Workshop.admission_price_info_es'
        db.delete_column(u'workshops_workshop', 'admission_price_info_es')

        # Deleting field 'Workshop.admission_price_info_es_markup_type'
        db.delete_column(u'workshops_workshop', 'admission_price_info_es_markup_type')

        # Deleting field 'Workshop.admission_price_info_it'
        db.delete_column(u'workshops_workshop', 'admission_price_info_it')

        # Deleting field 'Workshop.admission_price_info_it_markup_type'
        db.delete_column(u'workshops_workshop', 'admission_price_info_it_markup_type')

        # Deleting field 'Workshop.meeting_place_fr'
        db.delete_column(u'workshops_workshop', 'meeting_place_fr')

        # Deleting field 'Workshop.meeting_place_pl'
        db.delete_column(u'workshops_workshop', 'meeting_place_pl')

        # Deleting field 'Workshop.meeting_place_tr'
        db.delete_column(u'workshops_workshop', 'meeting_place_tr')

        # Deleting field 'Workshop.meeting_place_es'
        db.delete_column(u'workshops_workshop', 'meeting_place_es')

        # Deleting field 'Workshop.meeting_place_it'
        db.delete_column(u'workshops_workshop', 'meeting_place_it')

        # Deleting field 'WorkshopType.title_fr'
        db.delete_column(u'workshops_workshoptype', 'title_fr')

        # Deleting field 'WorkshopType.title_pl'
        db.delete_column(u'workshops_workshoptype', 'title_pl')

        # Deleting field 'WorkshopType.title_tr'
        db.delete_column(u'workshops_workshoptype', 'title_tr')

        # Deleting field 'WorkshopType.title_es'
        db.delete_column(u'workshops_workshoptype', 'title_es')

        # Deleting field 'WorkshopType.title_it'
        db.delete_column(u'workshops_workshoptype', 'title_it')
    ...
    models = {
        ...
        u'workshops.mediafile': {
            'Meta': {'ordering': "['sort_order', 'creation_date']", 'object_name': 'MediaFile'},
            'creation_date': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'path': ('filebrowser.fields.FileBrowseField', [], {'directory': "'workshops/'", 'max_length': '255'}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'default': 'None'}),
            'workshop': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['workshops.Workshop']"})
        },
        u'workshops.organizer': {
            ...
            'organizing_museum': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'workshop_organizer'", 'null': 'True', 'to': u"orm['museums.Museum']"}),
            'workshop': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['workshops.Workshop']"})
        },
        u'workshops.workshop': {
            'Meta': {'ordering': "['title', 'creation_date']", 'object_name': 'Workshop'},
            'admission_price': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '5', 'decimal_places': '2', 'blank': 'True'}),
            'admission_price_info': ('base_libs.models.fields.MultilingualTextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            'admission_price_info_de': ('base_libs.models.fields.ExtendedTextField', ["u'Admission price info'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'admission_price_info_de_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            ...
            'booking_info_de': ('base_libs.models.fields.ExtendedTextField', ["u'Booking info'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'booking_info_de_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            'booking_info_en': ('base_libs.models.fields.ExtendedTextField', ["u'Booking info'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'booking_info_en_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            'booking_info_es': ('base_libs.models.fields.ExtendedTextField', ["u'Booking info'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'booking_info_es_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            'booking_info_fr': ('base_libs.models.fields.ExtendedTextField', ["u'Booking info'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'booking_info_fr_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            'booking_info_it': ('base_libs.models.fields.ExtendedTextField', ["u'Booking info'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'booking_info_it_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            'booking_info_pl': ('base_libs.models.fields.ExtendedTextField', ["u'Booking info'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'booking_info_pl_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            'booking_info_tr': ('base_libs.models.fields.ExtendedTextField', ["u'Booking info'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'booking_info_tr_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            'city': ('django.db.models.fields.CharField', [], {'default': "'Berlin'", 'max_length': '255', 'blank': 'True'}),
            'closest_workshop_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'closest_workshop_time': ('django.db.models.fields.TimeField', [], {'null': 'True', 'blank': 'True'}),
            'country': ('django.db.models.fields.CharField', [], {'default': "'de'", 'max_length': '255', 'blank': 'True'}),
            'creation_date': ('django.db.models.fields.DateTimeField', [], {}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'workshop_creator'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'description': ('base_libs.models.fields.MultilingualTextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            'description_de': ('base_libs.models.fields.ExtendedTextField', ["u'Description'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'description_de_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            'description_en': ('base_libs.models.fields.ExtendedTextField', ["u'Description'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            ...
            'has_group_offer': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('filebrowser.fields.FileBrowseField', [], {'directory': "'workshops/'", 'max_length': '200', 'extensions': "['.jpg', '.jpeg', '.gif', '.png', '.tif', '.tiff']", 'blank': 'True'}),
            'is_for_blind': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_for_deaf': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_for_dementia_sufferers': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_for_families': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_for_learning_difficulties': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_for_preschool': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_for_primary_school': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_for_wheelchaired': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_for_youth': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'meeting_place_es': ('django.db.models.fields.CharField', ["u'Meeting place'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'meeting_place_fr': ('django.db.models.fields.CharField', ["u'Meeting place'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'meeting_place_it': ('django.db.models.fields.CharField', ["u'Meeting place'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'meeting_place_pl': ('django.db.models.fields.CharField', ["u'Meeting place'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'meeting_place_tr': ('django.db.models.fields.CharField', ["u'Meeting place'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'modifier': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'workshop_modifier'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'museum': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['museums.Museum']", 'null': 'True', 'blank': 'True'}),
            ...
            'title_pl': ('django.db.models.fields.CharField', ["u'Title'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'title_tr': ('django.db.models.fields.CharField', ["u'Title'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'types': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['workshops.WorkshopType']", 'symmetrical': 'False'}),
            'website': ('base_libs.models.fields.MultilingualCharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'website_de': ('django.db.models.fields.CharField', ["u'Website'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'website_en': ('django.db.models.fields.CharField', ["u'Website'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'website_es': ('django.db.models.fields.CharField', ["u'Website'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            ...
            'website_pl': ('django.db.models.fields.CharField', ["u'Website'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'website_tr': ('django.db.models.fields.CharField', ["u'Website'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'workshop_type': ('base_libs.models.fields.MultilingualCharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'workshop_type_de': ('django.db.models.fields.CharField', ["u'Type'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'workshop_type_en': ('django.db.models.fields.CharField', ["u'Type'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'workshop_type_es': ('django.db.models.fields.CharField', ["u'Type'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'workshop_type_fr': ('django.db.models.fields.CharField', ["u'Type'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'workshop_type_it': ('django.db.models.fields.CharField', ["u'Type'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'workshop_type_pl': ('django.db.models.fields.CharField', ["u'Type'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
            'workshop_type_tr': ('django.db.models.fields.CharField', ["u'Type'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'})
        },
        u'workshops.workshoptime': {
            'Meta': {'ordering': "('workshop_date', 'start')", 'object_name': 'WorkshopTime'},
        ...
        u'workshops.workshoptype': {
            'Meta': {'ordering': "['title_de']", 'object_name': 'WorkshopType'},
            'creation_date': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '255'}),
