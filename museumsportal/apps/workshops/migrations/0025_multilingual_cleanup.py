...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Deleting field 'Workshop.press_text_markup_type'
        db.delete_column(u'workshops_workshop', 'press_text_markup_type')

        # Deleting field 'Workshop.booking_info_markup_type'
        db.delete_column(u'workshops_workshop', 'booking_info_markup_type')

        # Deleting field 'Workshop.description_markup_type'
        db.delete_column(u'workshops_workshop', 'description_markup_type')

        # Deleting field 'Workshop.admission_price_info_markup_type'
        db.delete_column(u'workshops_workshop', 'admission_price_info_markup_type')


        # Changing field 'Workshop.description_de'
        db.alter_column(u'workshops_workshop', 'description_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Description', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Workshop.booking_info_de'
        db.alter_column(u'workshops_workshop', 'booking_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Booking info', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Workshop.press_text_en'
        db.alter_column(u'workshops_workshop', 'press_text_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Press text', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Workshop.admission_price_info_en'
        db.alter_column(u'workshops_workshop', 'admission_price_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Admission price info', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Workshop.description_en'
        db.alter_column(u'workshops_workshop', 'description_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Description', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Workshop.press_text_de'
        db.alter_column(u'workshops_workshop', 'press_text_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Press text', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Workshop.admission_price_info_de'
        db.alter_column(u'workshops_workshop', 'admission_price_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Admission price info', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Workshop.booking_info_en'
        db.alter_column(u'workshops_workshop', 'booking_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Booking info', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))
    
    
    def backwards(self, orm):
                # Adding field 'Workshop.press_text_markup_type'
        db.add_column(u'workshops_workshop', 'press_text_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Workshop.booking_info_markup_type'
        db.add_column(u'workshops_workshop', 'booking_info_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Workshop.description_markup_type'
        db.add_column(u'workshops_workshop', 'description_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)

        # Adding field 'Workshop.admission_price_info_markup_type'
        db.add_column(u'workshops_workshop', 'admission_price_info_markup_type',
                      self.gf('django.db.models.fields.CharField')('Markup type', default='pt', max_length=10, blank=False),
                      keep_default=False)


        # Changing field 'Workshop.description_de'
        db.alter_column(u'workshops_workshop', 'description_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Beschreibung', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Workshop.booking_info_de'
        db.alter_column(u'workshops_workshop', 'booking_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Buchungsinformation', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Workshop.press_text_en'
        db.alter_column(u'workshops_workshop', 'press_text_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Pressetext', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Workshop.admission_price_info_en'
        db.alter_column(u'workshops_workshop', 'admission_price_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintrittpreis Infotext', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Workshop.description_en'
        db.alter_column(u'workshops_workshop', 'description_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Beschreibung', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Workshop.press_text_de'
        db.alter_column(u'workshops_workshop', 'press_text_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Pressetext', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Workshop.admission_price_info_de'
        db.alter_column(u'workshops_workshop', 'admission_price_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Eintrittpreis Infotext', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Workshop.booking_info_en'
        db.alter_column(u'workshops_workshop', 'booking_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Buchungsinformation', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))
