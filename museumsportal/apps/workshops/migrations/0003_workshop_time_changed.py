...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Workshop.start'
        db.delete_column('workshops_workshop', 'start')

        # Deleting field 'Workshop.workshop_date'
        db.delete_column('workshops_workshop', 'workshop_date')

        # Deleting field 'Workshop.end'
        db.delete_column('workshops_workshop', 'end')

        # Deleting field 'WorkshopTime.start_ii'
        db.delete_column('workshops_workshoptime', 'start_ii')

        # Deleting field 'WorkshopTime.start_hh'
        db.delete_column('workshops_workshoptime', 'start_hh')

        # Deleting field 'WorkshopTime.end_yyyy'
        db.delete_column('workshops_workshoptime', 'end_yyyy')

        # Deleting field 'WorkshopTime.end_hh'
        db.delete_column('workshops_workshoptime', 'end_hh')

        # Deleting field 'WorkshopTime.end_ii'
        db.delete_column('workshops_workshoptime', 'end_ii')

        # Deleting field 'WorkshopTime.start_dd'
        db.delete_column('workshops_workshoptime', 'start_dd')

        # Deleting field 'WorkshopTime.end_dd'
        db.delete_column('workshops_workshoptime', 'end_dd')

        # Deleting field 'WorkshopTime.end_mm'
        db.delete_column('workshops_workshoptime', 'end_mm')

        # Deleting field 'WorkshopTime.start_yyyy'
        db.delete_column('workshops_workshoptime', 'start_yyyy')

        # Deleting field 'WorkshopTime.start_mm'
        db.delete_column('workshops_workshoptime', 'start_mm')

        # Deleting field 'WorkshopTime.is_all_day'
        db.delete_column('workshops_workshoptime', 'is_all_day')

        # Adding field 'WorkshopTime.workshop_date'
        db.add_column('workshops_workshoptime', 'workshop_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2013, 1, 25)), keep_default=False)

        # Changing field 'WorkshopTime.start'
        db.alter_column('workshops_workshoptime', 'start', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'WorkshopTime.end'
        db.alter_column('workshops_workshoptime', 'end', self.gf('django.db.models.fields.TimeField')(null=True))
    ...
    models = {
        ...
        'workshops.workshop': {
            ...
            'categories': ('mptt.fields.TreeManyToManyField', [], {'to': "orm['workshops.WorkshopCategory']", 'symmetrical': 'False'}),
            'city': ('django.db.models.fields.CharField', [], {'default': "'Berlin'", 'max_length': '255', 'blank': 'True'}),
            'country': ('django.db.models.fields.CharField', [], {'default': "'de'", 'max_length': '255', 'blank': 'True'}),
            'creation_date': ('django.db.models.fields.DateTimeField', [], {}),
