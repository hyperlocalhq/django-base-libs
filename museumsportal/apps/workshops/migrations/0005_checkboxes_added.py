...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Workshop.has_group_offer'
        db.add_column('workshops_workshop', 'has_group_offer', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Workshop.is_for_families'
        db.add_column('workshops_workshop', 'is_for_families', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Workshop.is_for_disabled'
        db.add_column('workshops_workshop', 'is_for_disabled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Workshop.is_for_wheelchaired'
        db.add_column('workshops_workshop', 'is_for_wheelchaired', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Workshop.is_for_deaf'
        db.add_column('workshops_workshop', 'is_for_deaf', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Workshop.is_for_blind'
        db.add_column('workshops_workshop', 'is_for_blind', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Workshop.is_for_learning_difficulties'
        db.add_column('workshops_workshop', 'is_for_learning_difficulties', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'Workshop.admission_price_info_de'
        db.alter_column('workshops_workshop', 'admission_price_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Preisinformation', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Workshop.booking_info_de'
        db.alter_column('workshops_workshop', 'booking_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Buchungsinformation', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Workshop.admission_price_info_en'
        db.alter_column('workshops_workshop', 'admission_price_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Preisinformation', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

        # Changing field 'Workshop.booking_info_en'
        db.alter_column('workshops_workshop', 'booking_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Buchungsinformation', unique_for_month=None, unique_for_date=None, primary_key=False, db_column=None, max_length=None, unique_for_year=None, rel=None, unique=False, db_tablespace=''))

    
    def backwards(self, orm):
        
        # Deleting field 'Workshop.has_group_offer'
        db.delete_column('workshops_workshop', 'has_group_offer')

        # Deleting field 'Workshop.is_for_families'
        db.delete_column('workshops_workshop', 'is_for_families')

        # Deleting field 'Workshop.is_for_disabled'
        db.delete_column('workshops_workshop', 'is_for_disabled')

        # Deleting field 'Workshop.is_for_wheelchaired'
        db.delete_column('workshops_workshop', 'is_for_wheelchaired')

        # Deleting field 'Workshop.is_for_deaf'
        db.delete_column('workshops_workshop', 'is_for_deaf')

        # Deleting field 'Workshop.is_for_blind'
        db.delete_column('workshops_workshop', 'is_for_blind')

        # Deleting field 'Workshop.is_for_learning_difficulties'
        db.delete_column('workshops_workshop', 'is_for_learning_difficulties')

        # Changing field 'Workshop.admission_price_info_de'
        db.alter_column('workshops_workshop', 'admission_price_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Admission price info', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Workshop.booking_info_de'
        db.alter_column('workshops_workshop', 'booking_info_de', self.gf('base_libs.models.fields.ExtendedTextField')(u'Booking info', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Workshop.admission_price_info_en'
        db.alter_column('workshops_workshop', 'admission_price_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Admission price info', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))

        # Changing field 'Workshop.booking_info_en'
        db.alter_column('workshops_workshop', 'booking_info_en', self.gf('base_libs.models.fields.ExtendedTextField')(u'Booking info', rel=None, unique_for_year=None, unique_for_date=None, unique_for_month=None, unique=False, primary_key=False, db_column=None, default='', max_length=None, db_tablespace=''))
    ...
    models = {
        ...
        'workshops.agegroup': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'AgeGroup'},
            'creation_date': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '255', 'db_index': 'True'}),
        ...
        'workshops.workshop': {
            ...
            'admission_price_info_en_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            'admission_price_info_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            'age_groups': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['workshops.AgeGroup']", 'symmetrical': 'False', 'blank': 'True'}),
            ...
            'categories': ('mptt.fields.TreeManyToManyField', [], {'to': "orm['workshops.WorkshopCategory']", 'symmetrical': 'False', 'blank': 'True'}),
            'city': ('django.db.models.fields.CharField', [], {'default': "'Berlin'", 'max_length': '255', 'blank': 'True'}),
            'country': ('django.db.models.fields.CharField', [], {'default': "'de'", 'max_length': '255', 'blank': 'True'}),
            'creation_date': ('django.db.models.fields.DateTimeField', [], {}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'workshop_creator'", 'null': 'True', 'to': "orm['auth.User']"}),
            'description': ('base_libs.models.fields.MultilingualTextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            'description_de': ('base_libs.models.fields.ExtendedTextField', ["u'Beschreibung'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            'description_de_markup_type': ('django.db.models.fields.CharField', ["'Markup type'"], {'default': "'pt'", 'max_length': '10', 'blank': 'False'}),
            'description_en': ('base_libs.models.fields.ExtendedTextField', ["u'Beschreibung'"], {'unique_for_month': 'None', 'unique_for_date': 'None', 'primary_key': 'False', 'db_column': 'None', 'max_length': 'None', 'unique_for_year': 'None', 'rel': 'None', 'blank': 'True', 'unique': 'False', 'db_tablespace': "''", 'db_index': 'False'}),
            ...
            'is_for_disabled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'modifier': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'workshop_modifier'", 'null': 'True', 'to': "orm['auth.User']"}),
            'museum': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['museums.Museum']", 'null': 'True', 'blank': 'True'}),
            'organizer_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'organizer_url_link': ('base_libs.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'organizing_museum': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'organized_workshops'", 'null': 'True', 'to': "orm['museums.Museum']"}),
        ...
        'workshops.workshopcategory': {
            'Meta': {'ordering': "['tree_id', 'lft']", 'object_name': 'WorkshopCategory'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'child_set'", 'null': 'True', 'to': "orm['workshops.WorkshopCategory']"}),
            'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '255', 'db_index': 'True'}),
            'title': ('base_libs.models.fields.MultilingualCharField', [], {'max_length': '255', 'null': 'True'}),
            'title_de': ('django.db.models.fields.CharField', ["u'title'"], {'null': 'False', 'primary_key': 'False', 'db_column': 'None', 'default': "''", 'editable': 'True', 'max_length': '255', 'db_tablespace': "''", 'blank': 'True', 'unique': 'False', 'db_index': 'False'}),
