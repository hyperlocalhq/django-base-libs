...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MailingContentBlock.sort_order'
        db.add_column('mailchimp_mailingcontentblock', 'sort_order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'MailingContentBlock.sort_order'
        db.delete_column('mailchimp_mailingcontentblock', 'sort_order')
