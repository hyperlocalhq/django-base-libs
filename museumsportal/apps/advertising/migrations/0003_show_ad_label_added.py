...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'AdBase.show_ad_label'
        db.add_column(u'advertising_adbase', 'show_ad_label',
    ...
    def backwards(self, orm):
                # Deleting field 'AdBase.show_ad_label'
        db.delete_column(u'advertising_adbase', 'show_ad_label')
