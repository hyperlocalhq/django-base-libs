...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
                # Adding field 'AdBase.impressions_stats'
        db.add_column(u'advertising_adbase', 'impressions_stats',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'AdBase.clicks_stats'
        db.add_column(u'advertising_adbase', 'clicks_stats',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
                # Deleting field 'AdBase.impressions_stats'
        db.delete_column(u'advertising_adbase', 'impressions_stats')

        # Deleting field 'AdBase.clicks_stats'
        db.delete_column(u'advertising_adbase', 'clicks_stats')
