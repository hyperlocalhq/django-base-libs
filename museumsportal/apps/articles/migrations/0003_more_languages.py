...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArticleType.title_fr'
        db.add_column(u'articles_articletype', 'title_fr',
        ...
        # Adding field 'ArticleType.title_pl'
        db.add_column(u'articles_articletype', 'title_pl',
                      self.gf('django.db.models.fields.CharField')(u'title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=512, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'ArticleType.title_tr'
        db.add_column(u'articles_articletype', 'title_tr',
                      self.gf('django.db.models.fields.CharField')(u'title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=512, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'ArticleType.title_es'
        db.add_column(u'articles_articletype', 'title_es',
                      self.gf('django.db.models.fields.CharField')(u'title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=512, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'ArticleType.title_it'
        db.add_column(u'articles_articletype', 'title_it',
                      self.gf('django.db.models.fields.CharField')(u'title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=512, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'ArticleCategory.title_fr'
        db.add_column(u'articles_articlecategory', 'title_fr',
                      self.gf('django.db.models.fields.CharField')(u'title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=512, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'ArticleCategory.title_pl'
        db.add_column(u'articles_articlecategory', 'title_pl',
                      self.gf('django.db.models.fields.CharField')(u'title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=512, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'ArticleCategory.title_tr'
        db.add_column(u'articles_articlecategory', 'title_tr',
                      self.gf('django.db.models.fields.CharField')(u'title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=512, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'ArticleCategory.title_es'
        db.add_column(u'articles_articlecategory', 'title_es',
                      self.gf('django.db.models.fields.CharField')(u'title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=512, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)

        # Adding field 'ArticleCategory.title_it'
        db.add_column(u'articles_articlecategory', 'title_it',
                      self.gf('django.db.models.fields.CharField')(u'title', null=False, primary_key=False, db_column=None, default='', editable=True, max_length=512, db_tablespace='', blank=True, unique=False, db_index=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArticleType.title_fr'
        db.delete_column(u'articles_articletype', 'title_fr')

        # Deleting field 'ArticleType.title_pl'
        db.delete_column(u'articles_articletype', 'title_pl')

        # Deleting field 'ArticleType.title_tr'
        db.delete_column(u'articles_articletype', 'title_tr')

        # Deleting field 'ArticleType.title_es'
        db.delete_column(u'articles_articletype', 'title_es')

        # Deleting field 'ArticleType.title_it'
        db.delete_column(u'articles_articletype', 'title_it')

        # Deleting field 'ArticleCategory.title_fr'
        db.delete_column(u'articles_articlecategory', 'title_fr')

        # Deleting field 'ArticleCategory.title_pl'
        db.delete_column(u'articles_articlecategory', 'title_pl')

        # Deleting field 'ArticleCategory.title_tr'
        db.delete_column(u'articles_articlecategory', 'title_tr')

        # Deleting field 'ArticleCategory.title_es'
        db.delete_column(u'articles_articlecategory', 'title_es')

        # Deleting field 'ArticleCategory.title_it'
        db.delete_column(u'articles_articlecategory', 'title_it')
    ...
    models = {
        u'articles.article': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'article_author'", 'null': 'True', 'to': u"orm['auth.User']"}),
