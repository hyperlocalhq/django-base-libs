...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('articles_articlecategory', south_cleaned_fields((
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('modified_date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=255, db_index=True)),
        ...
        db.create_table('cmsplugin_articleselection', south_cleaned_fields((
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('article', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['articles.Article'])),
        )))
        db.send_create_signal('articles', ['ArticleSelection'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('cmsplugin_articleselection')
    ...
    models = {
        'articles.article': {
            ...
            'category': ('mptt.fields.TreeForeignKey', [], {'to': "orm['articles.ArticleCategory']", 'null': 'True', 'blank': 'True'}),
        ...
        'articles.articlecategory': {
            ...
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'child_set'", 'null': 'True', 'to': "orm['articles.ArticleCategory']"}),
        ...
        'articles.articleselection': {
            'Meta': {'object_name': 'ArticleSelection', 'db_table': "'cmsplugin_articleselection'", '_ormbases': ['cms.CMSPlugin']},
