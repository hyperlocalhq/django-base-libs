...
class KarmaScoreManager(models.Manager):
    def vote(self, user_id, comment_id, score):
        try:
            ...
            karma = self.model(None, user_id=user_id, comment_id=comment_id, score=score, scored_date=tz_now())
            karma.save()
        else:
            karma.score = score
...
class ModeratorDeletion(models.Model):
    ...
    deletion_reason = models.ForeignKey("comments.ModeratorDeletionReason", verbose_name='deletion reason')
