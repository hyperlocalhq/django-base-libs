...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm.ModeratorDeletionReason(
            id=1,
            title_en="Terms of use violated",
            title_de="Verletzung der Nutzungsbedingungen",
            reason_en="This comment has been unpublished by the administrator because of violation of the terms of use.",
            reason_de="Dieser Beitrag hat die Nutzungsbedingungen der Seite verletzt und wurde vom Administrator entfernt.",
            reason_en_markup_type="pt",
            reason_de_markup_type="pt",
            ).save()
