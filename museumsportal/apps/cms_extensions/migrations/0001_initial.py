    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(default='de', max_length=5, verbose_name='Language', choices=[('de', 'Deutsch'), ('en', 'English'), ('fr', 'Fran\xe7ais'), ('pl', 'Polski'), ('tr', 'T\xfcrk\xe7e'), ('es', 'Espa\xf1ol'), ('it', 'Italiano')])),
