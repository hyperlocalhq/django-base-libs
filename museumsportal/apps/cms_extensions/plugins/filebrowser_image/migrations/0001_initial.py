...
from museumsportal.apps.cms_extensions.plugins.filebrowser_image.models import *
...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_filebrowserimage', south_cleaned_fields((
            ('cmsplugin_ptr', orm['filebrowser_image.FilebrowserImage:cmsplugin_ptr']),
            ('image', orm['filebrowser_image.FilebrowserImage:image']),
            ('alt', orm['filebrowser_image.FilebrowserImage:alt']),
        )))
        db.send_create_signal('filebrowser_image', ['FilebrowserImage'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('cmsplugin_filebrowserimage')
    ...
    models = {
        ...
        'filebrowser_image.filebrowserimage': {
            'Meta': {'db_table': "'cmsplugin_filebrowserimage'"},
            'alt': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'image': ('FileBrowseField', [], {'extensions': "['.jpg','.jpeg','.gif','.png','.tif','.tiff']", 'max_length': '255'})
        },
        'sites.site': {
