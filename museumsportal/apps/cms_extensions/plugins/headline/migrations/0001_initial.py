...
from museumsportal.apps.cms_extensions.plugins.headline.models import *
...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_headline', south_cleaned_fields((
            ('cmsplugin_ptr', orm['headline.Headline:cmsplugin_ptr']),
            ('title', orm['headline.Headline:title']),
            ('subtitle', orm['headline.Headline:subtitle']),
        )))
        db.send_create_signal('headline', ['Headline'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('cmsplugin_headline')
    ...
    models = {
        ...
        'headline.headline': {
            'Meta': {'db_table': "'cmsplugin_headline'"},
