/* 
 * bootstrap-jetson-datepicker.js 
 *
        ...
        + '<div class="inner">'
            + '<div id="picker">'
                ...
                + '<footer class="clearfix">'
                    + '<button class="cancel right">Schließen</button>'
                    + '<button class="done btn-primary">Bestätigen</button>'
                + '</footer>'
            + '</div>'
        + '</div>'
    + '</div>';
    ...
    $.fn.extend({ 
        ...
        datepicker: function(options) {
            ...
            return this.each(function() {
                var $input = $(this);
                if ($input.data('datepicker-applied')) {
                    return;
                }
                ...
                $('<span class="input-group-btn"><button class="btn btn-lg btn-icon btn-info pick-date" type="button"><span class="icon icon-calendar"></span></button></span>').insertAfter(this).find('button').click(function() {
                    ...
                    var oDatepicker = new Datepicker($input, $picker, settings);
                ...
                $input.data('datepicker-applied', true);
            });
        }
    });
