 ...
 */ (function (au, k) {
    ...
    var T = {};
    T.markup = '<div id="sb-container"><div id="sb-overlay"></div><a id="sb-nav-close" title="{close}" onclick="Shadowbox.close()"><span></span></a><div id="sb-nav"><a id="sb-nav-next" title="{next}" onclick="Shadowbox.next()"><span></span></a><a style="display: none" id="sb-nav-play" title="{play}" onclick="Shadowbox.play()"></a><a  style="display: none"id="sb-nav-pause" title="{pause}" onclick="Shadowbox.pause()"></a><a id="sb-nav-previous" title="{previous}" onclick="Shadowbox.previous()"><span></span></a></div><div id="sb-wrapper"><div id="sb-wrapper-inner"><div id="sb-body"><div id="sb-body-inner"></div><div id="sb-loading"><div id="sb-loading-inner"><span>{loading}</span></div></div></div></div><div id="sb-info"><div id="sb-info-inner"><div id="sb-title"><div id="sb-title-inner"></div><div id="sb-counter"></div></div></div></div></div></div>';
    T.options = {
        animSequence: "sync",
        counterLimit: 10,
        counterType: "default",
