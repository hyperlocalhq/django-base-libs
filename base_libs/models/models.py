...
class HierarchyMixinManager(models.Manager):
    ...
    def get_roots(self):
        ...
        if roots.count() > 0:
            ...
            raise RootDoesNotExist, ugettext('Roots Node does not exist. Please create one.')
...
class OpeningHoursMixin(BaseModel):
    ...
    tue_break_close = models.TimeField(_('Break Starts on Tuesday'), blank=True, null=True)
    ...
    wed_break_close = models.TimeField(_('Break Starts on Wednesday'), blank=True, null=True)
    wed_break_open = models.TimeField(_('Break Ends on Wednesday'), blank=True, null=True)
    ...
    thu_break_close = models.TimeField(_('Break Starts on Thursday'), blank=True, null=True)
    thu_break_open = models.TimeField(_('Break Ends on Thursday'), blank=True, null=True)
    ...
    fri_break_close = models.TimeField(_('Break Starts on Friday'), blank=True, null=True)
    ...
    sat_break_close = models.TimeField(_('Break Starts on Saturday'), blank=True, null=True)
    sat_break_open = models.TimeField(_('Break Ends on Saturday'), blank=True, null=True)
    ...
    sun_break_close = models.TimeField(_('Break Starts on Sunday'), blank=True, null=True)
