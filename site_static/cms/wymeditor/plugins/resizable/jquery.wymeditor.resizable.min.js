 ...
 */WYMeditor.editor.prototype.resizable=function(e){var t=this,n=jQuery(t._box).find("iframe"),r=jQuery(t._box).find(".wym_iframe"),i={},s={resize:function(){r.height(n.height())},alsoResize:n,handles:"s,e,se",minHeight:250},o=jQuery.extend(s,e);jQuery.isFunction(jQuery.fn.resizable)?jQuery(t._box).resizable(o):WYMeditor.console.error("Oops, jQuery UI.resizable unavailable.")};