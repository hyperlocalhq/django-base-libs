...
_(u"Minimal size is 330 px of width.")
            ...
            <div class="row row-md">
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    ...
                    {% if not media_file.path %}
                        ...
                        <p id="image_help_text" class="help-block">{% trans "Available formats are JPG, GIF, and PNG." %}<br/>{% trans "Minimal size is 330 px of width." %} {% trans "Optimal size is 680 × 375 px (min)." %}</p>
                    {% endif %}
                </div>
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    {% if media_file.path %}
...
class PDFForm(forms.Form):
    ...
    def __init__(self, media_file_obj=None, *args, **kwargs):
        ...
        for lang_code, lang_name in settings.FRONTEND_LANGUAGES:
            ...
            self.fields['description_%s' % lang_code] = forms.CharField(
                label=_('Description <span class="lang">%s</span>') %
                lang_code.upper(),
                required=False,
                widget=forms.Textarea(),
            )
