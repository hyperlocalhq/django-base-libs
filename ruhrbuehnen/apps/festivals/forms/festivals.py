...
from ruhrbuehnen.apps.festivals.models import Festival, Image, SocialMediaChannel
    ...
    def __init__(self, *args, **kwargs):
        ...
        layout_blocks.append(
            layout.Fieldset(
                ...
                layout.Row(
                    layout.Div(
                        layout.Field("start", placeholder="YYYY-MM-DD"),
                        css_class="col-xs-6 col-sm-6 col-md-6 col-lg-6"
                    ),
                    layout.Div(
                        layout.Field("end", placeholder="YYYY-MM-DD"),
                        css_class="col-xs-6 col-sm-6 col-md-6 col-lg-6"
                    ),
                    css_class="row-md"
                ),
        ...
        layout_blocks.append(
            layout.Fieldset(
                ...
                layout.HTML(
                    """{% load i18n %}<div class="subtitle">{% trans "leave blank if you want to use organizer data" %}</div>"""
                ),
                layout.Row(
                    layout.Div(
                        "street_address",
        ...
        layout_blocks.append(
            layout.Fieldset(
                ...
                layout.Row(
                    ...
                    layout.Div(
                        layout.Field('press_website', placeholder="http://"),
                        css_class="col-xs-6 col-sm-6 col-md-6 col-lg-6"
                    ),
                    css_class="row-md"
                ),
                layout.Row(
                    ...
                    layout.Div(
                        layout.HTML(
                            '{% load i18n %}<div><label class="with">{% trans "Mobile" %}</label></div>'
                        ),
                        layout.Row(
                            layout.Div(
                                'press_mobile_country',
        ...
        if form_step_data[current_step]['logo_path']:
            ...
            filename = "".join(
                (
                    ...
                    ("000" + str(int(round(now.microsecond / 1000))))[-4:], fext
                )
            )
