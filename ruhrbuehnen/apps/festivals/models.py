...
class Festival(
    CreationModificationMixin, UrlMixin, SlugMixin(), OpeningHoursMixin
):
    ...
    tickets_street_address = models.CharField(
        _("Street address"), max_length=255, blank=True
    )
    tickets_street_address2 = models.CharField(
        _("Street address (second line)"), max_length=255, blank=True
    )
    tickets_postal_code = models.CharField(
        _("Postal code"), max_length=255, blank=True
    )
    tickets_city = models.CharField(
        _("City"), default="Berlin", max_length=255, blank=True
    )
    tickets_email = models.EmailField(
        _("Tickets Email"), max_length=255, blank=True
    )
    tickets_website = URLField("Tickets Website", blank=True)

    tickets_phone_country = models.CharField(
        _("Country Code"), max_length=4, blank=True, default="49"
    )
    tickets_phone_area = models.CharField(
        _("Area Code"), max_length=6, blank=True
    )
    tickets_phone_number = models.CharField(
        _("Subscriber Number and Extension"), max_length=25, blank=True
    )
    tickets_fax_country = models.CharField(
        _("Country Code"), max_length=4, blank=True, default="49"
    )
    tickets_fax_area = models.CharField(
        _("Area Code"), max_length=6, blank=True
    )
    tickets_fax_number = models.CharField(
        _("Subscriber Number and Extension"), max_length=25, blank=True
    )

    tickets_calling_prices = MultilingualTextField(
        _("Phone calling prices"), blank=True
    )

    press_contact_name = models.CharField(
        _("Press contact name"), max_length=255, blank=True
    )
    press_phone_country = models.CharField(
        _("Country Code"), max_length=4, blank=True, default="49"
    )
    press_phone_area = models.CharField(
        _("Area Code"), max_length=6, blank=True
    )
    press_phone_number = models.CharField(
        _("Subscriber Number and Extension"), max_length=25, blank=True
    )
    press_mobile_country = models.CharField(
        _("Country Code"), max_length=4, blank=True, default="49"
    )
    press_mobile_area = models.CharField(
        _("Area Code"), max_length=6, blank=True
    )
    press_mobile_number = models.CharField(
        _("Subscriber Number and Extension"), max_length=25, blank=True
    )
    press_fax_country = models.CharField(
        _("Country Code"), max_length=4, blank=True, default="49"
    )
    press_fax_area = models.CharField(_("Area Code"), max_length=6, blank=True)
    press_fax_number = models.CharField(
        _("Subscriber Number and Extension"), max_length=25, blank=True
    )
    press_email = models.EmailField(
        _("Press Email"), max_length=255, blank=True
    )
    ...
    organizers = models.ManyToManyField(
        "locations.Location", verbose_name=_("Organizers"), blank=True
    )
    ...
    def duplicate(self, new_values=None):
        ...
        target_festival.slug = get_unique_value(
            Festival, better_slugify(target_festival.title_de)
        )
        ...
        if source_festival.logo:
            target_festival.logo = source_festival.logo.path.replace(
    ...
    def is_editable(self, user=None):
        ...
        if not hasattr(self, "_is_editable_cache"):
            ...
            self._is_editable_cache = any(
                (location.is_editable() for location in self.organizers.all())
            )
