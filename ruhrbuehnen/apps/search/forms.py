    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = layout.Layout(
            layout.Fieldset(
                ...
                layout.Div(
                    layout.Field(
                        self.QUERY_PARAM_NAME, css_class="input-block-level"
                    ),
                    layout.Field(
                        self.MODELS_PARAM_NAME,
                        template=
                        "bootstrap/layout/dropdown_checkboxselectmultiple.html"
                    ),
                    css_class="input-block-wrapper"
                ),
                layout.Div(
                    layout.Submit('submit', _('search')), css_class="btn-group"
                ),
            ),
        )
