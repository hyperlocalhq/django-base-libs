...
class ArticleOptions(ExtendedModelAdmin):
    ...
    class Media:
        js = ("%sjs/AddFileBrowser.js" % URL_FILEBROWSER_MEDIA, )

    save_on_top = True

    list_display = [
        'id', 'title', 'author', 'published_from', 'published_till', 'views',
        'article_type', 'language', 'newsletter', 'status'
    ]
    list_display_links = ['title']
    list_filter = (
        'published_from', 'published_till', 'is_featured', 'article_type',
        'language', 'newsletter', 'status'
    )
