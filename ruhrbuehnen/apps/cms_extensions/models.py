...
class CMSPageOpenGraph(models.Model):
    page = models.ForeignKey(
        Page, verbose_name=_("Page"), related_name='open_graph'
    )
    og_title = models.CharField(_("Title"), blank=True, max_length=255)
    og_description = models.TextField(
        _("Description"), blank=True, help_text=_("No HTML and no new lines")
    )
    og_image = FileBrowseField(
    ...
    og_type = models.CharField(
        _("Type"), max_length=20, default="article", choices=OG_TYPE_CHOICES
    )
