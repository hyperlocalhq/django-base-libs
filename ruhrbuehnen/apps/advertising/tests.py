...
from ruhrbuehnen.apps.advertising.models import Advertiser, AdCategory, AdZone, AdBase
from ruhrbuehnen.apps.advertising.models import AdImpression, AdClick
from ruhrbuehnen.apps.advertising.managers import AdManager
from ruhrbuehnen.apps.advertising.templatetags.advertising_tags import random_zone_ad, random_category_ad
...
class AdManagerTestCase(TestCase):
    ...
    def test_manager_exists(self):
        # AdManager # TODO implement this test correctly
        pass
