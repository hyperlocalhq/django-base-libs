...
class EmailOrUsernameAuthentication(AuthenticationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = layout.Layout(
            ...
            bootstrap.FormActions(layout.Submit('submit', _('Login')), )
        )
...
class RegistrationForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = layout.Layout(
            ...
            bootstrap.FormActions(layout.Submit('submit', _('Signup')), )
        )
...
password_change_form_helper.layout = layout.Layout(
    ...
    bootstrap.FormActions(layout.Submit('submit', _('Confirm')), )
)
...
password_reset_form_helper.layout = layout.Layout(
    ...
    bootstrap.FormActions(layout.Submit('submit', _('Reset password')), )
)
...
password_reset_change_form_helper.layout = layout.Layout(
    ...
    bootstrap.FormActions(layout.Submit('submit', _('Change my password')), )
)
