...
from ruhrbuehnen.apps.slideshows.models import Slideshow
...
class SlideshowRenderer(template.Node):
    ...
    def render(self, context):
        ...
        slideshow, created = Slideshow.objects.get_or_create(sysname=sysname, )
        ...
        output = loader.render_to_string(
            template_path or "slideshows/top_slideshow.html", context_vars
        )
        context_vars.pop()
        return output
