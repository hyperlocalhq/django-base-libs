...
urlpatterns = patterns(
    'ruhrbuehnen.apps.education.views.projects',
...
urlpatterns += patterns(
    'ruhrbuehnen.apps.education.views.project_gallery',
    # videos
    url(
        r'^(?P<slug>[^/]+)/video/$',
        'video_overview',
        name='project_video_overview'
    ),
    url(
        r'^(?P<slug>[^/]+)/video/add/$',
        'create_update_video',
        name='project_add_video'
    ),
    url(
        r'^(?P<slug>[^/]+)/video/file_(?P<mediafile_token>[^/]+)/$',
        'create_update_video',
        name='project_change_video'
    ),
    url(
        r'^(?P<slug>[^/]+)/video/file_(?P<mediafile_token>[^/]+)/delete/$',
        'delete_video',
        name='project_delete_video'
    ),
    # images
    url(
        r'^(?P<slug>[^/]+)/gallery/$',
        'image_overview',
        name='project_image_overview'
    ),
    url(
    ...
    url(
        ...
        'create_update_image',
        name='project_change_image'
    ),
    url(
        r'^(?P<slug>[^/]+)/gallery/file_(?P<mediafile_token>[^/]+)/delete/$',
        'delete_image',
        name='project_delete_image'
    ),
    # pdfs
