...
@register.inclusion_tag(
    'education/includes/add_to_calender.html', takes_context=True
)
def add_to_calender_education(context, department, event):
    ...
    if description:
        description += "\n\n"
    description += context['request'].build_absolute_uri(
        project.get_url_path(event)
    )
...
@register.inclusion_tag(
    'education/includes/education_info.html', takes_context=True
)
