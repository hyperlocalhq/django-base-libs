...
from ruhrbuehnen.apps.locations.api.resources.v1 import StageResource
...
from ruhrbuehnen.apps.productions.models import ProductionSocialMediaChannel
...
from ruhrbuehnen.apps.productions.models import ProductionPDF
from ruhrbuehnen.apps.productions.models import ProductionLeadership
from ruhrbuehnen.apps.productions.models import ProductionAuthorship
from ruhrbuehnen.apps.productions.models import ProductionInvolvement
...
from ruhrbuehnen.apps.productions.models import EventSocialMediaChannel
...
from ruhrbuehnen.apps.productions.models import EventPDF
from ruhrbuehnen.apps.productions.models import EventLeadership
from ruhrbuehnen.apps.productions.models import EventAuthorship
from ruhrbuehnen.apps.productions.models import EventInvolvement
from ruhrbuehnen.apps.productions.models import EventSponsor

from ruhrbuehnen.apps.site_specific.functions import remove_copyright_label
...
class ProductionCategoryResource(ModelResource):
    ...
    class Meta(BaseMetaForModelResource):
        ...
        fields = [
            'id', 'title_de', 'title_en', 'creation_date', 'modified_date'
        ]
...
class ProductionImageResource(ModelResource):
    class Meta(BaseMetaForModelResource):
        queryset = ProductionImage.objects.exclude(
            copyright_restrictions="protected"
        )
    ...
    def get_object_list(self, request):
        object_list = super(ProductionImageResource,
    ...
    def dehydrate(self, bundle):
        if bundle.obj.path:
            ...
            try:
                ...
                copyright = remove_copyright_label(
                    strip_invalid_chars(file_description.author)
                )
...
class ProductionLeadershipResource(ModelResource):
    class Meta(BaseMetaForModelResource):
        ...
        fields = [
            'id', 'function_de', 'function_en', 'creation_date', 'modified_date'
        ]
...
class EventImageResource(ModelResource):
    class Meta(BaseMetaForModelResource):
        queryset = EventImage.objects.exclude(
            copyright_restrictions="protected"
        )
...
class EventResource(ModelResource):
    ...
    characteristics = fields.ToManyField(
        EventCharacteristicsResource, "characteristics", full=True
    )

    leaders = fields.ToManyField(
        EventLeadershipResource, "eventleadership_set", full=True
    )
    authors = fields.ToManyField(
        EventAuthorshipResource, "eventauthorship_set", full=True
    )
    participants = fields.ToManyField(
        EventInvolvementResource, "eventinvolvement_set", full=True
    )

    videos = fields.ToManyField(EventVideoResource, "eventvideo_set", full=True)
    live_streams = fields.ToManyField(
        EventLiveStreamResource, "eventlivestream_set", full=True
    )
    ...
    language_and_subtitles = fields.ToOneField(
        LanguageAndSubtitlesResource,
    ...
    sponsors = fields.ToManyField(
        EventSponsorResource, "eventsponsor_set", full=True
    )
    ...
    def dehydrate(self, bundle):
        ...
        bundle.data['teaser_de'] = strip_invalid_chars(
            strip_html(bundle.obj.get_rendered_teaser_de())
        )
        bundle.data['teaser_en'] = strip_invalid_chars(
            strip_html(bundle.obj.get_rendered_teaser_en())
        )
        bundle.data['work_info_de'] = strip_invalid_chars(
            strip_html(bundle.obj.get_rendered_work_info_de())
        )
        bundle.data['work_info_en'] = strip_invalid_chars(
            strip_html(bundle.obj.get_rendered_work_info_en())
        )
        bundle.data['contents_de'] = strip_invalid_chars(
            strip_html(bundle.obj.get_rendered_contents_de())
        )
        bundle.data['contents_en'] = strip_invalid_chars(
            strip_html(bundle.obj.get_rendered_contents_en())
        )
        bundle.data['press_text_de'] = strip_invalid_chars(
            strip_html(bundle.obj.get_rendered_press_text_de())
        )
        bundle.data['press_text_en'] = strip_invalid_chars(
            strip_html(bundle.obj.get_rendered_press_text_en())
        )
        bundle.data['credits_de'] = strip_invalid_chars(
            strip_html(bundle.obj.get_rendered_credits_de())
        )
        bundle.data['credits_en'] = strip_invalid_chars(
            strip_html(bundle.obj.get_rendered_credits_en())
        )
        bundle.data['concert_program_de'] = strip_invalid_chars(
            strip_html(bundle.obj.get_rendered_concert_program_de())
        )
        bundle.data['concert_program_en'] = strip_invalid_chars(
            strip_html(bundle.obj.get_rendered_concert_program_en())
        )
        bundle.data['supporting_program_de'] = strip_invalid_chars(
            strip_html(bundle.obj.get_rendered_supporting_program_de())
        )
        bundle.data['supporting_program_en'] = strip_invalid_chars(
            strip_html(bundle.obj.get_rendered_supporting_program_en())
        )
        bundle.data['remarks_de'] = strip_invalid_chars(
            strip_html(bundle.obj.get_rendered_remarks_de())
        )
        bundle.data['remarks_en'] = strip_invalid_chars(
            strip_html(bundle.obj.get_rendered_remarks_en())
        )
        bundle.data['price_information_de'] = strip_invalid_chars(
            strip_html(bundle.obj.get_rendered_price_information_de())
        )
        bundle.data['price_information_en'] = strip_invalid_chars(
            strip_html(bundle.obj.get_rendered_price_information_en())
        )
        bundle.data['other_characteristics_de'] = strip_invalid_chars(
            strip_html(bundle.obj.get_rendered_other_characteristics_de())
        )
        bundle.data['other_characteristics_en'] = strip_invalid_chars(
            strip_html(bundle.obj.get_rendered_other_characteristics_en())
        )
...
class ProductionResource(ModelResource):
    ...
    categories = fields.ToManyField(
        ...
        attribute=lambda bundle: bundle.obj.get_categories(),
        full=True,
        null=True,
        blank=True
    )
    characteristics = fields.ToManyField(
        ProductionCharacteristicsResource, "characteristics", full=True
    )

    leaders = fields.ToManyField(
        ProductionLeadershipResource, "productionleadership_set", full=True
    )
    authors = fields.ToManyField(
        ProductionAuthorshipResource, "productionauthorship_set", full=True
    )
    participants = fields.ToManyField(
        ProductionInvolvementResource, "productioninvolvement_set", full=True
    )

    videos = fields.ToManyField(
        ProductionVideoResource, "productionvideo_set", full=True
    )
    live_streams = fields.ToManyField(
        ProductionLiveStreamResource, "productionlivestream_set", full=True
    )
    ...
    pdfs = fields.ToManyField(
        ProductionPDFResource, "productionpdf_set", full=True
    )
    social_media = fields.ToManyField(
        ProductionSocialMediaChannelResource,
        "productionsocialmediachannel_set",
        full=True
    )
    ...
    sponsors = fields.ToManyField(
        ProductionSponsorResource, "productionsponsor_set", full=True
    )
    ...
    class Meta(BaseMetaForModelResource):
        queryset = Production.objects.all().prefetch_related(
            ...
            'categories',
            'characteristics',
            'productionleadership_set__person',
            'productionauthorship_set__person',
            'productionauthorship_set__authorship_type',
            'productioninvolvement_set__person',
            'productioninvolvement_set__involvement_type',
            'productionvideo_set',
            'productionlivestream_set',
            'productionimage_set',
            'productionpdf_set',
            'productionsocialmediachannel_set',
            'language_and_subtitles',
            'event_set__play_locations',
            'event_set__play_stages',
            'event_set__characteristics',
            'event_set__eventleadership_set__person',
            'event_set__eventauthorship_set__person',
            'event_set__eventauthorship_set__authorship_type',
            'event_set__eventinvolvement_set__person',
            'event_set__eventinvolvement_set__involvement_type',
            'event_set__eventvideo_set',
            'event_set__eventlivestream_set',
            'event_set__eventimage_set',
            'event_set__eventpdf_set',
        )
    ...
    def dehydrate(self, bundle):
        ...
        for lang_code, lang_name in settings.FRONTEND_LANGUAGES:
            try:
                activate(lang_code)
                path = reverse(
                    'production_detail', kwargs={'slug': bundle.obj.slug}
                )
                bundle.data['link_%s' % lang_code] = "".join(
                    (get_website_url()[:-1], path)
                )
    ...
    def apply_filters(self, request, applicable_filters):
        ...
        base_object_list = super(ProductionResource, self).apply_filters(
