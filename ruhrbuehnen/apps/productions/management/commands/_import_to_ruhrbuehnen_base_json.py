...
class ImportToRuhrbuehnenBaseJSON(ImportToRuhrbuehnenBaseXML):
    ...
    def parse_and_use_texts(self, d, instance):
        ...
        instance.description_de = (d.get('description_de', "") or "").replace("&nbsp;", " ")
        instance.description_en = (d.get('description_en', "") or "").replace("&nbsp;", " ")
        instance.teaser_de = (d.get('teaser_de', "") or "").replace("&nbsp;", " ")
        instance.teaser_en = (d.get('teaser_en', "") or "").replace("&nbsp;", " ")
        instance.work_info_de = (d.get('work_info_de', "") or "").replace("&nbsp;", " ")
        instance.work_info_en = (d.get('work_info_en', "") or "").replace("&nbsp;", " ")
        instance.contents_de = (d.get('contents_de', "") or "").replace("&nbsp;", " ")
        instance.contents_en = (d.get('contents_en', "") or "").replace("&nbsp;", " ")
        instance.press_text_de = (d.get('press_text_de', "") or "").replace("&nbsp;", " ")
        instance.press_text_en = (d.get('press_text_en', "") or "").replace("&nbsp;", " ")
        instance.credits_de = (d.get('credits_de', "") or "").replace("&nbsp;", " ")
        instance.credits_en = (d.get('credits_en', "") or "").replace("&nbsp;", " ")
        instance.concert_program_de = (d.get('concert_program_de', "") or "").replace("&nbsp;", " ")
        instance.concert_program_en = (d.get('concert_program_en', "") or "").replace("&nbsp;", " ")
        instance.supporting_program_de = (d.get('supporting_program_de', "") or "").replace("&nbsp;", " ")
        instance.supporting_program_en = (d.get('supporting_program_en', "") or "").replace("&nbsp;", " ")
        instance.remarks_de = (d.get('remarks_de', "") or "").replace("&nbsp;", " ")
        instance.remarks_en = (d.get('remarks_en', "") or "").replace("&nbsp;", " ")
        instance.duration_text_de = (d.get('duration_text_de', "") or "").replace("&nbsp;", " ")
        instance.duration_text_en = (d.get('duration_text_en', "") or "").replace("&nbsp;", " ")
        instance.subtitles_text_de = (d.get('subtitles_text_de', "") or "").replace("&nbsp;", " ")
        instance.subtitles_text_en = (d.get('subtitles_text_en', "") or "").replace("&nbsp;", " ")
        instance.age_text_de = (d.get('age_text_de', "") or "").replace("&nbsp;", " ")
        instance.age_text_en = (d.get('age_text_en', "") or "").replace("&nbsp;", " ")
        instance.price_information_de = (d.get('price_information_de', "") or "").replace("&nbsp;", " ")
        instance.price_information_en = (d.get('price_information_en', "") or "").replace("&nbsp;", " ")
    ...
    def save_page(self, productions):
        ...
        for prod_index, prod_dict in enumerate(productions, 1):
            ...
            prod.prefix_de = strip_tags((prod_dict.get('prefix_de', "") or "").replace('<br />', ' '))
            prod.prefix_en = strip_tags((prod_dict.get('prefix_en', "") or "").replace('<br />', ' '))
            prod.subtitle_de = strip_tags((prod_dict.get('subtitle_de', "") or "").replace('<br />', ' '))
            prod.subtitle_en = strip_tags((prod_dict.get('subtitle_en', "") or "").replace('<br />', ' '))
            prod.original_de = strip_tags((prod_dict.get('original_de', "") or "").replace('<br />', ' '))
            prod.original_en = strip_tags((prod_dict.get('original_en', "") or "").replace('<br />', ' '))
