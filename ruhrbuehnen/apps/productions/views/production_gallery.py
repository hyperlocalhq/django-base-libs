...
def video_overview(request, slug):
    ...
    return render(
        request, "productions/gallery/video_overview.html",
        {'production': instance}
    )
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if not media_file_obj:
                media_file_obj = ProductionVideo(production=instance)
            ...
            if "hidden_iframe" in request.REQUEST:
                ...
                if cleaned['goto_next']:
                    ...
                    return redirect(
                        "production_gallery_overview", slug=instance.slug
                    )
    else:
        if media_file_obj:
            # existing media file
...
def streaming_overview(request, slug):
    ...
    return render(
        request, "productions/gallery/streaming_overview.html",
        {'production': instance}
    )
...
def create_update_streaming(request, slug, mediafile_token="", **kwargs):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if not media_file_obj:
                media_file_obj = ProductionLiveStream(production=instance)
...
def image_overview(request, slug):
    ...
    return render(
        request, "productions/gallery/image_overview.html",
        {'production': instance}
    )
...
def create_update_image(request, slug, mediafile_token="", **kwargs):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if not media_file_obj:
                media_file_obj = ProductionImage(production=instance)
            ...
            if "hidden_iframe" in request.REQUEST:
                ...
                if cleaned['goto_next']:
                    ...
                    return redirect(
                        "production_image_overview", slug=instance.slug
                    )
    else:
        if media_file_obj:
            # existing media file
...
def pdf_overview(request, slug):
    ...
    return render(
        request, "productions/gallery/pdf_overview.html",
        {'production': instance}
    )
...
def create_update_pdf(request, slug, mediafile_token="", **kwargs):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if not media_file_obj:
                media_file_obj = ProductionPDF(production=instance)
