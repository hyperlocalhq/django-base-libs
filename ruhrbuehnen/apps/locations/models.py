...
class LocationManager(models.Manager):
    ...
    def for_newsletter(self):
        return self.filter(status="published", newsletter=True)
...
class Location(
    ...
    categories = TreeManyToManyField(
        LocationCategory, verbose_name=_("Categories"), blank=True
    )
    ...
    tickets_additional_info = MultilingualTextField(
        _("Additional information"), blank=True
    )

    services = models.ManyToManyField(
        Service, verbose_name=_("Service"), blank=True
    )
    accessibility_options = models.ManyToManyField(
        AccessibilityOption,
        verbose_name=_("Accessibility options"),
        blank=True
    )
    ...
    def is_editable(self, user=None):
        ...
        if not hasattr(self, "_is_editable_cache"):
            ...
            self._is_editable_cache = user.has_perm(
                "locations.change_location", self
            )
    ...
    def is_deletable(self, user=None):
        ...
        if not hasattr(self, "_is_deletable_cache"):
            ...
            self._is_deletable_cache = user.has_perm(
                "locations.delete_location", self
            )
