...
from ruhrbuehnen.apps.locations.models import Service
from ruhrbuehnen.apps.locations.models import AccessibilityOption
from ruhrbuehnen.apps.locations.models import Location
from ruhrbuehnen.apps.locations.models import Stage
from ruhrbuehnen.apps.locations.models import Image as LocationImage
from ruhrbuehnen.apps.locations.models import SocialMediaChannel
...
class StageResource(ModelResource):
    ...
    def dehydrate(self, bundle):
        ...
        bundle.data['street_address'] = strip_invalid_chars(
            bundle.obj.street_address
        )
        bundle.data['street_address2'] = strip_invalid_chars(
            bundle.obj.street_address2
        )
...
class LocationResource(ModelResource):
    accessibility = fields.ToManyField(
        AccessibilityOptionResource, "accessibility_options", full=True
    )
    ...
    social_media = fields.ToManyField(
        SocialMediaChannelResource, "socialmediachannel_set", full=True
    )
    ...
    def dehydrate(self, bundle):
        ...
        for lang_code, lang_name in settings.FRONTEND_LANGUAGES:
            try:
                activate(lang_code)
                path = reverse(
                    'location_detail', kwargs={'slug': bundle.obj.slug}
                )
        ...
        if bundle.obj.phone_number:
            bundle.data['phone'] = [
                strip_invalid_chars(bundle.obj.phone_country),
                strip_invalid_chars(bundle.obj.phone_area),
                strip_invalid_chars(bundle.obj.phone_number)
            ]
        if bundle.obj.fax_number:
            bundle.data['fax'] = [
                strip_invalid_chars(bundle.obj.fax_country),
                strip_invalid_chars(bundle.obj.fax_area),
                strip_invalid_chars(bundle.obj.fax_number)
            ]

        bundle.data['tickets'] = {}
        if bundle.obj.tickets_street_address:
            bundle.data['tickets']['street_address'] = strip_invalid_chars(
                bundle.obj.tickets_street_address
            )
            bundle.data['tickets']['street_address2'] = strip_invalid_chars(
                bundle.obj.tickets_street_address2
            )
            bundle.data['tickets']['postal_code'] = strip_invalid_chars(
                bundle.obj.tickets_postal_code
            )
            bundle.data['tickets']['city'] = strip_invalid_chars(
                bundle.obj.tickets_city
            )
        if bundle.obj.tickets_email:
            bundle.data['tickets']['email'] = strip_invalid_chars(
                bundle.obj.tickets_email
            )
        if bundle.obj.tickets_website:
            bundle.data['tickets']['website'] = strip_invalid_chars(
                bundle.obj.tickets_website
            )
        if bundle.obj.tickets_phone_number:
            bundle.data['tickets']['phone'] = [
                strip_invalid_chars(bundle.obj.tickets_phone_country),
                strip_invalid_chars(bundle.obj.tickets_phone_area),
                strip_invalid_chars(bundle.obj.tickets_phone_number)
            ]
        if bundle.obj.tickets_fax_number:
            bundle.data['tickets']['fax'] = [
                strip_invalid_chars(bundle.obj.tickets_fax_country),
                strip_invalid_chars(bundle.obj.tickets_fax_area),
                strip_invalid_chars(bundle.obj.tickets_fax_number)
            ]
        ...
        if bundle.obj.press_contact_name:
            bundle.data['press']['contact_name'] = strip_invalid_chars(
                bundle.obj.press_contact_name
            )
        if bundle.obj.press_email:
            bundle.data['press']['email'] = strip_invalid_chars(
                bundle.obj.press_email
            )
        if bundle.obj.press_website:
            bundle.data['press']['website'] = strip_invalid_chars(
                bundle.obj.press_website
            )
        if bundle.obj.press_phone_number:
            bundle.data['press']['phone'] = [
                strip_invalid_chars(bundle.obj.press_phone_country),
                strip_invalid_chars(bundle.obj.press_phone_area),
                strip_invalid_chars(bundle.obj.press_phone_number)
            ]
        if bundle.obj.press_fax_number:
            bundle.data['press']['fax'] = [
                strip_invalid_chars(bundle.obj.press_fax_country),
                strip_invalid_chars(bundle.obj.press_fax_area),
                strip_invalid_chars(bundle.obj.press_fax_number)
            ]
    ...
    def apply_filters(self, request, applicable_filters):
        ...
        base_object_list = super(LocationResource, self).apply_filters(
