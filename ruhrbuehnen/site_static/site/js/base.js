...
u.ready(function() {
    ...
    Gallery.prototype.open = function(item) {
        ...
        var u_close = u('<div class="gallery-layer-close"><svg class="svg-icons-close" viewPort="0 0 12 12" version="1.1" xmlns="http://www.w3.org/2000/svg"><line x1="20%" y1="80%" x2="80%" y2="20%" stroke="black" stroke-width="20%"/><line x1="20%" y1="20%" x2="80%" y2="80%" stroke="black" stroke-width="20%"/></svg></div>');
    ...
    function AddClass(u_main) {
        ...
        me.class = me.u_main.attr('data-add-class');
    ...
    AddClass.prototype.setClass = function() {
        ...
        if (me.from_scroll) {
            ...
            if (window.pageYOffset < me.target) u.body.removeClass(me.class);
            else u.body.addClass(me.class);

        } else if (me.from_top) {

            var size = me.u_main.size();
            if (size.top > me.target) u.body.removeClass(me.class);
            else u.body.addClass(me.class);

        } else if (me.from_bottom) {

            var size = me.u_main.size();
            if (size.top > u.window.height()-me.target) u.body.removeClass(me.class);
            else u.body.addClass(me.class);
            ...
            if (u_target.length) {
                ...
                if (main_size.top > target_size.bottom) u.body.removeClass(me.class);
                else u.body.addClass(me.class);

            } else u.body.removeClass(me.class);
        }
