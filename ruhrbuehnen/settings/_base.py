...
STATIC_URL = PIPELINE_URL = "/static/%s/" % get_git_changeset(os.path.join(PROJECT_PATH, "ruhrbuehnen"))
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(PROJECT_PATH, "ruhrbuehnen", "templates", "ruhrbuehnen"),
...
RAVEN_CONFIG = {
    'dsn': 'http://027415c3f0ef4493891dddb074649742:8a2aac93c7074114a35840dfa725cd82@sentry.studio38.de/14',
