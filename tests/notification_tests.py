# -*- coding: UTF-8 -*-
'''
This script helps automate the creation of instances of the models that should generate email notifications. In order to use, you need to make sure that:
- Redis is running:
    $ redis-server
- Celery is running:
...
If go and MailHog are not installed, install go. On FreeBSD, it's simply:
    $ pkg install go
and on Mac it's
    $ brew install go
