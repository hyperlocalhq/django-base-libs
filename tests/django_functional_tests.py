...
class Urls(object):
    def __init__(self, limit_detail_pages_to=None):
        ...
        from ruhrbuehnen.apps.education.models import Department, Project
        from ruhrbuehnen.apps.articles.models import Article
...
if __name__ == "__main__":
    ...
    os.environ["DJANGO_SETTINGS_MODULE"] = "ruhrbuehnen.settings.test"
