...
def suite():
    known_values = (
        ...
        ('/admin/auth/user/send_mail/', 'Django site admin'),
        ...
        ('/admin/email_campaigns/campaign/', 'Django site admin'),
        ('/admin/email_campaigns/campaign/add/', 'Django site admin'),
        ('/admin/email_campaigns/infosubscription/', 'Django site admin'),
        ('/admin/email_campaigns/infosubscription/add/', 'Django site admin'),
        ('/admin/email_campaigns/infosubscription/send_mail/', 'Django site admin'),
        ('/admin/email_campaigns/mailing/', 'Django site admin'),
        ('/admin/email_campaigns/mailing/add/', 'Django site admin'),
        ('/admin/email_campaigns/mailinglist/', 'Django site admin'),
        ('/admin/email_campaigns/mailinglist/add/', 'Django site admin'),
        ...
        ('/admin/institutions/institution/send_mail/', 'Django site admin'),
        ...
        ('/admin/people/person/send_mail/', 'Django site admin'),
