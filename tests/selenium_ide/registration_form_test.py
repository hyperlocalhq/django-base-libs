...
class RegistrationFormTest(unittest.TestCase):
    ...
    def test_registration_form(self):
        ...
        try: self.assertTrue(self.is_element_present(By.CSS_SELECTOR, "div.col3_content.clearfix > h1"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertEqual("Sie haben es fast geschafft.", driver.find_element_by_css_selector("div.col3_content.clearfix > h1").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertTrue(self.is_element_present(By.XPATH, "//div[@id='main']/div[3]/div/div/p[2]/strong"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertEqual(u"Bitte schauen Sie auch in Ihren Spamordner nach der Bestätigungsmail.", driver.find_element_by_xpath("//div[@id='main']/div[3]/div/div/p[2]/strong").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
