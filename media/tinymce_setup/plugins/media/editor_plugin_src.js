...
(function() {
	...
	tinymce.create('tinymce.plugins.MediaPlugin', {
		init : function(ed, url) {
			...
			ed.addCommand('mceMedia', function() {
				ed.windowManager.open({
					...
					height : 600 + parseInt(ed.getLang('media.delta_height', 0)),
					inline : 1
				}, {
					plugin_url : url
				});
		...
		_createImg : function(cl, n) {
			...
			each(['id', 'name', 'width', 'height', 'bgcolor', 'align', 'flashvars', 'src', 'wmode', 'allowfullscreen', 'allowscriptaccess', 'quality'], function(na) {
